# Ejercicio de escritura 8

Signos vocálicos para el inicio de palabra, en caso de que la palabra no esté conectada en la escritura con una palabra precedente:
...
Cuando en una palabra o frase dos o más consonantes aparecen inmediatamente una tras otra, se escriben mediante una ligadura (signo conectado).

1. Si el primer signo de las consonantes a conectar termina con la línea vertical a la derecha, pierde dicha línea y se coloca delante de la segunda consonante.

Excepción: si el segundo signo consonántico es न् o ल्, este se coloca debajo del primer signo consonántico perdiendo su línea horizontal. Dependiendo del tipo de letra, existen otras excepciones, que se enumeran a continuación. Si en el tipo de letra correspondiente no está prevista una ligadura, se coloca un Virāma.

Ejemplos:

En el tipo de letra utilizado en este manual:
...
La -a inicial que es elidida según las reglas de Sandhi de frase (-as + a- » -o ' ) se indica mediante el llamado Avagraha:
