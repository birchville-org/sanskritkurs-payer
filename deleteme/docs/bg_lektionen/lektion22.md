...
Абсолютивът е глаголно‑наречие, т.е. не се спряга и не се склонява, но (с изключение на малък брой изключения) винаги има същия агент (कर्तृ) като действието, предшестващо или съпътстващо действието, обозначено с абсолютив. Агентът на абсолютива стои в именителния падеж (प्रथमा) или в творителния (तृतीया).

Освен съставните думи, абсолютивът е едно от най‑често използваните средства за изразяване в санскрит.

При превод към немски (тук: български) се избягва постоянното „след като“. Вместо това се употребяват обичайните български изрази за последователност във времето.

Схема:

(по‑детайлен определител за абсолютива: обстоятелствено определение, обект и др.) – Абсолютив – Абсолютив – … – Абсолютив – … Агент + глаголна част (в актив или пасив)
...
## 22.2. Образуване на абсолютив

*   Verben ohne Präverb: Absolutiv auf -tvā
*   Глаголи с приставка: абсолютив на ‑ya или ‑tya  
...
(най‑често) дълбока форма на корена + ‑ya
...
непроменен високоформален корен + ‑ya
...
#### 22.2.2.4. Корени на ‑am / ‑an, които в дълбока форма завършват на ‑a

Опционално:

Фигура: दुर्गाशक्तिः = दुर्गैव शक्तिः  
...
Фигура: दुर्गाशक्तिः = दुर्गैव शक्तिः  
Колката = কলকাতা  
\[Източник на изображението: The Eternity. -- [http://www.flickr.com/photos/the_world_in_my_eyes/2914301330/](http://www.flickr.com/photos/the_world_in_my_eyes/2914301330/). -- Достъп 2008‑12‑12. -- [](http://creativecommons.org/licenses/by-nc-nd/2.0/deed.de) Creative Commons лиценз (приписване, некомерсиално използване, без производни произведения)\]
...
व्रत *n.*: देवदासी, व्रत व्रत, Dharmaśāstra व्रत (  на  , за да   от . :   да   си    (),   се .   : ;  от  ;  ;  на  ;  на ;  на  и пр.   за : Walker, *Hindu World* т. II, с. 581f. : P. V. Kane, *History of * т. 5,1, с. 1‑462.  с. 253‑462 –  на  и   („the following list … does not claim to be thoroughly exhaustive“ !!!)

चर् 1 P चरति Pass. चर्यते PPP चरित Inf. चरितुम् : weiden, umhergehen, sich regen, sich bewegen, handeln, etwas ausüben, vollziehen (напр. व्रतं चर् : ein Gelübde praktizieren, insbes. sexuelle Enthaltsamkeit)
...
Фигура: धेनवश्चरन्ति  
Goa = गोंय  
\[Източник на изображението: Veebl. -- [http://www.flickr.com/photos/veebl/2322214162/](http://www.flickr.com/photos/veebl/2322214162/). -- Достъп 2008‑12‑12. -- [](http://creativecommons.org/licenses/by-nc-nd/2.0/deed.de) Creative Commons лиценз (приписване, некомерсиално използване, без производни произведения)\]
...
![](/images/lekt2204.jpg)  
Фигура: अन्नं पक्त्वा ...  
\[Източник на изображението: Curt Carnemark / World Bank. -- [http://www.flickr.com/photos/worldbank/2183558378/](http://www.flickr.com/photos/worldbank/2183558378/). -- Достъп 2008‑12‑12. -- [](http://creativecommons.org/licenses/by-nc-nd/2.0/deed.de) Creative Commons лиценз (приписване, некомерсиално използване, без производни произведения)\]