...
Като adverbial (недекларируемо) предводно член могат да се използват  
...
Най‑важните adverbialни предводни членове са **a-/an-**, **su-**, **dus-**.
...
सु "wohl, gut";  wird bei der Auflösung des Kompositums von den Kommentatoren durch ein Adjektiv mit der Bedeutung "gut" (напр. सुष्टु 3, शोभन 3) ersetzt.
...
Чрез приставка (префикс) значението на корена се променя драстично, като сладостта на речната вода, променена от морска вода.

В санскрит глаголите могат да се свързват с префикси (उपसर्ग м.). Обикновено важи санди‑правилото. Префиксите могат съществено да променят значението на корена, затова в мнозина случаи това значение се учи отделно. Префиксните глаголи могат да имат различен модус (P, Ā) от простия корен. Пред корен могат да се поставят едновременно няколко префикса.
...
![](/images/lekt1804.jpg)  
Фигура: Hochzeit = विवाह् m., ein wichtiger संस्कारः  
\[Източник на изображението: Saad.Akhtar. -- [http://www.flickr.com/photos/saad/64770385/](http://www.flickr.com/photos/saad/64770385/). -- Достъпно на 2008‑12‑08. -- [](http://creativecommons.org/licenses/by-nc-nd/2.0/deed.de) Creative Commons лиценз (въведение, некомерсиално, без промяна)\]  
...
**C) Повторително упражнение**

Моля, без помощни средства!

**A) Разделете следните съставки на санскрит и предложете превод:**
...
![](/images/lekt1802.jpg)  
Фигура: मृतिसाधनी काली  
1770 Print  
\[Източник на изображението: Wikipedia, Public domain\]

**B) Преведете, използвайки глаголи от 2‑‑та класa на време:**

Фигура: मृतिसाधनी काली  

2. Герои тръгват по труднопроходимия път към селото на арийците.  

3. Дворовата служителка дои кравите.  

4. Враговете на арийците убиват могъщите кшатрии.  

5. Призрак не яде плодове.  

6. Така говори онзи, който [пътят през преражданията] е добре преминал към ученика.
...
**C) Дайте на санскрит дефиницията на йога по два начина: едно с използване на съставно, друго като разглобяване на съставното.**
...
*Това е съдържанието на предишната секция, която вече беше зададена, така че в случай че искате да я разгледате пак, тук е.*  
