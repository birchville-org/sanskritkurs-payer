...
Esempi per r prima di una consonante:
...
r dopo una consonante: /

*   per le lettere con un tratto verticale finale: / sul tratto verticale finale
    
*   per le altre lettere: nella parte inferiore della lettera
...
A) Scrivete in Devanāgarī e fornite la traduzione (presuppone la Lezione 8):
...
B) Leggete, traslitterate e traducete:
