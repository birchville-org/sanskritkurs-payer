...
def translate_text(text, target_lang):
    ...
    system = (
        ...
        f"(3) Translate '# Lektion N', '## Übung', '### Wortliste', and ALL subheadings (including '## B) Wortformen', '## Verbformen-Übung', '## Wiederholungsübung', etc.) strictly to the target-language equivalent{target_example}. Headings and frontmatter titles must NEVER be translated into English unless the target language is English! "
        "(4) NEVER add TODO comments, fallback markers, or any annotations of your own. Translate ALL text strictly into the target language. Translating into English as a fallback is strictly FORBIDDEN unless the target language is English. "
