---
title: "Oppitunti 25"
subtitle: 'Ablatiivin muodostus (⟪पञ्चमी⟫ = \"viides kasuspääte\")'
lesson_id: 25
...
::: grammar-box
Paitsi maskuliinien ja neutrien -a-päätteisten sekä pronominalien osalta, ablatiivin muodot (⟪पञ्चमी⟫) ovat yksikössä kaikissa taivutusluokissa samat kuin genetiivin muodot (⟪षष्ठी⟫).

Paitsi henkilöpronominien kohdalla pluralin ablatiivin muodot ovat kaikissa taivutuksissa samat kuin datiivin (⟪चतुर्थी⟫).
:::
...
:::
Kysymys-, suhde- ja demonstratiivipronominit:

::: grammar-box

| | ablatiivi yksikkö:brmaskuliini / neutri | ablatiivi yksikkö:brfeminiini |
| :--- | :--- | :--- |
...
⟪अश्वात्पतितः⟫ = "pudota hevosen selästä"

⟪तेभ्यो⟫ ⟪लब्धम्⟫ = "heiltä (päin) vastaanotettu"
:::
Esimerkit:

::: indent
⟪गुरोर्धर्मं⟫ ⟪शृणोति⟫ = "kuulija kuulee opettajalta dharmaa koskevaa"

⟪ब्राह्मणः⟫ ⟪क्षत्रियाद्धेनुमिच्छति⟫ = "brahmani toivoo kṣatrijalta maitolehmää"
:::
::: grammar-box
...
:::
::: grammar-box
3\. Ablatiivi ilmaisee syyn tai aiheen:
:::
Esimerkit:
...
⟪धर्मतस्⟫ = "dharman vuoksi, dharman perusteella"
:::
::: grammar-box
...
*   ablatiivinen:
    ...
    *   ⟪यस्मात्⟫ ... alalause ... ⟪तस्मात्⟫ ... päälause ... = "koska ..., siksi ..."
*   instrumentaali:
    *   ⟪येन⟫ ... alalause ... ⟪तेन⟫ ... päälause ... = "minkä kautta/koska ..., sen vuoksi ..."
:::
Esimerkki:

::: indent
⟪यतो⟫ (⟪यस्माद्⟫ / ⟪येन⟫) ⟪धर्ममिच्छति⟫ \[⟪ततो⟫ (⟪तस्माद्⟫ / ⟪तेन⟫)\] ⟪रामो⟫ ⟪व्रतं⟫ ⟪चरति⟫ = "Koska Rāma haluaa vaurautta, hän harjoittaa lupauksensa"
:::
::: grammar-box
**2\. ⟪हि⟫**
...
*   ⟪हेतु⟫ m.
*   muut substantiivit merkityksessä "syy"

\+ Genetiivi (⟪षष्ठी⟩) tai yhdyssanan jälkiosa:
:::
Esimerkki:

::: indent
⟪पुण्यस्य⟫ ⟪कारणात्⟫ (⟪हेतोः⟫ jne.) = "ansion vuoksi"
:::
::: grammar-box
**5\. ⟪इति⟫**

Toiminnan motiivi voidaan ilmaista ajatuksella ⟪इति⟫:
:::
Esimerkki:
...
⟪मद⟫ m.: humina, aistuksellinen nautinto = aistinhimoinen
:::
⟪मान⟫ m.: arvio, maine, kunnia, kunnia, ylpeys, ylimielisyys, vähäisyydentunne ; (vertaa itseään muihin)
...
⟪शास्⟫ 2P ⟪शास्ति⟫, ⟪शासति⟫ (3. pl.) : käsky, opetus, rangaistus

::: indent
Pass. ⟪शिष्यते⟫  
PPP ⟪शिष्ट⟫ ⟪३⟫ : opettettu
...
⟪वह्⟫ + ⟪वि⟫ 1P ⟪विवहति⟫ : viedä pois (nimittäin morsian vanhempien kodista) = mennä naimisiin

siitä:

⟪विवाह⟫ m.: viedä pois, naisen naimisiinotto (Instr., saha) (naimisista v. Basham, Wonder S. 166 -171)
:::
::: media
...
A) Täydennä harjoituksen [Lektion 16](lektion16.md), toistoharjoitus A deklinaatioesimerkit lisäämällä 4. datiivi (⟪चतुर्थी⟩) ja 5. ablatiivi (⟪पञ्चमी⟩). Muodosta myös deklinaatiokannat kaikilla tähän mennessä opetuilla muodoilla
...
::: indent
Selitys: ⟪सर्वतस्⟫ = sarva "jokainen, kaikki" + -tas ; ⟪अणु⟫ = Nom., Akk. sg. neutr.
:::
...
2\. ⟪कौटिलीयार्थशास्त्र⟫ ⟪१⟫.⟪५⟫. hallitsijan koulutuksesta:
