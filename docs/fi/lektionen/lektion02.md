...
::: grammar-box
**Kaava: Predikaattinimi - Subjekti**
...
- **kolme lukua** (lukumuodot) = **vacana** n. -- ⟪वचन⟫
  - yksikkö (yksikön muoto) = **ekavacana** n. -- ⟪एकवचन⟫
  - kaksikko (kahden muoto) = **dvivacana** n. -- ⟪द्विवचन⟫
  - monikko (monikon muoto) = **bahuvacana** n. -- ⟪बहुवचन⟫
- **kolme sukua** (kieliopilliset sukut) = **liṅga** n. / **vyakti** f. -- ⟪लिङ्ग⟫ / ⟪व्यक्ति⟫
  - maskuliini (miespuolinen) = **puṃs** m. -- ⟪पुंस्⟫
  - feminiini (naaraspuolinen) = **strī** f. -- ⟪स्त्री⟫
...
::: grammar-box
**Nominatiivin yksikkö päättyy muotoon -s = -⟪स्⟫ tai on päättömä.**
:::
### 2.3.1. Nominatiivin yksikkö muodossa -s

Seuraavat vokaaliin päättyvät substantiivikannat muodostavat nominatiivin yksikön muotoon **-s**:

::: grammar-box
**Maskuliinit -a-päätteiset:** esim. deva m. = ⟪देव⟫ "jumala" -- Nom. sg.: devas = ⟪देवस्⟫
**Maskuliinit -i-päätteiset:** esim. kavi m. = ⟪कवि⟫ "runoilija" -- Nom. sg.: kavis = ⟪कविस्⟫
**Maskuliinit -u-päätteiset:** esim. guru m. = ⟪गुरु⟫ "opettaja" -- Nom. sg.: gurus = ⟪गुरुस्⟫
:::

## 2.4. Sandhi -- ⟪सन्धि⟫

Sanskritissa sanan loppuääneen määräytyy myös seuraavan sanan alkuäänne. Tätä ilmiötä kutsutaan **sandhiksi** (m.) = ⟪सन्धि⟫ ("yhteys").

### 2.4.1. Lopun -s:n sandhi
...
- **absoluuttisessa lopussa** (lauseen pääte) se muuttuu **visargaksi (-ḥ)**:
  - **devas** = ⟪देवस्⟫ » **devaḥ** = ⟪देवः⟫
  - **kavis** = ⟪कविस्⟫ » **kaviḥ** = ⟪कविः⟫
  - **gurus** = ⟪गुरुस्⟫ » **guruḥ** = ⟪गुरुः⟫

- **äänettömien konsonanttien edellä**:
  - **k, kh, p, ph** ja **ś, ṣ, s** edellä: muuttuu **visargaksi (-ḥ)**
    - **devas + śivaḥ** » **devaḥ śivaḥ** = ⟪देवः⟫ ⟪शिवः⟫ ("Śiva on jumala")
  - **c, ch** edellä: muuttuu **-ś**:ksi
  - **ṭ, ṭh** edellä: muuttuu **-ṣ**:ksi
  - **t, th** edellä: pysyy **-s**:na
    - **sādhus + caitanyas** » **sādhuś caitanyaḥ** = ⟪साधुश्चैतन्यः⟫ ("Caitanya on pyhimys")

- **äänillisten konsonanttien edellä**:
  - ei-a-vokaalien jälkeen: muuttuu **-r**:ksi
    - **kavis + Māghas** » **kavir māghaḥ** = ⟪कविर्माघः⟫ ("Māgha on runoilija")
  - ei-a-vokaalien jälkeen **r-**:n edellä: **-s** katoaa, vokaali pitenee.
    - **gurus + rāmas** » **gurū rāmaḥ** = ⟪गुरू⟫ ⟪रामः⟫ ("Rāma on opettaja")
  - **a-**:n jälkeen: **-as**
    - äänillisten konsonanttien/a edellä: muuttuu **-o**:ksi (alku-a katoaa » ⟪ऽ⟫)
...
- **kṣatriyoiden**
  - kansan suojeleminen
  - lahjojen (brahmaneille) antaminen
  - uhraaminen itselle
  - vedainto
- **vaiśyoiden**
  - karjanhoito
  ...
  - vedainto
- **śūdraiden**
  - palveleminen ylemmissä kolmessa kastessa
:::
**dvija** m. -- ⟪द्विज⟫ : "Kaksi kertaa syntynyt" (ylempien kolmen kastin jäsenet: brāhmaṇa, kṣatriya, vaiśya).
...
Kuva: Eurooppalaisen keskiajan yhteiskuntaluokkien jako (puukaiverrus 1400-luvun lopulta).
(Kuvan lähde: [Yksityiskohdat](/fi/licenses#lekt0201))
:::
**Tekstitys:**
- **Pappiskasti** (~brāhmaṇa): Tu supplex ora = Rukoile nöyrästi!
...
**A) Sovella sandhia ja muodosta substantiivilauseita:**
...
5. Viṣṇu on HERRA.
6. HERRA on Śiva.
7. Kaksi kertaa syntynyt on brahmani.
