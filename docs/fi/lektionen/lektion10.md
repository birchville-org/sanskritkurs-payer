...
- Passiivilause (agensin instrumentaali)
- Instrumentaalin (tṛtīyā) taivutus
- Cerebraalilaki -n:lle (sana-asennus)
...
::: grammar-box
**Kaava:**
**(Agens - kartṛ - instrumentaalin (tṛtīyā) muodossa) - (suora objekti - karman - nominatiivissa) - passiivin verbimuoto**

esim. **brāhmaṇena deva ijyate** = ⟪ब्राह्मणेन⟫ ⟪देव⟫ ⟪इज्यते⟫ = "Brahmani kunnioittaa jumalaa uhraamalla" (sanastaen: "Jumala kunnioitetaan brahmanin toimesta uhraamalla.")

Tämä lause on **täysin (!) merkitykseltään sama** kuin seuraava lause:
**brāhmaṇo devaṃ yajati / yajate** = ⟪ब्राह्मणो⟫ ⟪देवं⟫ ⟪यजति⟫ / ⟪यजते⟫
:::

::: grammar-box
- Passiivilauseessa agentti (**kartṛ**) on **instrumentaali** (tṛtīyä f. "kolmas sijamuoto"), ja suora objekti (**karman** n.) on **nominatiivi** (prathamā f.).
- Passiivilauseissa, joissa agenttia ei mainita, on yleensä henkilöimätön merkitys ("ihminen"):
esim. **ijyate** = ⟪इज्यते⟫ "Uhraillaan" (sanastaen: "sitä kunnioitetaan uhraamalla").
:::
...
::: grammar-box
**Intransitiiviset verbit (verbit, joilla ei ole suoraa objektia) muodostavat usein passiivirakenteita, erityisesti myös kohteliaissa kehotuksissa:**
...
**Epäsäännölliset taivutukset (yksikkö):**
...
**Kysymyspronomini kim:**

| | instrumentaali yksikkö | instrumentaali monikko |
| :--- | :--- | :--- |
| **maskuliini / neutri** | **kena** :br⟪केन⟫ | **kais** :br⟪कैस्⟫ |
| **feminiini** | **kayā** :br⟪कया⟫ | **kābhis** :br⟪काभिस्⟫ |

**Demonstrativpronomina:**

| Pronomen | Genus | instrumentaali yksikkö | instrumentaali monikko |
| :--- | :--- | :--- | :--- |
...
- **Minkä kautta?**
- **Millä välineellä/mitenkin?**
- **Kenen kanssa?**

**Se esiintyy**
1. **passivilauseissa: tekijä (kartṛ) instrumentaalin muodossa**
...
::: grammar-box
**Muodostus:**
**(useimmiten) matalan tason juuri + -ya- + Ātmanepada-loppu**
:::
esim.

| Juuri:br⟪धातु⟫ | 3. sg. Pass. Präs. Indik.:br⟪यक्⟫ ⟪लट्⟫ | 3. pl. Pass. Präs. Indik.:br⟪यक्⟫ ⟪लट्⟫ |
| :--- | :--- | :--- |
...
4. **Matala aste verbeissä, jotka alkavat yllä, v tai r, tai joissa nämä äänteet sijaitsevat minkä tahansa muun konsonantin jälkeen (Samprasāraṇa = ⟪सम्प्रसारण⟫):**
   ...
   | Juuri:br⟪धातु⟫ | Tiefstufe:br⟪सम्प्रसारण⟫ | Passiv:br⟪यक्⟫ |
   | :--- | :--- | :--- |
...
**A) Muodosta passiivi seuraavista verbimuodoista (käännä verbimuu):**
...
**D) Käännä seuraavat lauseet sanskritiksi:**
...
- **vṛṣ** 1 P (varṣati) ⟪वृष्⟫ ⟪वर्षति⟫ : sataa
