...
:::
## 23.2. Infinitiivin muodostus (⟪तुमुन्⟫)

::: grammar-box
**korkean asteen juuri + -tum**
...
**Verbit, joissa on prepositio, muodostavat infinitiivin samalla tavalla kuin yksinkertaiset vartalon juuret.**
:::
Esimerkkejä:
...
:::
Yhdyssanavokaalin -i- käytöstä ei voida asettaa tiukkoja sääntöjä. Periaatteessa yhdyssanavokaalin jakautuminen infinitiivissä vastaa tulevan aikamuodon jakautumista.

Niiden tähän mennessä opittujen juurten lisäksi seuraavat infinitiivit on erityisesti otettava huomioon:
...
:::
Muut juuret, joissa on -ṛ- toiseksi viimeisenä paikkana, voivat fakultatiivisesti käyttää -ra- tai -ar-, jos ne ovat aniṭ.


## 23.3. Infinitiivi (⟪तुमुन्⟫) tähän mennessä opituille juurille
...
A) Seuraavat verbijuuret muodostavat infinitiivin ilman liitinvokaalia -i-. Muodosta infinitiivi huomioiden äänteenmuutokset seuraaviin:
...
B) Seuraavat verbijuuret muodostavat infinitiivin liitinvokaalilla -i-. Muodosta infinitiivi seuraaviin:
...
C) Seuraavat verbijuuret joko vakiintuneella tai ilman väliääntä:
