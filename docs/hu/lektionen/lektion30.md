---
title: "Lecke 30"
subtitle: 'A 9. jelen idő osztály (⟪क्र्यादि⟫ = \"⟪क्री⟫ stb.\")'
lesson_id: 30
...
Néhány hosszú magánhangzóra végződő gyökér lerövidíti azt a 9. osztály jelen idői tőképzője előtt:
...
::: indent
⟪क्रीणन्त्⟫ (krī + n + ant) ; nőnem: ⟪क्रीणती⟫ (krī + n + at + ī)
:::
## 30.2. Az optativus használata (⟪लिङ्⟫)

Az optativust használjuk:
...
**(ebben az esetben a potenciális mód - ⟪लिङ्⟫ - átfedésbe kerül az imperatívussal - ⟪लोट्⟫)**
:::
Példa:
...
::: indent
⟪ग्रामाच्चेद्गच्छेद्गुरुं⟫ ⟪न⟫ ⟪शृणुयात्⟫ = "Ha elmenne a faluból, nem hallaná meg a mestert"
:::
::: grammar-box
**3. Az optatívból képzett mellékmondatok néha a következő jelentést hordozzák: „Ha valaki ...”**
:::
Példa:
...
### 30.4.1. Themás jelen időosztályok
...
**gyenge jelenlegi törzs + -ī- + másodlagos végződés**
:::
Példák:
...
::: grammar-box
**A végződő -rre ugyanazok a Sandhiszabályok vonatkoznak, mint a végződő -sra, kivéve az -ar esetét.**
...
Kép: ⟪ज्ञातयः⟫
Darewadi, Ahmed Nagar kerület = ⟪अहमदनगर⟫, Mahárástra = ⟪महाराष्ट्र⟫
(Képmegjelenés: [Részletek](/hu/licenses#lekt3002))
:::
...
(Képmegjelenés: [Részletek](/hu/licenses#lekt3003))
:::
⟪अश्⟫ 9P ⟪अश्नाति⟫ : enni, elfogyasztani
...
Kép: ⟪अश्नीयात्⟫
⟪थाली⟫, Dél-India
(Képmegjelenés: [Részletek](/hu/licenses#lekt3005))
:::
...
Ábra: ⟪प्रिया⟫
(Képmegjelenítés: [Részletek](/hu/licenses#lekt3004))
:::
...
Ábr.: ⟪पुनर्भवः⟫
(Képmegjelenítés: [Részletek](/hu/licenses#lekt2904))
:::
⟪जीव्⟫ 1P ⟪जीवति⟫ : élni
...
:::
⟪सनातन⟫ ⟪३⟫ nőnem: ⟪सनातनी⟫ : örökkévaló, megsemmisíthetetlen, állandó
...
## 30.8. Alakformák ismétlő gyakorlata
