...
*   **das Múlt idő (imperfektum) (⟪लङ्⟫) bezeichnet, was sich vor dem laufenden Tage ereignet hat, die entfernte Vergangenheit** <!-- TODO: Fallback translation -->
*   **das Perfekt (⟪लिट्⟫) bezeichnet wie das Múlt idő (imperfektum) die entfernte Vergangenheit, wird aber, im Gegensatz zum Múlt idő (imperfektum), nur von Ereignissen gebraucht, die der Sprechende selbst nicht gesehen hat** <!-- TODO: Fallback translation -->
...
:::
## 32.2. Das Imperfekt (⟪लङ्⟫) <!-- TODO: Fallback translation -->
...
:::
## 32.3. Regeln für das Augment <!-- TODO: Fallback translation -->
...
| Jelen időklasse | Tő:br⟪धातु⟫ | 3. sg. P. | 3. pl. P. | 3. sg. Ā. | 3. pl. Ā. | <!-- TODO: Fallback translation -->
| :--- | :--- | :--- | :--- | :--- | :--- | <!-- TODO: Fallback translation -->
...
:::
## 32.5. Wortliste <!-- TODO: Fallback translation -->

**⟪अग्र⟫ n.:** Spitze, äusserstes Ende <!-- TODO: Fallback translation -->

**⟪मही⟫ f.:** Erde, Grund und Boden (wörtl.: die Grosse) <!-- TODO: Fallback translation -->
...
:::
## 32.6. Übung <!-- TODO: Fallback translation -->
...
:::
## 32.7. Übung zur Wiederholung über die Weihnachtsferien <!-- TODO: Fallback translation -->
...
16. Immer (sei seine) Verbindung mit solchen, die in den Wissenschaften gewachsen sind, auf dass seine Erziehung/gutes Verhalten wachse. (Dies) weil die Erziehung/gutes Verhalten als Tő dieses (die Verbindung mit solchen) hat. <!-- TODO: Fallback translation -->
...
35. Deshalb haben die drei (tisras) Wissenschaften das Regiment als Tő. Das Regiment, das Erziehung/gutes Verhalten als Tő hat, bringt den Lebewesen (⟪प्राणभृत्⟫) Gewinn und sicheren Besitz. <!-- TODO: Fallback translation -->
...
38. Der hehre Hari ist mein Weg/Ziel, der (seine) Feinde in einen Himmel schickte, die Seinen den Sinn des Veda wissen liess, den Göttern Unsterblichkeitsspeise zu essen gab, den Schöpfer (⟪विधि⟫) den Veda lehrte, die Erde im Wasser (fest) setzte. <!-- TODO: Fallback translation -->
...
:::
## 32.8. Übung zur Wiederholung <!-- TODO: Fallback translation -->
...
## 32.9. Übersetzungsübung <!-- TODO: Fallback translation -->
...
::: indent
⟪पथि⟫ Lok. sg. zu **⟪पथ्⟫ m.** "Weg" (unregelmässige Deklination) <!-- TODO: Fallback translation -->
