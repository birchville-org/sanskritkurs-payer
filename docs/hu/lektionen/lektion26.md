---
title: Lektion 26
subtitle: "A szó belsejében a -s- cerebraalizációs törvénye"
lesson_id: 26
...
::: grammar-box
A **-s-** helyett **-ṣ-** szerepel, ha **k, r, l** vagy egy **magánhangzó** — kivéve az **a, ā** — közvetlenül vagy csak ⟪अनुस्वार⟫ vagy ⟪विसर्ग⟫ által elválasztva előzi meg, és egy másik hang követi, nem pedig **ṛ, r**.

Ennek a szandhinek követi még **⟪दुस्⟫-** néma gutturálisok és labiálisok előtt összetételekben.
:::
*Példák:*
::: indent
⟪तेषाम्⟫ (forrás: *te-sām*)
...
Lásd a példákat lentebb
:::
## 26.4. Grassmann-féle aspirációs disszimiláció

::: grammar-box
**Két aspirált hang közvetlen egymásutánja (aspirált - magánhangzó - aspirált) az első hang behangzóságának elvesztésével jár:**
...
**A jövő idő parasmaipada igeneve a jövő idői tövhöz -nt- képző csatolásával keletkezik, nőnemben fakultatívan -ntī vagy -tī végződéssel:**
...
C) A jövő idő képzése opcionálisan -i-vel és nélküle:

1. ⟪मुह्यन्ति⟫
2. ⟪वर्तते⟫
3. ⟪अश्नुवते⟫ (a jövő idő Parasmaipada alakja)
