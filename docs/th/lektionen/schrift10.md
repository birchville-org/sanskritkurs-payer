...
### กฎข้อที่สองสำหรับการสร้างตัวอักษรควบ (Consonant Ligatures)

\[ดูกฎข้อแรกใน [แบบฝึกเขียนอักษร 8](schrift08.md)\]

หากตัวอักษรตัวแรกซึ่งต้องการเชื่อมกัน ไม่ลงท้ายด้วยเส้นตั้งตรง ตัวอักษรถัดไปจะถูกวางไว้ใต้ตัวอักษรแรก โดยสูญเสียเส้นแนวนอนของมัน

ข้อยกเว้น: หาก ⟪म्⟫ หรือ ⟪य्⟫ เป็นองค์ประกอบที่สองของตัวอักษรควบ ให้เขียนย่อไว้หลังสัญลักษณ์แรก:
...
เขียนตัวอักษรควบทั้งหมดที่ระบุไว้ข้างต้น

### รายการตัวอักษรควบที่ใช้บ่อยที่สุดในแบบพิมพ์ของตำราคำนวณภาษาสันสกฤตโดย Kielhorn
...
อ่านและถอดเสียงเป็นอักษรโรมัน (transliterate):
