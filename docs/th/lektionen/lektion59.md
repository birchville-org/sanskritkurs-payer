...
## 59.1. การลงท้ายคู่แบบทุติยภูมิและการลงท้ายคำสั่งคู่ (⟪द्विवचनम्⟫)

::: grammar-box
|   | ⟪परस्मैपदम्⟫ || ⟪आत्मनेपदम्⟫ |||
| :--- | :---: | :---: | :---: | :---: | :---: |
|   | ทุติยภูมิ | คำสั่ง (⟪लोट्⟫) | ทุติยภูมิแบบมีTheme | ทุติยภูมิแบบไม่มีTheme:brOptative (⟪विधिलिङ्⟫) | คำสั่ง (⟪लोट्⟫) |
| **1. ⟪तृतीयः⟫** | -va | -āva | -vahi || -āvahai |
| **2. ⟪मध्यमः⟫** | -tam:br-tām || -īthām | -āthām | -īthām / āthām |
| **3. ⟪प्रथमः⟫** | ^^ || -ītām | -ātām | -ītām / -ātām |
:::
## 59.2. คู่แบบมีTheme ของกลุ่มปัจจุบัน: Optative (⟪विधिलिङ्⟫), Imperfect (⟪लङ्⟫), Imperative (⟪लोट्⟫)

::: grammar-box
**ก่อน -va และ -vahi จะแทนที่สระ Theme -a- ด้วย -ā-**
:::
### 59.2.1. กลุ่มปัจจุบันที่หนึ่ง (⟪भ्वादिगणः⟫)
...
:::
### 59.2.2. กลุ่มปัจจุบันที่สี่ (⟪दिवादिगणः⟫)
...
:::
### 59.2.3. กลุ่มปัจจุบันที่หก (⟪तुदादिगणः⟫)
...
:::
### 59.2.4. กลุ่มกริยาปัจจุบันครั้งที่สิบ (⟪चुरादिगणः⟫) และกริยาทำให้ (⟪णिजन्त⟩)
...
:::
### 59.2.5. การสร้างประโยคปฏิเสธ (Suffix -⟪यक्⟫)
...
| 3\. ⟪प्रथमः⟫ | ⟪तुद्येताम्⟫ |
:::
## 59.3. คำคู่ของกริยาปัจจุบันที่ไม่ใช่สระ: อรรถกถา (⟪विधिलिङ्⟫), อรรถกถาอดีต (⟪लङ्⟫), คำสั่ง (⟪लोट्⟫)

### 59.3.1. กลุ่มกริยาปัจจุบันครั้งที่สอง (⟪अदादिगणः⟫)
...
| 3\. ⟪प्रथमः⟫ | ⟪स्ताम्⟫ |
:::
### 59.3.2. กลุ่มกริยาปัจจุบันที่สาม (⟪जुहोत्यादिगणः⟫)
...
:::
### 59.3.5. กลุ่มปัจจุบันที่เจ็ด (⟪रुधादिगणः⟫)
...
:::
### 59.3.6. กลุ่มปัจจุบันกาลที่เก้า (⟪क्र्यादिगणः⟫)
...
:::
## 59.4. ทวิพจน์ (⟪द्विवचनम्⟫) ออริสต์ (⟪लुङ्⟫)

### 59.4.1. ออริสต์รากศัพท์
...
:::
## 59.5. Aorist (⟪लुङ्⟫) 6: siṣ-Aorist (เฉพาะ P)

::: grammar-box
**สร้าง siṣ-Aorist ใน P โดยรากศัพท์ทั้งหมดที่ลงท้ายด้วย -ā, -e, -o, -ai ซึ่งไม่ถูกจำกัดไว้เฉพาะใน Aorist ที่ 1, 2 หรือ 3 รวมถึงรากศัพท์อื่นๆ อีกบางประการ เช่น ⟪नम्⟫, ⟪यम्⟫, ⟪रम्⟫. ใน Ā รากศัพท์เหล่านี้ทั้งหมดสร้าง s-Aorist.**

**การสร้าง:**

**Augment + รากศัพท์ระดับสูง + s + i + ṣ + การลงท้ายแบบ athematic (เหมือน siṣ-Aorist)**
:::
ดังนั้น สuffix การสร้างรากศัพท์ + การลงท้ายของ siṣ-Aorist มีดังนี้:
...
:::
## 59.6. Aorist (⟪लुङ्⟫) 7: sa-Aorist (s-Aorist แบบ thematic)

::: grammar-box
**sa-Aorist ถูกสร้างโดยรากศัพท์ ⟪अनिट्⟫ ส่วนใหญ่ ซึ่งลงท้ายด้วย -ś, -ṣ หรือ -h และก่อนหน้าตัวสุดท้ายเป็น i, u หรือ ṛ. รากศัพท์ ⟪अनिट्⟫ ที่มีโครงสร้างดังกล่าวสามารถเลือกสร้าง sa-Aorist หรือ iṣ-Aorist ได้ตามต้องการ.**

**การสร้าง:**

**Augment + รากศัพท์ระดับต่ำ + s + a + การลงท้ายแบบ thematic**

**บุคคลที่ 1, 2 และ 3 พหูพจน์ Ā ถูกสร้างจาก s-Aorist คือแบบ athematic.**
:::
...
**Некоторые корни на -h (⟪गुह्⟫, ⟪दिह्⟫, ⟪दुह्⟫, ⟪लिह्⟫) могут в Ā 2.3.sg.1.du.2.pl. выборочно без -sa- образовывать.**
:::
Парадигма:
...
Следующий текст взят из ⟪भट्टिकाव्य⟫ ("Художественное стихотворение \[поэта\] Бхатти"). ⟪भट्टिकाव्य⟫ рассказывает в 22 песнях историю ⟪राम⟫, но одновременно иллюстрирует правила грамматики и поэтики на примерах.

Стихотворение состоит из четырех разделов:
...
⟪भट्टिकाव्य⟫ датируется периодом между 495 и 641 гг. н. э.

::: media
![](/images/lekt5902.webp)
Рис.: ⟪रावणः⟫
(Источник изображения: [Детали](/th/licenses#lekt5902))
:::
Следующий отрывок является началом 15-й песни, посвященной аористу. ⟪रावण⟫, царь демонов, похитивший у ⟪राम⟫ его жену ⟪सीता⟫, посылает за своим братом ⟪कुम्भकर्ण⟫ ("Ухо-горшок"), который за свои злодеяния находится в состоянии непрерывного сна.

::: media
![](/images/lekt5903.webp)
Рис.: ⟪कुम्भकर्णः⟫
Танец Кечак, Бали (Индонезия)
(Источник изображения: [Детали](/th/licenses#lekt5903))
:::
_Подсказка к переводу:_ Стих 6: ⟪दिदृक्षते⟫ \= Дезидератив от ⟪दृश्⟫

::: media
![](/images/lekt5901.webp)
(Источник изображения: [Детали](/th/licenses#lekt5901))
:::
Текст из: Отто Бёхлингк: Санскрит-хрестоматия, стр. 127f.

::: deleteme-box

**lekt5902:** [Источник изображения: Henryart/Wikipedia. Общественное достояние]

**lekt5903:** Танец Кечак, Бали (Индонезия) [Источник изображения: Flying Pharmacist / Wikipedia. [Лицензия Creative Commons](http://creativecommons.org/licenses/by-sa/3.0/) (Указание авторства, аналогичное распространение)]
