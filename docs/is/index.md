...
::: note-box
El **curso de sánscrito** de Alois Payer es un programa integral y científicamente fundamentado para el aprendizaje del idioma sánscrito y la escritura Devanāgarī. Esta edición digital presenta el curso completo en un entorno de lectura moderno, multilingüe y buscable.
...
**Editores**: Editor en línea disponible a través de [QA](/qa_viewer.html){target="_blank"} (Solo lectura, acceso protegido con contraseña para escritura)
