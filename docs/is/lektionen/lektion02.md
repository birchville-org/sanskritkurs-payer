...
:::
A verbal copula ("is", "are", "am", "art", "be") is not necessary, but can sometimes occur.

There are **no articles**: **devaḥ** -- ⟪देवः⟫ can mean "the god" or "a god".

Although in Sanskrit the word order is quite free (especially in verses), when translating a nominal sentence one must always primarily consider a translation according to the standard schema above.
...
(Uppruni myndar: [Upplýsingar](/is/licenses#lekt0201))
:::
**Labels:**
...
a) primariamente, mediante una propia conducta vital de clase, incluyendo particularmente la naturaleza del **oficio** (**estamentos profesionales o de oficio**),
b) secundariamente, por heredo-carisma, mediante exigencias de prestigio exitosas gracias al **linaje** estamental (**estamentos de nacimiento**),
...
El desarrollo de los estamentos de nacimiento es regularmente una forma de (hereditaria) apropiación de privilegios a un grupo o a individuos calificados. Cada apropiación firme de oportunidades, particularmente [de] poderes [señoriales o de adquisición], tiende a llevar a la formación de estamentos. Cada formación de estamentos tiende a llevar a la apropiación monopolística de poderes señoriales y oportunidades de adquisición.

Mientras que las clases profesionales crecen sobre la base de una economía orientada al mercado, los estamentos surgen y existen preferentemente sobre la base de la cobertura de necesidades monopolísticamente litúrgica, o feudal, o patrimonialmente estamental de los grupos.

»**Estamental**« debe significar una sociedad si la estructuración social ocurre preferentemente por estamentos, »**clasista**«, si ocurre preferentemente por clases. De las «clases», la clase »social« está más cerca del »estamento«, mientras que la »clase profesional« está más lejos. Los estamentos a menudo se forman por clases de posesión según su punto central.

Cada sociedad estamental es convencional, ordenada por reglas de conducta vital, crea por tanto condiciones irracionales económicas de consumo y obstaculiza de esta manera mediante apropiaciones monopolísticas y por la exclusión del libre manejo de la propia capacidad profesional la libre formación del mercado.

[**Weber, Max (1864–1920):** Economy and Society : Outline of Understanding Sociology. – 5th, revised ed. – Tübingen : Mohr, 1976. – Pp. 625 f.]
:::
...
(Uppruni myndar: [Upplýsingar](/is/licenses#lekt0203))
:::
...
(Uppruni myndar: [Upplýsingar](/is/licenses#lekt0202))
:::
