...
(Image source: [Details](/is/licenses#lekt2404))
:::

::: grammar-box
**2. The dative (⟪चतुर्थी⟫) can also denote the object of an infinitive of purpose that needs to be supplied:**
...
(Image source: [Details](/is/licenses#lekt2401))
:::

::: grammar-box
**3. The dative (⟪चतुर्थी⟫) also denotes the person or thing for which the object of an action is intended (indirect object; question: to whom?). (Note, however, the verbs with double accusative (⟪द्वितीया⟫)!)**

Example:

:::
::: indent
⟪रामाय फलं ददाति⟫ = "He gives Rāma a fruit." (Root ⟪दा⟫, class 3 present)
:::
::: media
...
(Image source: [Details](/is/licenses#lekt2402))
:::

::: grammar-box
**4. The dative is used with certain verbs (and some other words) similar to German, answering the question "to whom?":**
...
(Image source: [Details](/is/licenses#lekt2403))
:::
...
* **-ai before a vowel-initial word is generally replaced by -ā (rarely by -āy as within the word)**
...
⟪कृतम्⟫ : ⟪कृतं क्रोधेन⟫ = "It is done with the anger = stop being angry!"
...
Fig.: ⟪अलंकारः⟫
(Image source: [Details](/is/licenses#lekt2405))
:::
...
(Image source: [Details](/is/licenses#lekt2406))
:::
...
⟪वृत्त⟫ n.: behavior
:::
⟪अभि⟫ Preverb:  be-, towards - there, to - here, to - there, against, into -, with regard to, on, over, at

⟪नि⟫ Preverb: downwards, down, in, backwards

⟪आ⟫ Preposition / Postposition: before Ablative or after Accusative: up to, as far as; with Ablative: from here, from then, since
...
(Image source: [Details](/is/licenses#lekt2407))
:::
...
(Image source: [Details](/is/licenses#lekt2408))
:::
...
(Image source: [Details](/is/licenses#lekt2411))
:::
...
1. The goddess, to whom no sacrifice has been offered, is angry with men.
...
Fig.: ⟪श्रीगणेशाय नमः⟫
(Image source: [Details](/is/licenses#lekt2409))
:::
...
Fig.: ⟪नरो नरसिंहाय नमस्करोति नरसिंह⟫ devours ⟪हिरण्यकशिपु⟫, leaf from a manuscript of the ⟪भागवतपुराण⟫
(Image source: [Details](/is/licenses#lekt2410))
:::
...
15⟪१५⟫. ¡Hasta luego! (Neusanskrit: ⟪पुनर्दर्शनाय⟫)
