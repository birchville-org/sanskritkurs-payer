...
vant attaches to nouns whose final or penultimate sound is a, ā, or m, as well as to nouns ending in a stop consonant; otherwise -mant usually attaches.
...
Stems in -mant and -vant belong to nominal stems with stem gradation.

::: grammar-box

In nominal stems with stem gradation, one distinguishes between strong and weak cases (cases). In the strong cases, the stem-forming suffix — in root nouns, the root-like component — has the full grade or lengthened grade; in weak cases it has the zero grade.
...
As the first member of a compound, a noun with stem gradation stands in the weak stem (in so-called middle for three-stem nouns).
...
2. A voiceless stop becomes a voiced stop corresponding to it before another voiced stop (not nasal):
...
* for regularly formed stems, in the neuter, the ending of nominative and accusative plural is -i.
...
[LN] The feminine stem of the stems in -mant- and -vant- ends in -mat-ī or -vat-ī. The declension follows that of devī, i.e., there is no stem gradation.
...
Fig.: ⟪महिषासुरः⟫
(Uppruni myndar: [Upplýsingar](/is/licenses#lekt1301))
...
Fig.: ⟪अन्नम्⟫
(Uppruni myndar: [Upplýsingar](/is/licenses#lekt1304))
...
(Uppruni myndar: [Upplýsingar](/is/licenses#lekt1303))
...
(Uppruni myndar: [Details](/is/licenses#lekt1305))

:::

⟪४⟫. ⟪शूद्रा मूढाः ।⟫ (2 möguleikar)
...
[LN] B) Translate and convert into passive sentences in the past tense:
...
[LN] ## 13.11. Review Exercise

[LN] A) Translate the following sentences:
...
B) Transforme the sentences from Exercise A) into the passive voice.
...
Fig.: ⟪सत्यमेव जयते⟫
(Uppruni myndar: [Upplýsingar](/is/licenses#lekt1302))
...
2. Śūdras have entered a heaven.
3. The farmers have walked the path.
The people were liberated by the Buddha's teaching.
4. The son danced.
5. The amulet protected the teacher.
6. A Brāhmaṇa did not tell a falsehood.
7. Śūdra women honored the goddess with sacrifices.
8. Buddha awakened to the truth = Buddha recognized the truth.
9. The Vedic sages heard the Śruti.
10. The sacrificial priests pressed the Soma.