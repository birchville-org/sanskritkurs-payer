...
::: grammar-box
**-s-** is replaced by **-ṣ-**, when **k, r, l** or a **vowel** — except for **a, ā** — immediately precedes it or is separated only by ⟪अनुस्वार⟫ or ⟪विसर्ग⟫, and another sound than **ṛ, r** follows.
...
but: ⟪तासाम्⟫ (*tā-sām*)
:::
## 26.2. Law of cerebralisations for dentals within the word
...
(Uppruni myndar: [Upplýsingar](/is/licenses#lekt2601))
:::
...
**The future tense is partly in competition with the optative (see later).**
:::
...
(Uppruni myndar: [Upplýsingar](/is/licenses#lekt2602))
:::
...
C) Future optional with and without -i-:
