...
The end of a sentence in prose is marked with | (ardhadanda m.). In verses, | denotes the end of a half-verse, while || (danda m.) marks the end of a full verse. In prose, || indicates a larger break (e.g., the end of a paragraph). Verse numbering is placed between two ||, e.g. ||⟪१⟫||.
