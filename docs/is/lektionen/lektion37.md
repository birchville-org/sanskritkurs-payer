---
title: "Lección 37"
subtitle: "El adverbio (⟪क्रियाविशेषणम्⟫)"
lesson_id: 37
...
⟪दूरे⟫ "far away"
:::
## 37.3. Adverbial use of no longer current case forms

Examples:
::: indent
⟪जातु⟫ "at all" (originally "by birth, by nature", acc. sg. n. to ⟪जातु⟫ \<no longer used as a noun\>)

⟪तूष्णीम्⟫ "silently" (acc. sg. to a no longer current ⟪तूष्णी⟫ f. "silence")

⟪एवम्⟫ "thus" (to a otherwise lost pronominal stem ⟪एव⟫ "one, single")
:::
## 37.4. Formation of Adverbs with Adverbial Suffixes

::: grammar-box
From the pronominal stems ⟪तद्⟫, ⟪इदम्⟫ or respectively ⟪अ⟫-, ⟪यद्⟫, ⟪किम्⟫ or respectively ⟪कु⟫, one can derive corresponding pronominal adverbs using the following adverbial suffixes:
...
| **-⟪दा⟫** :br(Time) | ⟪तदा⟫ :bat that time, then | | ⟪यदा⟫ :brwhen (at the time that) | ⟪कदा⟫ :brwhen? |
...
Fig.: ⟪क्व⟫
(Image source: [Details](/is/licenses#lekt3701))
:::
...
### 37.5.1. Compounds with an adverb or a case used adverbially as the final member

Example: ⟪सुचिरम्⟫ "for a very long time"

### 37.5.2. Adverbially used ⟪बहुव्रीहि⟫

Example: ⟪रक्षार्थम्⟫ "in the manner of someone whose purpose is protection, for the sake of protection". It can also be considered as belonging to 5.1.: -⟪अर्थम्⟫ as an adverbial final member.
...
::: grammar-box
An ⟪अव्ययीभाव⟫ is an adverbial compound whose initial member is an indeclinable (postposition, particle, etc.) and whose final member is a noun that takes the ending of the accusative singular neuter.

When resolving the compound, the initial member would govern the final member:
...
:::
Particularly important are ⟪अव्ययीभाव⟫ with ⟪यथा⟫ "like" as the initial member:

e.g. ⟪यथाकामम्⟫ = ⟪कामो यथास्ति⟫ = "as desired, according to wish, arbitrarily"
::: media
![lekt3702.jpg](/images/lekt3702.webp)
Fig.: ⟪यथाशक्ति⟫
(Image source: [Details](/is/licenses#lekt3702))
:::
## 37.6. Syntax
...
an adverbial predicate can stand instead of a predicative adjective:

e.g. ⟪तूष्णीं बभूव⟫ "hann þagnaði, hann varð hljóður"
:::
::: media
![lekt3703.jpg](/images/lekt3703.webp)
Mynd: ⟪तूष्णीं बभूवुः⟫
(Myndheimild: [Upplýsingar](/is/licenses#lekt3703))
:::
## 37.7. Óákveðin fornöfn

::: grammar-box
Óákveðin fornöfn eru mynduð með því að bæta við

*   \-⟪चिद्⟫
*   \-⟪चन⟫
*   ⟪अपि⟫

við föll spurnarfornafnsins ⟪किम्⟫.

t.d.
:::
::: indent
⟪कश्चिद्⟫ = ⟪कश्चन⟫ = ⟪को ऽपि⟫ = "einhver, einhver"  
⟪कस्यचिद्⟫ = einhvers
:::
## 37.8. Spurnarsetningin

::: grammar-box
"Hver?, hvernig?, hvað?, hvers vegna?, af hverju?  
Sá sem spyr ekki er heimskur."

⟪कः कथं किं केन कस्मात्कस्मै । यो न पृच्छेन् मूर्खस्तिष्ठेत् ॥⟫

Mottó Sesamstrætis, sem er góð leiðarlína fyrir lífið og sanskrítarnámið
:::
Sjá einnig [Lexía 4](lektion04.md).
...
Í orðaspurningum er spurt um geranda (⟪कर्तृ⟫), hlut, athöfn, aðstæður o.s.frv., t.d.

*   hver kemur?
*   hvað gerir Rāma?
*   hvern heyrir hann?
*   hvernig talar hún sanskrít?
*   hvar er móðirin?

Í setningaspurningum er spurt um allt innihald setningarinnar, t.d.

*   fer Rāma til Ofterdingen í dag?
*   er það rétt að ... ?
...
(Uppruni myndar: [Details](/is/licenses#lekt3704))
...
Fig.: ⟪शाक्यमुनिः⟫
(Image source: [Details](/is/licenses#lekt3705))
:::
⟪दिन⟫ n.: day
...
Fig.: ⟪वृक्षः⟫
(Image source: [Details](/is/licenses#lekt3706))
:::
...
Fig.: ⟪कृष्णः बलरामश्च⟫
(Image source: [Details](/is/licenses#lekt3707))
:::
...
(Image source: [Details](/is/licenses#lekt3708))
:::
...
(Image source: [Details](/is/licenses#lekt3709))
:::
...
(Image source: [Details](/is/licenses#lekt3710))
:::
7\. ⟪उप⟫ "near"
...
(Image source: [Details](/is/licenses#lekt3711))
:::
8\. ⟪यथा⟫
