---
title: "Lección 41"
subtitle: "⟪सुभाषिते⟫ (tvö orðskvið)"
lesson_id: 41
...
(Image source: [Details](/is/licenses#lekt4102))
...
⟪यज्⟫ 1U, Pres.Part.Ā ⟪यजमान⟫ 3 "one who is honored with a sacrifice for one's own benefit = lord of the sacrifice"
...
### 41.2.2. Lýsingarorð óbeinnar nauðsynjar (Gerundivum) (⟪कृत्य⟫)

::: grammar-box

**Til að tjá óvirka nauðsyn ("það sem þarf/á að gera") er hægt að mynda lýsingarorð úr rótum og afleiddum sagnstofnum valfrjálst með eftirfarandi viðskeytum:**

* **-⟪तव्य⟫** (kvk. **-⟪तव्या⟫**)
* **-⟪अनीय⟫** (kvk. **-⟪अनीया⟫**)
* **-⟪य⟫** (kvk. **-⟪या⟫**)
* **-⟪त्य⟫** (kvk. **-⟪त्या⟫**) (í stað **-⟪य⟫**/**-⟪या⟫**)

:::

#### 41.2.2.1. Viðskeytið -⟪तव्य⟫ / -⟪तव्या⟫
...
#### 41.2.2.2. Viðskeytið -⟪अनीय⟫ / -⟪अनीया⟫
...
| ⟪दा⟫ Kaus. | ⟪दापनीय⟫ 3:brdā-paya - aya + -anīya | "what must be made to give" |
...
Root (in guṇa, vṛddhi, or lengthened grade) + -⟪य⟫
...
(Image source: [Details](/is/licenses#lekt4103))

:::

::: grammar-box

**2b. Roots ending in -u /-ū replace the guṇa grade -o before -ya with -av, and the vṛddhi grade -au with -āv. Vṛddhi grade formation in this case denotes necessity.**
...
Examples of consonant-final roots (see rules in Kielhorn, Grammar § 533ff.):
...
Fig.: ⟪दृश्यो मन्दिरः⟫
(Image source: [Details](/is/licenses#lekt4106))
...
¹ actually a denominative to ⟪मान⟫
...
Fig.: ⟪मान्यः⟫
(Image source: [Details](/is/licenses#lekt4107))
...
List of roots ending in -i / -u /-ṛ that form a gerundive not with -⟪य⟫ / -⟪या⟫ but with the suffix -⟪त्य⟫ (fem. -⟪त्या⟫), in Kielhorn, Grammar §537.
...
The gerundive can also be used as a predicate noun in sentences with passive construction, expressing an obligation or command (with ⟪न⟫ a prohibition, impossibility):

::: indent

**⟪काशी द्विजैर्द्रष्टव्या⟫** = "Twice-born ones must see Benares"
...
(Image source: [Details](/is/licenses#lekt4108))

:::

### 41.2.4. Differences in the usage of gerundive suffixes

::: grammar-box

The usage of these suffixes largely overlaps

* **-⟪तव्य⟫ (fem. -⟪तव्या⟫):** always expresses necessity and is preferably used predicatively (less frequently attributively). Formations with this suffix should not be used in nominal compounds.
* **-⟪अनीय⟫ (fem. -⟪अनीया⟫) and -⟪य⟫ (fem. -⟪या⟫) / -⟪त्य⟫ (fem. -⟪त्या⟫) (instead of -⟪य⟫/-⟪या⟫):** can have an additional meaning (esp. -⟪य⟫) in the sense of German "-worth" (e.g. "worth seeing") or only possibility "-able" (⟪दृश्य⟫ "visible"). Formations with these suffixes can be negated with ⟪अ⟫-/-⟪अन्⟫- (but not formations with -⟪तव्य⟫) and there are ⟪तत्पुरुष⟫ as their second member in which they occur.
...
Gerundives must not be combined with ⟪सु⟫- and ⟪दुस्⟫- in the meaning "easy" or "difficult". Instead, ⟪तत्पुरुष⟫ of the type  ⟪सुकर⟫ 3 ("easy to do") are used (see [Lesson 18](lektion18.md)).
...
Fig.: ⟪भुजङ्गः⟫
(Image source: [Details](/is/licenses#lekt4105))
...
Fig.: ⟪भुजङ्गस्य विषम्⟫
(Image source: [Details](/is/licenses#lekt4104))
...
Fig.: ⟪शासना⟫
(Image source: [Details](/is/licenses#lekt4109))
...
Fig.: ⟪शास्त्री⟫
(Image source: [Details](/is/licenses#lekt4110))
...
(Image source: [Details](/is/licenses#lekt4111))
