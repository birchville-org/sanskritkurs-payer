...
**Before the final consonants of the zero-grade root, a so-called nasal infix (-na- or -n-) is inserted:**
...
| :--- | :--- | :--- | :--- |
| **Indicative** | **3. sg.** | ⟪युनक्ति⟫:bryu-na-j + -ti | ⟪युङ्क्ते⟫:bryu + n + j + te:(nasals are replaced by -ṅ- before gutturals within the word) |
...
Fig.: ⟪योगः⟫
Yoga depiction.
(Uppruni myndar: [Upplýsingar](/is/licenses#lekt3101))
:::
...
(Uppruni myndar: [Upplýsingar](/is/licenses#lekt3102))
:::
...
(Uppruni myndar: [Upplýsingar](/is/licenses#lekt3103))
:::
...
(Uppruni myndar: [Upplýsingar](/is/licenses#lekt3105))
:::
...
(Uppruni myndar: [Upplýsingar](/is/licenses#lekt3104))
:::
