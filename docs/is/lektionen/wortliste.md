...
**daṇḍanīti** f. = ⟪दण्डनीति⟫ : Politik (ein Tatpuruṣa aus daṇḍa m. = "Stock, Macht, Herrschaft, Strafe" und nīti f. = "richtige Führung").
...
**saha** ⟪सह⟫ : together with, jointly with (also in contexts like "fighting with" etc.) (postposition taking the instrumental case)
