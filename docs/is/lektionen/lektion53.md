...
**The use of the dual is obligatory where two things etc. are concerned:**
...
**Sometimes the dual denotes one male and one female exemplar of the same class (species, genus):**
...
**Words that mean "a pair" - e.g. ⟪युग⟫ n., ⟪द्वन्द्व⟫ n., ⟪द्वय⟫ n. - are always used in the singular, unless two or more pairs are meant:**
...
Fig.: ⟪मार्जारयुगम्⟫
(Image source: [Details](/is/licenses#lekt5301))
...
Fig.: ⟪हस्तौ⟫
(Image source: [Details](/is/licenses#lekt5302))
...
## 53.3. The Dual of Consonant-Stemmed Stems
...
Fig.: ⟪भरन्तौ⟫
(Image source: [Details](/is/licenses#lekt5305))
...
Fig.: ⟪फले⟫
(Image source: [Details](/is/licenses#lekt5306))
...
Fig.: ⟪धेनू⟫
(Image source: [Details](/is/licenses#lekt5307))
...
⟪सुखदुःखे⟫ (besides: ⟪सुखदुःखम्⟫) "Happiness and Suffering"
...
**When two kinship terms ending in -ṛ (or two substantives on -ṛ, which are designations for sacrifice priests) are composed into a Dvandva, the first member stands in the form of the Nominative Singular:**

:::

::: indent

⟪मा⟫:sig[⟪ता⟫]⟪पितरौ⟫ "Mother and Father"

:::

**The same happens with such a kinship term in a Dvandva before -⟪पुत्र⟫ :**
...
**When the names of two deities, which are usually mentioned in sacrifices, form a Dvandva, the final vowel of the first member is usually lengthened:**

::: indent

⟪मि⟫:sig[⟪त्रा⟫]⟪वरुणौ⟫ "Mitra and Varuṇa"
...
Fig.: ⟪पितापुत्रौ⟫
(Image source: [Details](/is/licenses#lekt5308))
...
⟪कतर⟫ 3 "which of both" and ⟪कतम⟫ 3 "which of several" are declined in all cases like ⟪यद्⟫.
...
*   ⟪उभ⟫ 3 "both" is used only in the dual and is declined like ⟪देव⟫ m., ⟪फल⟫ n. and ⟪देवता⟫ f. respectively.

The following pronominal adjectives are declined like ⟪सर्व⟫. In the Abl.Lok.sg.m.n as well as in the Nom.pl., they can be declined according to the -a- or -ā-declension:
...
**While the ⟪तद्धित⟫ suffixes -⟪तर⟫ and -⟪तम⟫ attach to the masculine stem of the adjective, the suffixes -⟪ईयस्⟫ and -⟪इष्ठ⟫ are attached to the root from which the adjective is derived (if such a root exists!). The root vowel is in the strong grade.**
...
| --- | --- | ---
| ⟪क्षिप्⟫ 6P "to throw" | ⟪क्षिप्र⟫ 3 "fast, swift" | :sig[⟪क्षेपीयस्⟫] 3 "faster" :br ⟪क्षिप्रतर⟫ 3 | :sig[⟪क्षेपिष्ठ⟫] 3 "fastest" :br ⟪क्षिप्रतम⟫ 3 |
...
| --- | ---
| ⟪पाप⟫ 3 "evil" | ⟪पा⟫:sig[⟪पी⟫]⟪यस्⟫ | ⟪पा⟫:sig[⟪पि⟫]⟪ष्ठ⟫ |
| ⟪महान्त्⟫ 3 "great, large" | ⟪म⟫:sig[⟪ही⟫]⟪यस्⟫ | ⟪म⟫:sig[⟪हि⟫]⟪ष्ठ⟫ |

:::

::: grammar-box

**Rule 2:** **Possessive suffixes (-mant, vant, -vin, -in etc.) are dropped. If the remaining part consists of only one syllable, it is not further changed; only sound changes caused by the connection with the possessive suffix are reversed. However, if the remainder consists of more than one syllable, Rule 1 applies.**
...
| Adjective | Comparative | Superlative |
| --- | ---
| ⟪धनवन्त्⟫ 3 "rich" | ⟪ध⟫:sig[⟪नी⟫]⟪यस्⟫ | ⟪ध⟫:sig[⟪नि⟫]⟪ष्ठ⟫ |
| ⟪बलिन्⟫ 3 "(especially) strong" | ⟪ब⟫:sig[⟪ली⟫]⟪यस्⟫ | ⟪ब⟫:sig[⟪लि⟫]⟪ष्ठ⟫ |
| ⟪वसुमन्त्⟫ "possessing goods" | ⟪व⟫:sig[⟪सी⟫]⟪यस्⟫ | ⟪व⟫:sig[⟪सि⟫]⟪ष्ठ⟫ |

:::

::: grammar-box

**Rule 3:** **-ra- is substituted for -ṛ-, when it is preceded by an initial vowel and followed by only a single consonant.**
...
**List of the most frequent comparative forms of this type for adjectives learned so far:**
...
| ⟪क्षिप्र⟫ 3 "fast" :br (from ⟪क्षिप्⟫) | ⟪क्षेपीयस्⟫ | ⟪क्षेपिष्ठ⟫ |
| ⟪गुरु⟫ 3 "heavy" :br (from *⟪गृ⟫) | ⟪गरीयस्⟫ | ⟪गरिष्ठ⟫ |
| ⟪दीर्घ⟫ 3 "long" :br (from *⟪दृघ्⟫) | ⟪द्राघीयस्⟫ | ⟪द्राघिष्ठ⟫ |
| ⟪दूर⟫ 3 "far" :br (from *⟪दु⟫/*⟪दू⟫) | ⟪दवीयस्⟫ | ⟪दविष्ठ⟫ |
...
(Image source: [Details](/is/licenses#lekt5309))

:::

**Some comparative forms of this type have no root-related basic form at all; they are "defective". Therefore, the following series must be memorized especially well:**
...
| (⟪प्रशस्य⟫ 3 "praiseworthy, good") | ⟪श्रेयस्⟩ :br from ⟪श्री⟫ f. "splendor" | ⟪श्रेष्ठ⟩ |
| (⟪प्रशस्य⟫ 3 "praiseworthy, good") | ⟪ज्यायस्⟩ :br also: "older" :br from ⟪ज्या⟫ f. "superiority" | ⟪ज्येष्ठ⟩ :br also: "oldest" |
| (⟪बहु⟫ 3 "much") | ⟪भूयस्⟩ | ⟪भूयिष्ठ⟩ |
| (⟪वृद्ध⟫ 3 "old") | ⟪वर्षीयस्⟩ :br from ⟪वर्ष⟩ n.m. "rainy season, year" | ⟪वर्षिष्ठ⟩ |
| (⟪वृद्ध⟫ 3 "old") | ⟪ज्यायस्⟩ :br also: "better" :br from ⟪ज्या⟩ f. "superiority" | ⟪ज्येष्ठ⟩ :br also: "best" |
...
**Comparatives ending in -īyas form the feminine in -īyasī (declension like ⟪देवी⟫). The masculine and neuter are declined according to the following paradigm.**
...
## 53.10. Metrics (The Science of Metrical Feet)
...
(Image source: [Details](/is/licenses#lekt5303))
...
1. **Fagurfræðilegt:** Vísnamælingin stuðlar meðal annars að fegurð yfirlýsingar. Ennfremur geta ákveðnar mælingar þjónað til að tjá sérstakar stemningar, eða þær eru tengdar ákveðnum samfélagsstéttum (⟪वर्ण⟫). Hinum ýmsu mælingum er kveðið á mismunandi hátt. :br Góða hugmynd um fagurfræðileg áhrif má fá, til dæmis, úr upplestri ⟪शिवताण्डवस्तोत्र⟫ (sálmurinn sem lofar dans Śiva): [http://de.youtube.com/watch?v=5KjfiJlkO58](http://de.youtube.com/watch?v=5KjfiJlkO58)
2. **Textafræðilegt:** Villur í vísnamælingu geta bent til þess að texti hafi ekki verið rétt sendur á ákveðnum stað. Vísnamælingin hjálpar til við að gera textaleiðréttingar.
3. **Tímaröð:** Ákveðnar mælingar gengust undir sérstakar breytingar í gegnum söguna. Þetta getur hjálpað til við að áætla aldur texta. Sjá hér **Oldenberg, Hermann (1854–1920):** Zur Geschichte der Triṣṭhubh ; ders.: Zur Geschichte des Śloka. -- Báðir endurprentaðir í: :br **Oldenberg, Hermann (1854–1920):** Kleine Schriften / Hermann Oldenberg. Ritstýrt af Klaus L. Janert. -- Wiesbaden : Steiner. -- 3 bindi. -- (Glasenapp-Stiftung ; ...). -- Bindi 2. -- 1967. -- Bls. 1188 - 1255.
...
(Image source: [Details](/is/licenses#lekt5304))

:::

### 53.10.2. Types of Meters
...
**For the meters, where the number of syllables is fixed (⟪वृत्त⟫), one can initially make a further distinction:**

*   Meters, where the number of syllables is fixed, but the quantity of these syllables only partially
*   Meters, where the number of syllables and their quantity is fixed
...
the fifth in all Pādas light.
The seventh syllable is short in the second and fourth Pāda, long in the other two."
The most important verse meter in the epics (⟪महाभारत⟫, ⟪रामायण⟫) as well as countless other works is the Śloka ("call", "noise", "stanza" from ⟪श्रु⟫ "to hear").

::: grammar-box

**The ⟪श्लोक⟫ is a double verse consisting of half-verses each with 16 syllables. Each half-verse again divides into two quarter-verses (⟪पाद⟫) of 8 syllables each. Each quarter-verse divides into two parts of 4 syllables each. The entire verse (⟪पद्य⟫ n.) thus consists of four ⟪पाद⟫ (m. "foot, quarter"). The four ⟪पाद⟫ are numbered consecutively with a, b, c, (⟪क्⟫, ⟪ख्⟫, ⟪ग्⟫, ⟪घ्⟫).**
...
The second and third syllable of a ⟪पाद⟫ should not simultaneously be ⟪लघु⟫. In b and d, syllables 2-4 may not be ¯ ˘ ¯.
