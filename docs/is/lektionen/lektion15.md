...
In determinative compounds (Tatpuruṣa), a noun (substantive or adjective) is specified more precisely by another noun or adverb. The word being specified usually forms the second member of the compound.

The relationship between the first member (determining element) and the second member (determined element) can be:

*   attributive or appositional: upon resolution of the compound, the first member forms a specification for the second member in the same case (i.e., outside of sentence context, in the nominative (⟪प्रथमा⟫); within a sentence, in the syntactically required case)
...
Fig.: ⟪लक्ष्मी⟫
(Image source: [Details](/is/licenses#lekt1501))
:::
...
*   If a Karmadhāraya expresses an apposition (further specification of the second member by a noun), then the specifying element stands in the first member, as also required by the general rule for the order of members in a Tatpuruṣa:
...
Fig.: ⟪नरसिंहः⟫
(Image source: [Details](/is/licenses#lekt1503))
:::
...
The first member may stand in the singular, dual, or plural when resolving the compound. Which possibility is present must be inferred from meaning and context.
...
![](/images/lekt1502.jpg)
Fig.: ⟪समासविच्छेदः⟫
(Image source: [Details](/is/licenses#lekt1502))
:::
...
2nd level (first secondary caesura): ⟪गुणवत्पुत्रेण ॥२॥ कृतं ॥१॥ पुण्यम्⟫

3rd level (second secondary caesura): ⟪गुणवता॥३॥ पुत्रेण ॥२॥ कृतं ॥१॥ पुण्यम्⟫

= "the meritorious deed (merit) that my virtuous son has performed"
:::
Different types of compounds can be mixed here, e.g. first member: Bahuvrīhi (⟪बहुव्रीहि⟫) - second member: Tatpuruṣa etc.
...
::: indent
1st level: ⟪ब्राह्मणक्षत्रियवैश्यानां धर्मः⟫ (first member: Itaretaradvandva)
...
In all types of compounds, the first member is generally the unchanged stem. Two-stem nouns stand in the weak stem. Feminine adjectives, which specify a following member in the compound, generally stand in the masculine stem:
...
Fig.: ⟪पूजा⟫
(Image source: [Details](/is/licenses#lekt1504))
:::
...
Fig.: ⟪इन्द्रः⟫
(Image source: [Details](/is/licenses#lekt1505))
:::
...
Fig.: ⟪सिंहः⟫
(Image source: [Details](/is/licenses#lekt1506))
:::
⟪व्याघ्र⟫ m.: tiger (_Panthera tigris tigris_) (lit.: growler)
::: media
![](/images/lekt1507.webp)
Fig.: ⟪व्याघ्रः⟫
(Image source: [Details](/is/licenses#lekt1507))
:::
...
Abb.: ⟪ग्रामदेवता⟫
(Uppruni myndar: [Details](/is/licenses#lekt1508))
:::
## 15.11. Æfing 3
