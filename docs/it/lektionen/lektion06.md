...
:::
Quando l'agente (**kartṛ** m. = ⟪कर्तृ⟫) è menzionato in una frase verbale che non è al passivo, allora l'agente è in **nominativo** (primo caso, prathamā = ⟪प्रथमा⟫). Nel numero (vacana n. = ⟪वचन⟫) l'agente e la forma verbale concordano.
...
3. Modalità (genus verbi):
   ...
   3. **Passivo** (**karman** n. = ⟪कर्मन्⟫). p.es. **ijyate** = ⟪इज्यते⟫ = "Viene venerato con un sacrificio"

   In molti casi la sfumatura di significato dell'Ātmanepada non è più riconoscibile; anche i poeti colti spesso usano l'Ātmanepada senza differenza di significato rispetto al Parasmaipada. Tuttavia, nella traduzione è sempre necessario prestare attenzione se non vi sia una tale sfumatura di significato.

   I verbi che sono usati nel Parasmaipada e nell'Ātmanepada (nella specifica accezione dell'Ātmanepada) sono detti verbi **Ubhayapada** (**ubhayapada** n. = ⟪उभयपद⟫ = "entrambe le forme verbali").

   Alcuni verbi sono usati o solo nel Parasmaipada o solo nell'Ātmanepada. In questi verbi l'Ātmanepada o il Parasmaipada non hanno un significato specifico. p.es. **manyate** = ⟪मन्यते⟫ = "egli (lei, esso) pensa" (senza specifica accezione Ātmanepada).
...
::: grammar-box
**L’indicativo (forma affermativa) presente si forma aggiungendo allo stemma del presente le cosiddette desinenze primarie.**
:::
Esempi:
...
| **nṛt** = ⟪नृत्⟫ | **nṛtya** = ⟪नृत्य⟫ | **nṛtyati** = ⟪नृत्यति⟫ = "egli (lei, esso) danza" |

## 6.4. Desinenze primarie della terza persona (prathama m. = ⟪प्रथम⟫ = "prima (!) persona")

::: grammar-box
| | Singolare (Einzahl):brekavacana n.:br⟪एकवचन⟫ | Plurale (Mehrzahl):brbahuvacana n.:br⟪बहुवचन⟫ |
| :--- | :--- | :--- |
...
- Stemmas del presente: **yaja** = ⟪यज⟫
  - 3. sg. P. **yajati** = ⟪यजति⟫
  - 3. pl. P. **yajanti** = ⟪यजन्ति⟫
  - 3. sg. Ā. **yajate** = ⟪यजते⟫
  - 3. pl. Ā. **yajante** = ⟪यजन्ते⟫

## 6.5. Formazione dello stemma del presente

### 6.5.1. Verbi della 6. classe del presente (tudādi = ⟪तुदादि⟫ = "tud ecc.")

::: grammar-box
**Stemmas del presente = Radice in grado debole (in cui è elencata) + a-**

| Radice (dhātu m.):br⟪धातु⟫ | Tema del presente |
| :--- | :--- |
...
::: grammar-box
| Grado debole:brSchwundstufe | Hochstufe:brVollstufe:brGuṇa m.:br⟪गुण⟫ | Dehnstufe:brVṛddhi f.:br⟪वृद्धि⟫ |
| :--- | :--- | :--- |
| **ø** | **a** | **ā** |
| **i / ī** | **e** | **ai** |
| **u / ū** | **o** | **au** |
...
:::
### 6.5.4. Vocale tematica, classi tematiche del presente

::: grammar-box
La **a** nei suffissi di formazione dello stemma delle classi del presente è detta **vocale tematica**. Le classi del presente con **a** nel suffisso di formazione dello stemma sono dette pertanto "classi tematiche del presente".
:::

## 6.6. Sanscrito parlato: altre domande (praśna m. = ⟪प्रश्न⟫)
...
::: grammar-box
In sanscrito i verbi sono elencati nella **forma di radice**. Il numero dopo la radice indica la **classe di coniugazione**.

- **P:** La radice è solo Parasmaipada
- **Ā:** La radice è solo Ātmanepada
- **U:** Ubhayapada ("entrambe le forme verbali"): la radice è usata sia nel Parasmaipada che nell'Ātmanepada.
...
- **sṛj** 6 P (sṛjati) ⟪सृज्⟫ ⟪सृजति⟫ : lasciare andare, emettere, far emanare

## 6.8. Esercizio

**A) Formare con le radici indicate tra parentesi inserendo frasi verbali:**
...
1. Egli onora con un sacrificio. (Il sacerdote sacrificale per un signore del sacrificio)
2. Śiva danza.
3. Rāma conduce.
...
15. Questi brāhmaṇa offrono sacrifici per conto di altri.
16. Brāhmaṇa, Kṣatriya e Vaśya sono due volte nati. (2 possibilità)
17. Le scienze (per un principe) sono: filosofia, il triplice (sapere vedico), economia e politica. (2 possibilità)
18. Come stai?
