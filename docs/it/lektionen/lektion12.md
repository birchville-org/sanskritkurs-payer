...
Non è necessario un verbo ausiliare ("essere").
...
::: grammar-box
**Agente (kartṛ) in Nominativoooooo (prathamā) -- Participio Perfetto Passivo**
...
Poiché il cosiddetto „Participio Perfetto Passivo“ per i verbi transitivi ha principalmente significato passivo (**āpta** = „raggiunto (essere stato)“) e per i verbi intransitivi e i verbi di movimento ha significato attivo (**gata** = „andato“), esistono alcuni verbi per i quali il PPP può avere sia significato attivo che passivo:

ad esempio
- **gata** = ⟪गत⟫ = „andato“ (attivo); ma anche: **gato mārgaḥ** = ⟪गतो⟫ ⟪मार्गः⟫ = „un percorso percorso“ (passivo)
- **āpta** = ⟪आप्त⟫ = „essere stato raggiunto“ (passivo), „avente raggiunto“ (attivo)
...
- **+ -ta**
  - con vocale di giunzione **-i-** prima: **-ita**
  - senza vocale di giunzione: **-ta**
- **+ -na**
...
#### 12.3.1.1. Senza vocale di collegamento -i- (aniṭ)
...
| Radice:br⟪धातु⟫ | Passiv Presente 3. sg. Indikativ:br⟪यक्⟫ ⟪लट्⟫ | PPP:br⟪क्त⟫ |
| :--- | :--- | :--- |
