# Esercizio di scrittura 10

### Seconda regola per la formazione di legature consonantiche

\[Vedi la prima regola in [Esercizio di scrittura 8](schrift08.md)\]

Se la prima delle consonanti da combinare non termina con un tratto verticale, allora la consonante successiva viene posta sotto la prima consonante con la perdita del proprio tratto orizzontale.

Eccezioni: Se म् o य् sono il secondo elemento della legatura, essi vengono scritti abbreviati dopo il primo segno:
...
Esempi (le eccezioni sono sottolineate):
...
Scrivete tutte le legature sopra elencate.

### Elenco delle legature più comuni nel tipo di carattere della Grammatica di Kielhorn
