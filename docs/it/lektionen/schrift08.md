...
### Legature di consonanti

Quando in una parola o in una frase due o più consonanti si susseguono immediatamente, esse vengono scritte con una legatura (segno unito).

1. Se il primo dei segni consonantici da unire termina con la barra verticale a destra, perde questa barra e viene posto prima della seconda consonante.

Eccezione: se il secondo segno consonantico è न् o ल्, questo viene posto sotto il primo segno consonantico, perdendo la barra orizzontale. A seconda del tipo di carattere esistono ulteriori eccezioni, elencate di seguito. Se una legatura non è prevista nel tipo di carattere in questione, viene posto un Virāma.

Esempi:

Nel tipo di carattere utilizzato in questo script:
...
A) Scrivere tutte le legature presenti nell'elenco precedente

B) Scrivere e tradurre:
...
D) Leggere, traslitterare e tradurre:
