...
## 16.1. Sobre o Sandhi de consoantes finais

Para a formação de compostos, cujo primeiro membro é um tema de terminação consonantal, são necessárias as seguintes regras:

Oclusivas guturais, retroflexas, dentais e labiais finais (isto é, sem nasais e palatais).

::: no-header

|   |   |
| :--- | :--- |
| **em pausa e antes de sons surdos** | **Substituição pelo som surdo não aspirado correspondente:** :br **p. ex.** :br :indent -g + p- » -kp- :br :indent -d + ph- » -tph- :br :indent -dh + p- » -tp- |
| **antes de sons sonoros não nasais** | **Substituição pelo som sonoro não aspirado correspondente:** :br **p. ex.** :br :indent -t + g- » -dg- :br :indent -k + b- » -gb- :br :indent -dh + d- » -dd- :br :indent -k + a- » -ga- |
| **antes de nasais** | **Substituição pela nasal correspondente:** :br **p. ex.** :br :indent -t + n- » -nn- :br :indent -p + n- » -mn- |

:::
Exceção à regra acima:

Oclusiva dental final (não nasal):

::: no-header

|   |   |
| :--- | :--- |
| **antes de Palatal** | **Substituição pela palatal não aspirada correspondente:** :br **ou seja** :br :indent -t + c- » -cc- :br :indent -d + c- » -cc- :br :indent -th + c- » -cc- :br :indent -dh + c- » -cc- :br :indent -t/-th/-d/-dh + ch- » -cch- :br :indent -t/-th/-d/-dh + j- » -jj- :br :indent -t/-th/-d/-dh + jh- » -jjh- |
| **+ ś** | **» -cś- ou -cch-** |
| **antes de Retroflexa** | **Substituição pela retroflexa não aspirada correspondente:** :br **ou seja** :br :indent -t/-th/-d/-dh + ṭ(h)- » -ṭṭ(h)- :br :indent -t/-th/-d/-dh + ḍ(h)- » -ḍḍ(h)- |
| **antes de l-** | **Substituição por -l:** :br **ou seja** :br :indent -t/-th/-d/-dh + l- » -ll- |
...
## 16.2. Lista de palavras

⟪अध्यापन⟫ n.: ensinar, instrução
...
⟪नृशंस्य⟫ n.: maldade, baixeza

disso:

::: indent
⟪अनृशंस्य⟫ n.: ausência de maldade
:::
...
⟪आजीव⟫ m.: sustento
:::
⟪क्षमा⟫ f.: paciência, longanimidade, indulgência
...
⟪शस्त्र⟫ (śastra) n.: ferramenta de corte, arma de corte, espada, arma

⟪शौच⟫ n.: purificação, pureza

⟪साधन⟫ m.,n. ⟪साधनी⟫ ⟪साधना⟫ f.: que conduz ao objetivo, que efetua

⟪अहिंसा⟫ f.: o não-fazer-mal-a-ninguém, não-ferimento, não-violência
...
B) Nas frases seguintes, resolva todos os compostos em sânscrito, formando assim frases com substantivos flexionados, e traduza:
...
## 16.4. Exercício de revisão

A) Forme todos os casos aprendidos até agora para as seguintes palavras, como exemplos para as classes de declinação aprendidas até agora.

Para isso, use o seguinte esquema, que corresponde à ordem dos casos dos gramáticos indianos e que, devido às suas vantagens — a serem discutidas mais tarde —, também foi adotado pelos gramáticos ocidentais:
...
Memorize os padrões de declinação de acordo com estes exemplos!!!
...
B) Traduza e analise todos os compostos em sânscrito:
...
Frase 7: ⟪कृषिपाशुपाल्ये⟫ Dual, Nom. Ac.: Dvandva, que designa duas "coisas"

Frase 8: ⟪कर्म⟫ Nom., Ac. sg. Neutro de ⟪कर्मन्⟫ "ato"

Frase 13: ⟪सर्वेषाम्⟫ Gen. pl. masc. de ⟪सर्व⟫ "cada um, todos" (Pronome, não declina como deva)
:::
