...
(Fonte da imagem: [Detalhes](/licenses#lekt5101))
:::
b) ⟪कृत्⟫-sufixo -t
...
Fig.: ⟪पापकृत्⟫
⟪भरतपुर⟫, ⟪राजस्थान⟫
(Fonte da imagem: [Detalhes](/licenses#lekt5103))
:::
c) Sufixo ⟪कृत्⟫ -a

::: indent
\-⟪ग⟫ 3 "indo (em, para)" (provavelmente da raiz gā, grau zero g + a) p. ex. ⟪खग⟫ 3 "voando" m. "pássaro, planeta" (⟪ख⟫ n. "buraco, 'espaço aéreo'")

\-⟪घ्न⟫ 3 "matando" p. ex. ⟪कुलघ⟫ 3 "matando a(s) família(s)"

\-⟪ज⟫ 3 (jña » jā » grau zero j + a) "descendente de, nascido em" p.ex. ⟪आत्मज⟫ "filho"

\-⟪ज्ञ⟫ 3 "conhecedor" (jñ-a) p.ex. ⟪सर्वज्ञ⟫ 3 "onisciente"

\-⟪द⟫ 3 "que dá" (d-a) p.ex. ⟪वारिद⟫ m. "nuvem" (⟪वारि⟫ n. "água")

\-⟪प⟫ 3 "que bebe" (p-a) p.ex. ⟪द्विप⟫ m. "elefante (que bebe duas vezes)"

\-⟪प⟫ 3 "protetor" (p-a) p.ex. ⟪भूप⟫ "protegendo a terra = rei"
...
⟪नेपाल⟫
(Fonte da imagem: [Detalhes](/licenses#lekt5102))
:::
...
Plural Nom.Ac.Voc. sig[⟪शत्रुजिन्ति⟫]
:::
...
::: grammar-box
**O ch- inicial é substituído por cch- após uma vogal curta, após ⟪मा⟫ "não" e após ⟪आ⟫ "para":**
...
⟪अजिन⟫ n.: pele de antílope, esp. a pele do antílope-negro (antílope-cervicapra: _Antilope cervicapra_ L.). Originalmente encontrado em todo o subcontinente indiano, do Punjab e Sind até Bengala e do Nepal até Kanyakumari (Cabo Comorim) (Tâmil: கன்னியாகுமரி) Ver:
...
:::
⟪शिवा⟫ f.: chacal (fêmea) (chacal-dourado = _Canis aureus_)
...
Fig.: ⟪भुजंगः⟫
Víbora-de-russell (_Daboia russelii_), Bangalore = ಬೆಂಗಳೂರು
...
⟪२⟫. ⟪कौटिलीयार्थशास्त्र⟫ ⟪१⟫, ⟪३⟫, ⟪१६⟫ - ⟪१७⟫ Sobre a necessidade de prestar atenção ao ⟪वर्नाश्रमधर्म⟫
...
⟪प्रसीदति⟫ ⟪न⟫ ⟪सीदति⟫ ⟪॥१७॥⟫
:::
⟪३⟫. ⟪बाण⟫ (séc. VII d.C.): ⟪कादम्बरी⟫ ed. K.P. Parab, 1896, pp. 65ss.: Reflexões do papagaio ⟪वैशम्पायन⟫ sobre a existência de caçador:
...
⟪४⟫. Comentário de ⟪भानुचन्द्र⟫ (séc. XVI) à seção anterior da ⟪कादम्बरी⟫ (este exercício deve ser traduzido sob a orientação de um professor. Se um não estiver disponível, pode-se pulá-lo)
