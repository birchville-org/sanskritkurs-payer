...
Wissen, das (nur) in Büchern steht, und Geld, das in fremder Hand ist: Wenn der Augenblick des Bedarfs eintritt, ist dieses Wissen kein Wissen und dieses Geld kein Geld. <!-- TODO: Fallback translation -->

⟪२⟫. **⟪उपदेशो⟫ ⟪हि⟫ ⟪मूर्खाणां⟫ ⟪प्रकोपाय⟫ ⟪न⟫ ⟪शान्तये⟫ ⟪।⟫**  
**⟪पयःपानं⟫ ⟪भुजङ्गानां⟫ ⟪केवलं⟫ ⟪विषवर्धनम्⟫ ⟪॥⟫ ⟪२⟫ ⟪॥⟫**  
Unterweisung für Toren führt zur Erbitterung, nicht zum Frieden. Das Trinken von Milch durch Schlangen ist lediglich eine Vermehrung des Giftes. <!-- TODO: Fallback translation -->
...
"Ich nehme Zuflucht zum Buddha, ich nehme Zuflucht zum Dharma, ich nehme Zuflucht zum Sangha" — dies ist von denen zu sagen, die zum Buddha gegangen sind. <!-- TODO: Fallback translation -->
...
Das Wesentliche ist jedoch nicht die Erlöserpersönlichkeit, sondern die Erlösungslehre, die es dem Einzelnen ermöglicht, den Weg selbst zu gehen. Man muss von der Lehre so überzeugt sein, dass man die Energie aufbringt, sie auf ihren Wahrheitsgehalt zu testen (**Zuflucht zum Dharma**). <!-- TODO: Fallback translation -->
...
"Ich werde nach Benares (Kāśī) gehen, den Ganges sehen und dort sterben" — mit diesem Gedanken verliess der ehrenwerte alte Mann Söhne, Enkelsöhne und Besitz und zog nach Benares aus. Ich denke, dass er so das zu beendende Leiden überwinden wird. <!-- TODO: Fallback translation -->
...
"Ich habe ein Mädchen geheiratet, mit ihr einen Sohn gezeugt und grossen Reichtum erlangt; so habe ich das Glück erreicht" — in dieser Weise täuschte ich mich in der Vergangenheit. Dann erkannte ich: Aus Glück entsteht Leid; deshalb ist auch das weltliche Glück aufzugeben, und nichts sollte mit den Sinnen berührt werden. <!-- TODO: Fallback translation -->
...
Nachdem er die zu verkaufenden Waren veräussert hatte, gab der sohnlose Vaiśya den Erlös den Mönchen und empfing das Verdienst der Gabe. Die Mönche verkündeten: "Diese Tat ist lobenswert." Die Einsichtigen jedoch zweifeln, ob der so handelnde Vaiśya tatsächlich Verdienstvolles getan hat. <!-- TODO: Fallback translation -->

⟪५⟫. **⟪गुरुभिः⟫ ⟪शिष्याः⟫ ⟪शासितव्याः⟫ ⟪शिष्यैरध्ययनमध्येतव्यम्⟫ ⟪॥⟫ ⟪५⟫ ⟪॥⟫**
Von Lehrern sind Schüler zu unterweisen; von Schülern ist das Pensum zu studieren. <!-- TODO: Fallback translation -->
