...
**Skeem:**
**(Tegevuse sooritaja - kartṛ - instrumentaalis (tṛtīyā)) - (otsene objekt - karman - nominatiivis) - passiivne tegusõnavorm**
...
**Sanskrit passive sentences generally should not be rendered in German by a passive sentence, as the German passive has a completely different stylistic function.**
...
**Masculine and Neuter on -a (irregular in singular and plural):**
...
| :--- | :--- | :--- | :--- |
| **tad** :br"he, she, it; the, the, the" (mentioned):br⟪तद्⟫ | M/N | **tena** :br⟪तेन⟫ | **tais** :br⟪तैस्⟫ |
| | F | **tayā** :br⟪तया⟫ | **tābhis** :br⟪ताभिस्⟫ |
| **etad** :br"this, this, this" (very close to the speaker):br⟪एतद्⟫ | M/N | **etena / enena** :br⟪एतेन⟫ / ⟪एनेन⟫ | **etais** :br⟪एतैस्⟫ |
| | F | **etayā / enayā** :br⟪एतया⟫ / ⟪एनया⟫ | **etābhis** :br⟪एताभिस्⟫ |
| **idam** :br"this, this, this" (close):br⟪इदम्⟫ | M/N | **anena / enena** :br⟪अनेन⟫ / ⟪एनेन⟫ | **ebhis** :br⟪एभिस्⟫ |
...
**Instrumentaal (tṛtīyā) vastab peamiselt küsimustele:**
**Mille läbi?**
**Millega?**
**Kellega?**
...
A **-n-**, followed by a vowel or **n, m, y, v**, is replaced by **-ṇ-**, if **ṛ, ṝ, r, ṣ** precede the **-n-** in the word or no other sound than vowels, gutturals, labials, **y, v, h** or Anusvāra stands between these sounds and the following **-n-** in the word.
...
**Nii on seletatav ka -ṇ- järgmistes sõnades:**
...
## 10.4. Passiiv, indikatiivi olevik (yak = ⟪यक्⟫)

::: grammar-box

**Bildung:**
**(usually) weak-grade root + -ya- + Ātmanepada ending**
...
**Note that for verbs of the 4th present class, the Ātmanepada and the passive have identical forms! Whether it is Ātmanepada or passive in this case can only be inferred from the sentence structure.**
...
| :--- | :--- | :--- | ->    | :--- | :--- | :--- |
| **yaj** 1 U:br⟪यज्⟫ | \*yj &raquo; ij | **ijyate** :br⟪इज्यते⟫:br **ijyante** :br⟪इज्यन्ते⟫ | ->    | **yaj** 1 U:br⟪यज्⟫ | \*yj &raquo; ij | **ijyate** :br⟪इज्यते⟫:br **ijyante** :br⟪इज्यन्ते⟫ |
| **vad** 1 P:br⟪वद्⟫ | \*vd &raquo; ud | **udyate** :br⟪उद्यते⟫:br **udyante** :br⟪उद्यन्ते⟫ | ->    | **vad** 1 P:br⟪वद्⟫ | \*vd &raquo; ud | **udyate** :br⟪उद्यते⟫:br **udyante** :br⟪उद्यन्ते⟫ |
| **prach** 6 P:br⟪प्रच्छ्⟫ | \*prcch &raquo; pṛcch | **pṛcchyate** :br⟪पृच्छ्यते⟫:br **pṛcchyante** :br⟪पृच्छ्यन्ते⟫ | ->    | **prach** 6 P:br⟪प्रच्छ्⟫ | \*prcch &raquo; pṛcch | **pṛcchyate** :br⟪पृच्छ्यते⟫:br **pṛcchyante** :br⟪पृच्छ्यन्ते⟫ |
...
* **tā-ya-te**, **tā-ya-nte** :br⟪तायते⟫, ⟪तायन्ते⟫ (pärit \*tn-ya-nte)
...
For city and village life, see Basham, *Wonder*, Ch. 6.
  :::
...
In India, the sacrifice is primarily a veneration of the deity as a guest. By this, one obligates the deity.
...
In India, magic power was attributed to the true word; indeed, the entire cosmic order is maintained and created by the true word. For this important concept, see the fundamental work:
...
In India, magical power was attributed to the true word; indeed, the whole cosmic order is maintained and created by the true word. For this important concept, see the fundamental work:
...
(Pildi allikas: [Details](/et/licenses#lekt1003))
...
Nende **ṛṣi**de nimed on mainitud Brāhmaṇates ja ka Veedade eraldi loendites. Kõik braahmanid tuletavad oma päritolu sellistest **ṛṣi**dest, kelle järgi on nimetatud nende **gotra** (⟪गोत्र⟫). Mõiste **gotra** kohta vaata Basham, *Wonder*, ptk. 5.
  :::
...
(Pildi allikas: [Details](/et/licenses#lekt1002))
...
(Pildi allikas: [Details](/et/licenses#lekt1004))

:::

5. Õpetajad küsivad. (passiivne konstruktsioon)
6. Silm juhib. (passiivne konstruktsioon)
7. Luuletaja näeb jumalust. (passiivne konstruktsioon)
8. Kes (naissoost) valvab tüdrukut? (passiivne konstruktsioon)
9. Kṣatriya kummardab ISANDAT ohvriga. (passiivne konstruktsioon, ilma sõna **yajña** kasutamata)
10. Suuremeelsuse kaudu saavutab Buddha järgija taeva.
