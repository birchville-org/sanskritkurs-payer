# Kirjutamisharjutus 10

### Teine reegel kaashäälikuühendite moodustamiseks

[Erste Regel siehe in [Schriftübung 8](schrift08.md)]

Kui esimene ühendatavatest kaashäälikutest ei lõpe vertikaalse joonega, siis asetatakse järgnev kaashäälik ilma oma horisontaalse jooneta esimese kaashääliku alla.

Erandid: Kui ⟪म्⟫ või ⟪य्⟫ on ühendi teine liige, kirjutatakse need lühendatult esimese märgi järele:
...
Näited (erandid on alla joonitud):
...
Kirjutage kõik ülaltoodud ühendid

Verzeichnis der gebräuchlichsten Ligaturen in der Schrifttype von Kielhorns Grammatik
