...
**Sometimes the dual denotes one male and one female specimen of the same class (species, genus):**
...
Fig.: ⟪मार्जारयुगम्⟫
(Image source: [Details](/et/licenses#lekt5301))
...
Fig.: ⟪हस्तौ⟫
(Image source: [Details](/et/licenses#lekt5302))
...
**Participle Present Parasmaipada**
...
Fig.: ⟪फले⟫
(Image source: [Details](/et/licenses#lekt5306))
...
(Pildi allikas: [Details](/et/licenses#lekt5307))
...
**When two kinship terms ending in -ṛ (or two substantives on -ṛ, which are designations for sacrificial priests) are compounded into a Dvandva, the first member stands in the form of the Nominative Singular:**
...
Fig.: ⟪पितापुत्रौ⟫
(Image source: [Details](/et/licenses#lekt5308))
...
⟪कतर⟫ 3 "kumbki" ja ⟪कतम⟫ 3 "mitmest" käänduvad kõigis käänetes nagu ⟪यद्⟫.

## 53.7. Pronominaladjektive

Järgmised pronominaalsed omadussõnad käänduvad kõigis käänetes nagu ⟪यद्⟫:

*   ⟪अन्य⟫ 3 "teine"
*   ⟪अन्यतर⟫ 3 "üks kahest"
*   ⟪इतर⟫ 3 "teine"

*   ⟪सर्व⟫ 3 "iga, kõik" käändub kõigis käänetes, välja arvatud nominatiivi-akusatiivi ainsuse neutrum (⟪सर्वम्⟫), nagu ⟪यद्⟫.
*   ⟪उभय⟫ 3 "mõlemad" ei oma duaali. Ainsuses ja mitmuses, maskuliinis ja neutrumis käändub see nagu ⟪सर्व⟫. Feminiin: ⟪उभयी⟫ (nagu ⟪देवी⟫).
*   ⟪उभ⟫ 3 "mõlemad" kasutatakse ainult duaalis ja see käändub nagu ⟪देव⟫ m., ⟪फल⟫ n. või ⟪देवता⟫ f.

Järgmised pronominaalsed omadussõnad käänduvad nagu ⟪सर्व⟫. Ablatiivi-lokatiivi ainsuse maskuliinis ja neutrumis ning nominatiivi mitmuses võivad need käänduda vastavalt -a- või -ā-käändelõppude järgi:

*   ⟪अपर⟫ 3 "teine"
*   ⟪उत्तर⟫ 3 "ülemine, põhjapoolne, järgnev"
*   ⟪पर⟫ 3 "järgnev, hilisem"
*   ⟪पूर्व⟫ 3 "eelnev, idapoolne"
*   ⟪स्व⟫ 3 "oma (minu, sinu, tema ...)"

## 53.8. Unregelmässige Steigerung

::: grammar-box

**Mõned omadussõnad moodustavad komparatiivi või superlatiivi järgmiste ⟪कृत्⟫-sufiksitega (!):**
...
| ⟪महान्त्⟩ 3 "great" | ⟪म⟩:sig[⟪ही⟩]⟪यस्⟩ | ⟪म⟩:sig[⟪हि⟩]⟪ष्ठ⟩ |
...
**List of the most frequent inflectional forms of this type for adjectives learned so far:**
...
| ⟪क्षिप्र⟫ 3 "quick" :br (from ⟪क्षिप्⟫) | ⟪क्षेपीयस्⟫ | ⟪क्षेपिष्ठ⟫ |
...
(Image source: [Details](/et/licenses#lekt5309))

:::

**Some inflectional forms of this type have no root-related base form at all; they are "defective". Therefore, the following paradigms must be memorized especially well:**
...
(Image source: [Details](/et/licenses#lekt5303))
...
(Image source: [Details](/et/licenses#lekt5304))

:::

### 53.10.2. Types of Metres
...
*   **⟪जाति⟫ f.:** Metres in which the sum of metrical units (⟪मात्रा⟫) (morae) is fixed (see below for these)

**For those metres in which the number of syllables is fixed (⟪वृत्त⟫), one can initially distinguish further:**

*   Metres in which the number of syllables is fixed, but the quantity of these syllables only partially
*   Metres in which the number of syllables and their quantity is fixed
...
*   on pikk,
*   on visarga,
*   as well as when it stands before a consonant cluster
*   as well as when the syllable stands at the end of a quarter-verse (Pāda)."
...
**⟪लघु⟫ = kerge on silp, kui**

*   selle täishäälik on lühike ja sellele täishäälikule
*   ei järgne Anusvārat,
*   ei järgne Visargat,
...
Meetrilises analüüsis tähendab:
...
### 53.10.4. Eepiline Śloka (⟪श्लोक⟫ m.)
...
"Ślokas on Pāda kuues silp raske,
viies kõigis Pādades kerge  
Seitsmes silp on teises ja neljandas Pādas lühike, teistes kahes pikk."
Kõige olulisem värsimõõt eepostes (⟪महाभारत⟫, ⟪रामायण⟫) ja lugematutes teistes teostes on Śloka ("kutse", "heli", "stroof" sõnast ⟪श्रु⟫ "kuulma").
...
⟪पाद⟫ teine ja kolmas silp ei tohiks olla korraga ⟪लघु⟫. b-s ja d-s ei tohi silp 2–4 olla ¯ ˘ ¯.

**Kõrvalskeemid (⟪विपुला⟫) a ja c jaoks:**
...
**In all Śloka forms, the main caesura lies at the end of the 2nd ⟪पाद⟫: there is either word-end or - in the case of long compounds - end of a compound component.**
## 53.11. Übung

::: grammar-box

**Determine the Ślokas among all verses learned so far. Create the metrical scheme for these in writing. Point out any irregularities or Vipulā forms.**
