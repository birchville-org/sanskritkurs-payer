...
**tugev tüvi:**
*   3.ains.P: pikendatud aste
*   2.ains.P: kõrge aste
*   1.ains.P: valikuliselt kõrge aste või pikendatud aste

**nõrk tüvi:** vaata alamtüüpide juurest
...
Moodustatakse järgmist tüüpi juurtest:
*   (kaashäälik)-(kaashäälik) - i/ī/u/ū
*   (kaashäälik) - ṛ

Vokaaliga algava lõpu ees asendatakse:
*   -i/-ī -iy-ga
*   -u/-ū -uv-ga
*   -ṛ r-ga
Näited:
...
Moodustatakse järgmist tüüpi juurtest:
*   (kaashäälik)-(kaashäälik)-ṝ
*   kaashäälik-kaashäälik-ṛ (st -ṛ-ga lõppevad juured, kui sellele eelneb mitu kaashäälikut)
Näited:
...
**tugev tüvi:**
*   3./1. ains. P perfekt lõpeb -au-ga
*   2.ains.P: kõrge aste -ā või madal aste -i
...
Moodustatakse tüüpi (kaashäälik)-kaashäälik-a-kaashäälik juurtest
...
Moodustatakse muu hulgas järgmistest juurtest:
*   ⟪गम्⟫
*   ⟪हन्⟫
*   ⟪जन्⟫
*   ⟪वच्⟫
...
**nõrk tüvi:** reduplikatsiooni pole. Juure -a- asendamine -e-ga
(selgituseks vaata Thumb-Hauschild 1,2 lk 286jj.)

:::

Moodustatakse juurtest, millel on -a- kahe lihtsa kaashääliku vahel ja mille alguskaashäälik reduplikatsioonisilbis ei muutu (st mille alguskaashäälik ei ole guturaal, aspiraat ega h).
Näide:
...
Moodustatakse kõigist teistest juurtest, mille keskel on -a-, st juurtest, mille keskel on -a-
*   mis algavad kahe kaashäälikuga
*   mis algavad guturaaliga
*   mis algavad aspiraadiga
*   mis algavad h-ga

eeldusel, et nad ei kuulu perfekt-tüüpi Va.
...
⟪क्रम्⟫ 1U :sig[⟪क्रा⟫]⟪मति⟫, 4P :sig[⟪क्रा⟫]⟪म्यति⟫ : step, go
...
(Image source: [Details](/et/licenses#lekt3502))
...
(Image source: [Details](/et/licenses#lekt3501))
...
(Image source: [Details](/et/licenses#lekt3503))
