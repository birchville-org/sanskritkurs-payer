...
**2. If prepositions precede a root, the augment a- is placed immediately after the preposition and before the root.**
...
Mangobaum, Kanpur.
(Pildi allikas: [Details](/et/licenses#lekt3202))
...
(Pildi allikas: [Details](/et/licenses#lekt3203))
...
(Pildi allikas: [Details](/et/licenses#lekt3204))
...
(Pildi allikas: [Details](/et/licenses#lekt3205))
...
A) Määrake järgmised tegusõnavormid ja moodustage neile vastavad imperfekti vormid isikus, arvus ja tegumoes:
...
B) Tõlkige ja lahutage sanskriti liitsõnad:
...
Joonis: ⟪बुद्धपुत्र इति बुद्धमार्गभिक्षुरुच्यते⟫

Buddhist monk in Sri Lanka.
(Pildi allikas: [Details](/et/licenses#lekt3208))

:::

## 32.7. Kordusharjutus jõuluvaheajaks
...
A) Määrake ja tõlkige järgmised sõnad:
...
B) Sandhi harjutus: Pange järgmistes lausetes sulgudes olevad sõnad õigesse kohta. Pöörake erilist tähelepanu sandhile:
...
C) Tõlkige sanskriti keelde:

1. Pärast poja sündi saadab braahmanin teenija braahmani juurde. Braahman laseb selle teenija majja siseneda ja küsib siis poja kohta. Teenija ütleb, et poeg on terve. Seda kuuldes saab braahman õnnelikuks.

2. Püha mees talus talle tehtud kurja.

3. Kõlblus on mehe ehteks.
...
7. Mees, keda jumalanna kaitseb, on õnnelik.

8. Mis tuulega iganes pilv vett (⟪वारि⟫ n.) laseb, selle tuulega liigutab õpetlane oma vihmavarju.

9. Ei ole seisuste, eluetappide jms viljakandvaid tegevusi.

10. Taassündide ringil ei ole algust.
...
14. Mees, kes ülbuse, ahnuse, viha või hirmu tõttu kohtuotsuse valesti langetab, läheb põrgusse.

15. Rāma läks õpetaja korraldusel külast linna, sisenes püha mehe majja, astus aupaklikult pühaku ette ja ütleb: "Loobu vihast!"

16. Olgu (tema) side alati nendega, kes on teadustes kasvanud, et tema haridus/hea käitumine kasvaks. (See) sellepärast, et haridusel/heal käitumisel on see (side nendega) juureks.

17. Kui õpetaja seisab, ei tohi poiss istuda.
...
21. Aarjalaste dharma on, et noored braahmanid õpivad ikka ja jälle Veda ja Smṛti osi.
...
37. Verehrung sei diesem Rāma!

38. Ülev Hari on minu tee/eesmärk, kes saatis (oma) vaenlased taevasse, õpetas omadele Veda mõistmist, andis jumalatele süüa surematuse toitu, õpetas loojale (⟪विधि⟫) Vedat, kinnitas maa vette (kindlalt).
...
40. Teostamata valitsemine põhjustab kalade seaduse.

41. Kellel on rikkusi, sellel on sõpru; kellel on rikkusi, sellel on sugulasi; kellel on rikkusi, see on mees (⟪पुमान्⟫ ainsuse nimetav) maailmas; kellel on rikkusi, see on nimelt õpetlane.

42. Tuli, mis põletab surnu, põletab ka hea lese.

43. Braahmani teenijanna on toidu keetnud ja sööb seda (nüüd).

44. Jetzt reicht's!

45. Diese Frucht genügt ihm zum Essen.

46. Sisemine templipühakoda on jumala kuju kodu.

47. Varast vabastatakse vargusest karistuse või vabastamise kaudu. Kui aga kuningas (⟪राजा⟫ ainsuse nimetav) (varast) ei karista, saab ta varga süü.

48. Kuna ta tegi ohverdamisel vea, ei ole braahman väärt rikkusi vastu võtma.

49. Kui initsiatsioonitseremoonia on toimunud, peaks ta omandama (⟪उपयुज्⟫) Veda ja filosoofia õpetlastelt, majanduse osakonnajuhatajatelt.

50. Vaiśyadharma on see, et vaiśyad elavad ostmisest ja müümisest. Kuna see nii on, ostavad ja müüvad vaiśyate pojad.
...
(Pildi allikas: [Details](/et/licenses#lekt3209))

:::

## 32.8. Übung zur Wiederholung

Tõlkige ja määrake järgmised sõnavormid:
