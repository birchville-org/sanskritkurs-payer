...
Liitsõnade moodustamiseks, mille esiosa moodustavad konsonantlõpulised tüved, on vaja järgmisi reegleid:

Lõppgutturaalsed, retrofleksed, dentaalsed ja labiaalsed sulghäälikud (st mitte nasaalid ja mitte palataalid).

::: no-header

|   |   |
| :--- | :--- |
| **pausas ja enne helituid häälikuid** | **Asendamine vastava helitu aspireerimata häälikuga:** :br **nt** :br :indent -g + p- » -kp- :br :indent -d + ph- » -tph- :br :indent -dh + p- » -tp- |
| **enne helilisi mittenasaalseid häälikuid** | **Asendamine vastava helilise aspireerimata häälikuga:** :br **nt** :br :indent -t + g- » -dg- :br :indent -k + b- » -gb- :br :indent -dh + d- » -dd- :br :indent -k + a- » -ga- |
| **enne nasaale** | **Asendamine vastava nasaaliga:** :br **nt** :br :indent -t + n- » -nn- :br :indent -p + n- » -mn- |

:::

Ausnahme zu obiger Regel:

Lõppdentaalne sulghäälik (mitte nasaal):

::: no-header

|   |   |
| :--- | :--- |
| **enne palataali** | **Asendamine vastava aspireerimata palataaliga:** :br **st** :br :indent -t + c- » -cc- :br :indent -d + c- » -cc- :br :indent -th + c- » -cc- :br :indent -dh + c- » -cc- :br :indent -t/-th/-d/-dh + ch- » -cch- :br :indent -t/-th/-d/-dh + j- » -jj- :br :indent -t/-th/-d/-dh + jh- » -jjh- |
| **+ ś** | **» -cś- või -cch-** |
| **enne retrofleksi** | **Asendamine vastava aspireerimata retrofleksiga:** :br **st** :br :indent -t/-th/-d/-dh + ṭ(h)- » -ṭṭ(h)- :br :indent -t/-th/-d/-dh + ḍ(h)- » -ḍḍ(h)- |
| **enne l-** | **Asendamine -l-ga:** :br **st** :br :indent -t/-th/-d/-dh + l- » -ll- |
...
(Pildi allikas: [Details](/et/licenses#lekt1602))
...
Birla Mandir, Delhi
(Pildi allikas: [Details](/et/licenses#lekt1601))
...
(Image source: [Details](/et/licenses#lekt1603))
...
(Image source: [Details](/et/licenses#lekt1604))
...
A) Moodustage kõik seni õpitud käänded järgmistest sõnadest näidetena seni õpitud käändkondade kohta.

Kasutage selleks järgmist skeemi, mis vastab käändsõnade järjekorrale India grammatikute juures ja mis oma – hiljem arutlusele tulevate – eeliste tõttu on omaks võetud ka lääne grammatikute poolt:
...
Õppige käändemustrid nende näidete järgi pähe!!!
