---
title: "Lektion 39"
subtitle: 'Esimese isiku pöördelõpud (:sig[⟪तृतीयः⟫] ⟪पुरुषः⟫ = "**kolmas** isik")'
lesson_id: 39
...
## 39.1. Esimese isiku pöördelõpud (:sig[तृतीयः] ⟪पुरुषः⟫ = "**kolmas** isik")

Esimese isiku pöördelõpud (:sig[⟪तृतीयः⟫] ⟪पुरुषः⟫ = "**kolmas** isik") on:
...
[LN] ¹ Note: actually, the primary ending Ā of thematic stems is also to be set as -e, before which the thematic vowel -a- drops out for reasons of analogy. However, the effect is as if the ending -i were to attach to the thematic vowel -a-: a + i » e.

[LN] ## 39.2. Formation of the verb forms of the first person of thematic present stems

::: grammar-box

**Regel:**
[LN] **Before -mi, -mas, -ma, -māhe, -māhi, the thematic vowel -a- is replaced by -ā- !!!**

:::

[LN] ### 39.2.1. First present class (⟪bhvādi⟫)
...
[LN] ### 39.2.2. Sixth present class (⟪tudādi⟫)
...
[LN] ### 39.2.3. Fourth present class (⟪divādi⟫)
...
[LN] ### 39.2.4. Tenth present class (⟪curādi⟫) and causatives (⟪ṇijānta⟫)
...
## 39.3. Lihtfuturumi esimese isiku tegusõnavormide moodustamine - ⟪ऌत्⟫

::: grammar-box

[LN] **The future has thematic formation. Therefore, the rule for thematic stems also applies:**

[LN] **Before -mi, -mas, -māhe, the thematic vowel -a- is replaced by -ā- !!!**
...
[LN] ## 39.4. Formation of the verb forms of the first person of athematic present stems

::: grammar-box

[LN] **Note that within the word – in contrast to sentence sandhi – before endings that begin with**
* **Vokal**
* **Halbvokal**
* **Nasal**

[LN] **consonants generally remain unchanged.**

z. B. ⟪वच्⟫ 1.sg.Ind.Präs.P ⟪व⟫*⟪च्मि⟫***

:::

[LN] ### 39.4.1. Second present class (⟪adādi⟫)
...
(Pildi allikas: [Details](/et/licenses#lekt3901))

:::

[LN] ### 39.4.2. The third present class (⟪juhotyādi⟫)
...
[LN] ### 39.4.3. The fifth present class (⟪svādi⟫)

::: grammar-box

[LN] **For roots ending in a vowel, the -u of the stem-forming suffix (-nu) may optionally drop out before endings beginning with m-.**
...
[LN] ### 39.4.4. Eighth present class (⟪tanādi⟫)
...
[LN] ### 39.4.5. Seventh present class (⟪rudhādi⟫)
...
### 39.4.6. Üheksas praesensklass (⟪क्र्यादि⟫)
...
| :--- | :---: | :---: | :---: | :---: |
| | ⟪एकवचनम्⟫ | ⟪बहुवचनम्⟫ | ⟪एकवचनम्⟫ | ⟪बहुवचनम्⟫ |
| **Indikativ praesens - ⟪लट्⟫** | ⟪क्रीणामि⟫ | ⟪क्रीणीमस्⟫ | ⟪क्रीणे⟫ :brkrī + n-e | ⟪क्रीणीमहे⟫ |
...
Moodustage järgmiste verbivormide puhul esimese isiku vormid, mis vastavad antud verbivormile arvu, aja, mooduse (indikatiivi või optatiivi) ja teguviisi poolest.

Näide: ⟪गच्छन्ति⟫ » ⟪गच्छामस्⟫
