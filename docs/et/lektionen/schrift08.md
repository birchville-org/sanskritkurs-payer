# Kirjutamisharjutus 8

Vokaalimärgid sõna alguses, kui sõna ei ole kirjapildis seotud eelneva sõnaga:
...
Kui sõnas või lauses järgneb kaks või enam kaashäälikut vahetult üksteisele, kirjutatakse need ligatuuriga (ühendatud märk).

1. Kui esimene ühendatavatest kaashäälikumärkidest lõpeb paremal oleva vertikaalse joonega, kaotab see selle joone ja asetatakse teise kaashääliku ette.

Erand: kui teine kaashäälikumärk on ⟪न्⟫ või ⟪ल्⟫, asetatakse see horisontaalse joone kaotusega esimese kaashäälikumärgi alla. Sõltuvalt kirjatüübist on veel erandeid, mis on loetletud järgnevas. Kui vastavas kirjatüübis ei ole ligatuuri ette nähtud, asetatakse Virāma.

Beispiele:

Selles skriptis kasutatavas tüübis:
...
Pange tähele jña kirjapilti:

![](/images/schrift017.webp)

Alguses olev -a, mis elideeritakse vastavalt lause sandhi reeglitele (-as + a- » -o ' ), tähistatakse nn Avagrahaga:
...
A) Kirjutage kõik ülaltoodud loendis esinevad ligatuurid

B) Kirjutage ja tõlkige:
...
D) Lugege, translitereerige ja tõlkige:
