...
A) Lisage otseobjekt või suunaline akusatiiv ainsuses ja mitmuses (kui tegemist ei ole pärisnimega):
...
C) Pange harjutuslausetes B) tegevussubjekt, objekt ja tegusõna mitmusesse.
...
E) Moodustage kõigist seni õpitud nimisõnadest akusatiiv (dvitīyā) ainsuses ja mitmuses.
