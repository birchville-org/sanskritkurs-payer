...
## 25.1. Ablatiivi moodustamine (⟪पञ्चमी⟫ = "viies käändkond")

::: grammar-box

Peale maskuliinide ja neutrumite -a lõpuga ning asesõnade on ainsuses kõikides käändkondades ablatiivi vormid (⟪पञ्चमी⟫) identsed genetiivi vormidega (⟪षष्ठी⟫).

Peale isiklike asesõnade on kõikides käändkondades mitmuses ablatiivi vormid identsed dativi vormidega (⟪चतुर्थी⟫).

:::

Nüüd näete põhjust Sanskriti käändkondade (⟪विभक्ति⟫) järjestusele: need on paigutatud nii, et identsed vormid oleksid võimalikult lähedal – või üksteise all.

::: grammar-box

**Ablatiivi ainsus maskuliinide / neutrumite puhul -a lõpuga**

**devāt** (⟪देवात्⟫)

:::

Küsi-, suhestus- ja demonstratiivasesõnad:

::: grammar-box

| | Ablatiivi ainsus:brMaskuliin / Neutrum | Ablatiivi ainsus:brFemininum |
| :--- | :--- | :--- |
...
## 25.2. Ablatiivi kasutamine (⟪पञ्चमी⟫)

"Ablatiiv tähistab seda, mis jääb alles, kui millestki eemaldatakse."

Pāṇini 2,3,28 + 1,4,24

Ablatiiv vastab peamiselt küsimustele "Kuselt?", "Miks?".

::: grammar-box

1. Ablatiiv tähistab seega lähtepunkti, päritolu ja materjali.
...
⟪ब्राह्मणः क्षत्रियाद्धेनुमिच्छति⟫ = "the Brāhmaṇa wishes for a milch cow from the Kṣatriya"

:::

::: grammar-box

2. The ablative stands with verbs meaning "to abstain from", "to protect against", "to defend against", "to fear":
...
⟪धर्मतस्⟫ = "because of dharma, on account of dharma"

:::

::: grammar-box

The suffix -⟪तस्⟫ also attaches to pronominal stems:

:::

::: indent

⟪तद्⟫ : ⟪ततस्⟫ (« ta-tas) "from there, there, to that place, on that account, then, for that reason"

⟪यद्⟫ : ⟪यतस्⟫ "from which, of which, from where, where, to where, for what reason, because" (relative)
...
Relative clauses often express a causal (reasoning), consecutive (resultative) or final (purposive) relationship to the main clause.
...
*   instrumental:
*   ⟪येन⟫ ... subordinate clause ... ⟪तेन⟫ ... main clause ... = "by which/because ..., thereby / for that reason ..."
...
Of course, reasons can also be expressed by constructions with
...
(Pildi allikas: [Details](/et/licenses#lekt2501))
...
⟪धर्म⟫ m.: see, mis on kindel ja hoiab kindlalt = Dharma
...
Fig.: ⟪मूलानि⟫
(Image source: [Details](/et/licenses#lekt2502))
...
Fig.: ⟪लिप्तिः⟫
(Image source: [Details](/et/licenses#lekt2503))
...
Fig.: ⟪विवाहः⟫
(Image source: [Details](/et/licenses#lekt2504))
...
Fig.: ⟪विष्टिः⟫
(Image source: [Details](/et/licenses#lekt2505))
...
Fig.: ⟪हिरण्यम्⟫
(Image source: [Details](/et/licenses#lekt2506))
...
Selgitus: ⟪सर्वतस्⟫ = sarva "iga, kõik" + -tas ; ⟪अणु⟫ = nominatiiv, akusatiiv ainsus neutrum
...
1. ⟪कौटिलीयार्थशास्त्र⟫ ⟪१⟫.⟪४⟫.⟪१⟫. majanduse kasulikkusest:

⟪वार्त्ता⟫ ⟪धान्यपशुहिरण्यकुप्यविष्टिप्रदानादौपकारिकी⟫ ⟪॥⟫

2. ⟪कौटिलीयार्थशास्त्र⟫ ⟪१⟫.⟪५⟫. vürsti haridusest:
...
1.5.1. ⟪तिस्रस्⟫ : Nom, Acc, fem. to ⟪त्रि⟫ "three"

1.5.2. ⟪प्राणभृताम्⟫ : Gen. pl. m. to ⟪प्राणभृत्⟫ m. "beings"

1.5.5. ⟪इतरम्⟫ Acc. sg. masc. to ⟪इतर ३⟫ "other"

1.5.7. ⟪कर्मा⟫ : Nom. sg. masc. to ⟪कर्मन्⟫ neuter "deed, work" ; ⟪उपयुञ्जीत⟫ : Optative 3. sg. Ā to upa-yuj 7 "to appropriate": "he may appropriate"

1.5.8. ⟪वक्तृप्रयोक्तृभ्यस्⟫ Abl., Dat. pl. to ⟪वक्त्र्प्रयोक्तृ⟫ (⟪इतरेतरद्वन्द्व⟫) "theorists and practitioners"

1.5.9. ⟪षोडश ३⟫ : "sixteenth"

1.5.10. ⟪कर्म⟫ Nom., Acc. sg. to ⟪कर्मन्⟫ n. "deed"

1.5.16. ⟪धि⟫ Sandhi form to ⟪हि⟫ ; ⟪आत्मवत्ता⟫ f.: "self-possession"
