...
Fig.: ⟪जयपुरनगरे⟫
Jaipur, 1875.
(Image source: [Details](/et/licenses#lekt2701))
...
**Note: In the absolute construction, the agent of the absolute must be identical to the agent of the main clause; in the locative absolute, the agent of the locative absolute and the agent of the main verb must be different.**
...
Rajasthan.
(Image source: [Details](/et/licenses#lekt2702))
...
Holi.
(Image source: [Details](/et/licenses#lekt2703))
...
### 27.2.2. Küsi-, näite- ja relatiivpronoomenid
...
## 27.3. Ülevaade regulaarsetest käändelõppudest (⟪विभक्ति⟫)
...
**Signaalpunasega trükitud**: tugevad käänded (tüve astmestiku korral).

## 27.4. Salm kõigi käändevormidega (ainsus) sõnast ⟪राम⟫

::: media

![](/images/lekt2708.webp)

Joonis: ⟪रामे चित्तलयः सदा भवतु मे भो राम मामुद्धर ॥⟫

Rāma-Satz.
(Pildi allikas: [Details](/et/licenses#lekt2708))
...
**Tõlge:**
1. **Nimetav:** Rāma, kuningate (⟪राजन्⟫ m.) juveel (⟪मणि⟫ m.) võidab alati (⟪सदा⟫).
2. **Omastav:** Ma armastan (⟪भज्⟫ 1U) Rāmat, Ramā (= Lakṣmī) isandat ja abikaasat (⟪ईश⟫ m.).
3. **Alaleütlev:** Rāma tappis öösel ringi uitajate (= deemonite) (⟪निशा⟫ f. = öö) armee (⟪चमू⟫ f.).
4. **Daativ:** Sellele Rāmale olgu austus!
5. **Ablatiiv:** Parem (⟪परतर⟫ 3) varjupaik (⟪परायण⟫ n.) kui Rāma puudub.
6. **Genitiiv:** Mina (⟪अहम्⟫) olen (⟪अस्मि⟫) Rāma teenija.
7. **Lokatiiv:** Rāmas olgu (⟪भवतु⟫) alati minu (⟪मे⟫) südame rahu (⟪लय⟫ m.).
8. **Vokatiiv:** Rāma, päästa (⟪उद्धर⟫ = imperatiiv sõnast ⟪उद्⟫ + ⟪हृ⟫ või ⟪उद्⟫ + ⟪धृ⟫) mind (⟪माम्⟫)!

## 27.5. Wortliste

⟪वस्⟫ 1P (⟪वसति⟫): viibima, elama (koos isiku lokatiiviga, kelle juures elatakse)
...
(Pildi allikas: [Details](/et/licenses#lekt2706))

:::

⟪वस्⟫ 6P (⟪उच्छति⟫): helendama (see juur on oluline nominaalvormide tõttu:)
...
(Pildi allikas: [Details](/et/licenses#lekt2707))
...
⟪हर⟫ 3: ära võttev; m.: hävitaja = Śiva epiteet
...
(Pildi allikas: [Details](/et/licenses#lekt2704))
...
(Pildi allikas: [Details](/et/licenses#lekt2705))
...
**B) Tõlkige ja lahutage liitsõnad:**
...
Naran. Udaipur.
(Pildi allikas: [Details](/et/licenses#lekt2711))
...
Früchte. Bangalore.
(Pildi allikas: [Details](/et/licenses#lekt2710))
...
(Pildi allikas: [Details](/et/licenses#lekt2718))
...
Kahe 1857. aasta mässus osaleja hukkamine. Felice Beato (1833/1834 - u 1907) foto.
(Pildi allikas: [Details](/et/licenses#lekt2712))
...
(Pildi allikas: [Details](/et/licenses#lekt2713))
...
Kuh in Udaipur.
(Pildi allikas: [Details](/et/licenses#lekt2714))

:::

### 27.7.8. Mit -ī lõppevad mitmesilbilised naissoost sõnad: ⟪देवी⟫
...
(Pildi allikas: [Details](/et/licenses#lekt2715))

:::

### 27.7.9. -ant lõpuga oleviku kesksõna Parasmaipada: ⟪सन्त्⟫
...
(Pildi allikas: [Details](/et/licenses#lekt2716))
...
### 27.7.11. Meessoost ja kesksoost sõnad, mis lõppevad -vant / -mant: ⟪गुणवन्त्⟫
...
(Pildi allikas: [Details](/et/licenses#lekt2717))
