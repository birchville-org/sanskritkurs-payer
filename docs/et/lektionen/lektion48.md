...
*   **kõik käskiva kõneviisi 1. isikud**
*   **3.ains.P käskiv kõneviis**

**Weak stem: all other forms**

:::

### 48.2.3. Second Present Class (⟪ada-di⟫)
...
Märkus: ¹ Selgitus ⟪जहि⟫ kohta vt. Thumb-Hauschild I,2 lk 253
...
## 48.3. Nimisõnade moodustamisest: ⟪तद्धित⟫-liited -a ja -ya

::: grammar-box

With the suffix **-a** and (rarely) **-ya**, another noun can be derived from a noun. In doing so, the first syllable of the original noun receives the guṇa grade (⟪vṛddhi⟫). If the original word stem already ends in **-a**, then the ⟪vṛddhi⟫ is the only sign of derivation, since nothing changes at the end of the stem.
...
The words formed in this way are adjectives, but can be substantivized, e.g., as patronymics (name formation after the father: "son of N.N.") or abstracts (mostly neuter).
...
(Image source: [Details](/et/licenses#lekt4801))
...
(Image source: [Details](/et/licenses#lekt4802))
...
(Image source: [Details](/et/licenses#lekt4803))
...
(Pildi allikas: [Details](/et/licenses#lekt4804))
...
(Pildi allikas: [Details](/et/licenses#lekt4805))
...
⟪नेपाल⟫
(Pildi allikas: [Details](/et/licenses#lekt4806))
...
⟪जोधपुर⟫
(Pildi allikas: [Details](/et/licenses#lekt4807))
...
(Pildi allikas: [Details](/et/licenses#lekt4808))
...
(Bild: Payer)
(Pildi allikas: [Details](/et/licenses#lekt4809))

:::

## 48.5. Übung

A) Tõlkige tunni alguses olevad ⟪सुभाषितानि⟫.

B) Translate into Sanskrit (use the imperative and preferably roots of the 2nd and 3rd present classes):

1. After you have had a son, leave the family!
