...
One way to form passive sentences in the past tense is the construction using the so-called Perfect Passive Participle (PPP).
...
In this case, the PPP agrees with the agent in number, case, and gender. The "Passive" Perfect Participle has an active meaning with intransitive verbs (verbs without a direct object) and verbs of motion.
...
Example:
> **kṣatriyeṇa (nagaraṃ gatam)** = ⟪क्षत्रियेण⟫ (⟪नगरं⟫) ⟪गतम्⟫ = „(By the Kṣatriya, (into the city) has been gone to) = The Kṣatriya has (gone into the city).“
...
Thus, while the so-called „Perfect Participle Passive“ for transitive verbs primarily has a passive meaning (**āpta** = „reached (been)“) and for intransitive verbs and verbs of motion an active meaning (**gata** = „gone“), there are some verbs for which the PPP can have both active and passive meaning:

e.g.
**gata** = ⟪गत⟫ = „gone“ (active); but also: **gato mārgaḥ** = ⟪गतो मार्गः⟫ = „a path that has been gone (on)“ (passive)
...
::: grammar-box
The following formation methods occur (for each root, its PPP must be learned respectively!):

**(mostly) weak-grade root**
...
In *aniṭ*-forms, the following laws of phonetic combination within words must be observed. **These laws are very important for understanding the entire Sanskrit morphology.**
...
| **6. A voiced aspirated stop + voiceless stop » a voiced unaspirated stop + a voiced aspirated stop (Bartholomew's Law of Aspirates):** | **bh-t » b-dh:** :br **labh + ta » lab-dha** = ⟪लब्ध⟫ :br **dh-t » d-dh:** :br **budh + ta » bud-dha** = ⟪बुद्ध⟫ :br **yudh + ta » yud-dha** = ⟪युद्ध⟫ :br **krudh + ta » krud-dha** = ⟪क्रुद्ध⟫ |
...
Fig.: ⟪गौतमो बुद्धः⟫
(Bildekilde: [Detaljer](/no/licenses#lekt1201))
:::
...
Fig.: ⟪मार्गः⟫
(Bildekilde: [Detaljer](/no/licenses#lekt1202))
:::
...
**muc** 6 U (muñcati), PPP **mukta** ⟪मुच् मुञ्चति मुक्त⟫ : to release, to let go, to free; from the cycle of rebirths (**saṃsāra** m.) to free = to liberate
...
Fig.: ⟪महावीरो जिनः⟫
(Bildekilde: [Detaljer](/no/licenses#lekt1203))
:::
