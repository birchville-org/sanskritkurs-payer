...
**1. The PPP of verbs meaning "to think", "to wish", "to know", "to be acquainted with", "to revere" as well as some other verbs marked in the Dhātupāṭha, the root list of Pāṇini, by ñi, does not only have past tense meaning, but can also be used in present tense meaning:**
e.g.
...
Attributes (modifiers) appear in prose before the word they modify, following standard word order. Adjectival attributes agree with the noun in number, case, and gender:
...
vant attaches to nouns whose final or penultimate sound is a, ā, or m, as well as to nouns ending in a stop consonant; for other nouns, -mant is usually attached.
...
For nominal stems with stem gradation, one distinguishes between strong and weak cases (cases). In the strong cases, the stem-forming suffix — for root nouns, the root-like component — has the guṇa stage or vṛddhi stage; in the weak cases, it has the zero grade.
...
The following laws of word sandhi are necessary for understanding the individual forms of the declension of nouns ending in -mant and -vant:

::: grammar-box

1. Number of final consonants in a word: If a word would end with two or more consonants, only the first consonant remains; the others are dropped. The combination -r- + consonant is permitted.

2. A voiceless stop becomes a voiced stop corresponding to it when preceding a voiced stop (not a nasal):
...
The feminine stem of the stems in -mant- and -vant- ends in -mat-ī or -vat-ī. The declension follows that of devī, i.e., there is no stem gradation.
...
Fig.: ⟪महिषासुरः⟫
(Bildekilde: [Detaljer](/no/licenses#lekt1301))
...
**dviṣ** 2 U (dveṣṭi), Pass. dviṣyate, PPP dviṣṭa ⟪द्विष् द्वेष्टि द्विष्यते द्विष्ट⟫ : to hate, to detest
...
Fig.: ⟪अन्नम्⟫
(Bildekilde: [Detaljer](/no/licenses#lekt1304))
...
(Bildekilde: [Detaljer](/no/licenses#lekt1303))
...
(Bildekilde: [Detaljer](/no/licenses#lekt1305))
...
Fig.: ⟪सत्यमेव जयते⟫
(Bildekilde: [Detaljer](/no/licenses#lekt1302))
...
4. By the Buddha's teaching, people were liberated.
5. The son danced.
6. The amulet has protected the teacher.
7. A Brāhmaṇa has not told an untruth.
8. Śūdra women have worshipped the goddess with offerings.
9. Buddha has awakened to truth = Buddha has recognized the truth.
