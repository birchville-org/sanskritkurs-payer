...
The Optative (⟪लिङ्⟫), the Imperfect (⟪लङ्⟫), the Aorist (⟪लुङ्⟫), Prekativ (⟪आशिर्लिङ्⟫) and Conditionalis have the so-called secondary endings:
...
**Present stem + -i- (which merges with the -a- to form -e-) + Secondary endings**
...
:::
### 30.4.2. Athematically Inflected Present Tense Classes
...
(Bildekilde: [Detaljer](/no/licenses#lekt3001))
:::
⟪ज्ञा⟫ 9U ⟪जानाति⟫ : to know, recognize, to be aware of, understand
...
(Bildekilde: [Detaljer](/no/licenses#lekt3002))
:::
...
(Bildekilde: [Detaljer](/no/licenses#lekt3003))
:::
...
(Bildekilde: [Detaljer](/no/licenses#lekt3005))
:::
...
Fig.: ⟪प्रिया⟫
(Bildekilde: [Detaljer](/no/licenses#lekt3004))
:::
...
Fig.: ⟪पुनर्भवः⟫
(Bildekilde: [Detaljer](/no/licenses#lekt2904))
:::
...
## 30.8. Repetisjonsoppgave i formlære
