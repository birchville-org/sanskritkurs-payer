...
If the first of the consonants to be joined does not end with a vertical stroke, then the following consonant is placed under the first consonant after losing its horizontal stroke.

Exceptions: If ⟪म्⟫ or ⟪य्⟫ is the second component of the ligature, they are written shortened behind the first character:
...
Examples (exceptions are underlined):
...
### List of the most common ligatures in the font type of Kielhorn's Grammar
