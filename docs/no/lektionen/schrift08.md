...
Exception: if the second consonant sign is ⟪न्⟫ or ⟪ल्⟫, this is placed under the first consonant sign with loss of the horizontal stroke. Depending on the font, there are further exceptions listed below. If a ligature is not provided for in the relevant font, a virāma is placed.
