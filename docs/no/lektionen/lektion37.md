...
::: grammar-box
From the pronominal stems ⟪तद्⟫, ⟪इदम्⟫ and respectively ⟪अ⟫-, ⟪यद्⟫, ⟪किम्⟫ and respectively ⟪कु⟫, one can derive corresponding pronominal adverbs using the following adverbial suffixes:
...
| **-⟪दा⟫** :br(Time) | ⟪तदा⟫ :bat that time, then | | ⟪यदा⟫ :bat the time when, when | ⟪कदा⟫ :brwhen? |
...
Fig.: ⟪क्व⟫
(Bildekilde: [Detaljer](/no/licenses#lekt3701))
:::
...
Fig.: ⟪यथाशक्ति⟫
(Bildekilde: [Detaljer](/no/licenses#lekt3702))
:::
## 37.6. Syntax
...
an adverbial predicate can stand instead of an adjectival predicate:
...
Fig.: ⟪तूष्णीं बभूवुः⟫
(Bildekilde: [Detaljer](/no/licenses#lekt3703))
:::
## 37.7. Indefinite Pronouns

::: grammar-box
Indefinite pronouns are formed by appending

*   \-⟪चिद्⟫
*   \-⟪चन⟫
*   ⟪अपि⟫

to the case forms of the interrogative pronoun ⟪किम्⟫.
...
::: grammar-box
"Who?, how?, what?, why? for what reason?  
...
In word questions, one asks about an agent (⟪कर्तृ⟫), an object, an action, a circumstance, etc., e.g.
...
(Bildekilde: [Detaljer](/no/licenses#lekt3704))
:::
...
Fig.: ⟪शाक्यमुनिः⟫
(Bildekilde: [Detaljer](/no/licenses#lekt3705))
:::
⟪दिन⟫ n.: day
...
Fig.: ⟪वृक्षः⟫
(Bildekilde: [Detaljer](/no/licenses#lekt3706))
:::
...
Fig.: ⟪कृष्णः बलरामश्च⟫
(Bildekilde: [Detaljer](/no/licenses#lekt3707))
:::
...
(Bildekilde: [Detaljer](/no/licenses#lekt3708))
:::
...
(Bildekilde: [Detaljer](/no/licenses#lekt3709))
:::
...
(Bildekilde: [Detaljer](/no/licenses#lekt3710))
:::
7\. ⟪उप⟫ "near"
...
(Bildekilde: [Detaljer](/no/licenses#lekt3711))
:::
8\. ⟪यथा⟫
