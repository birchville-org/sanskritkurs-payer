...
The end of a sentence is marked in prose with | (ardhadanda m.). In verses, | marks the end of a half-verse; || (danda m.) marks the end of a full verse. In prose, || indicates a larger break (e.g., the end of a paragraph). Verse numbering is placed between two ||, e.g. ||⟪१⟫||.
