...
Samohláskové značky pro začátek slova, pokud není slovo ve zápisu spojeno s předchozím slovem:
...
Pokud v slově nebo větě následují dvě nebo více souhlásek bezprostředně za sebou, zapisují se pomocí spřežky (spojené značky).

1. Pokud první ze spojovaných souhláskových znaků končí svislou čarou vpravo, tuto čaru ztrácí a umisťuje se před druhou souhlásku.

Výjimka: pokud je druhým souhláskovým znakem ⟪न्⟫ nebo ⟪ल्⟫, umisťuje se tento znak s odstraněním vodorovné čáry pod první souhlásku. V závislosti na písme existují další výjimky, které jsou uvedeny níže. Pokud dané písmo spřežku nepředpokládá, umisťuje se virāma.

Příklady:

V písmu používaném v tomto skriptu:
...
Vezměte na vědomí pravopis jña:

![](/images/schrift017.webp)

Úvodní -a, které se podle pravidel sandhi věty eliduje (-as + a- » -o ' ), je označováno takzvaným avagraha:
...
A) Zapište všechny ligatury uvedené v předchozí tabulce

B) Zapište a přeložte:
...
D) Přečtěte, transkribujte a přeložte:
