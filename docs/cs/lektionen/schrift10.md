...
### Druhé pravidlo pro tvorbu souhláskových ligatur

\[První pravidlo viz v [Písemný cvičení 8](schrift08.md)\]

Pokud první z spojovaných souhlásek nekončí svislou čarou, je následující souhláska umístěna pod první souhlásku za cenu ztráty své vodorovné čáry.

Výjimky: Jsou-li ⟪म्⟫ nebo ⟪य्⟫ druhým členem ligatury, jsou zkráceny a zapisovány za první znak:
...
Příklady (výjimky jsou podtrženy):
...
Zapište všechny výše uvedené ligatury

Seznam nejčastějších ligatur ve fontu Kielhornovy gramatiky
