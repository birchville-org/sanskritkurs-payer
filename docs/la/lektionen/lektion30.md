...
*   radix valida: radix gradus infimus + -nā-

*   radix infirma:

    *   ante consonantem: radix acuta + -nī-

    *   ante vocalem: radix acuta + -n-
:::
Exemplum:
...
:::
In hac classe praesentis maxime observanda est formatio radicalis praesentis ad radicem ⟪ज्ञा⟫ 9U "scire, noscere":
...
:::
Forma ⟪जा⟫, quae radicam praesentis ⟨ज्ञा⟩ subiacet, vel per series ablautium -ā (gradus infimus) -nā (gradus summus) explicari potest, vel per dissimilationem e *jñā-nā-ti.

Quaedam radices vocalem longam ante suffixum praesentis radicis nonae classis breviant:
...
**Stemma praesentis + -i- (quod cum -a- in -e- confudit) + terminationes secundariae**

**ante terminationes vocali incipientes:**

**Radix praesentis + -i- (» -e-) + -y- + desinens secundaria**
:::
Exempla:
...
:::
10\. Classis praesentis et causativa
...
**radix praesentis infirma + -yā- (ante -ur: -y-) + desinentia secundaria**

**Ātmanepada:**

**radix praesentis infirma + -ī- + desinentia secundaria**
:::
Exempla:
...
:::
⟪चेत्⟫ Coniunctio: si; dummodo (numquam initium orationis stat)
...
::: indent
⟪यद्यपि⟫ : quamvis, etiam si, quamquam

⟪यद्येवम्⟫ : si ita est, his de causis
:::
