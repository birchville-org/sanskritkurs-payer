...
If two or more consonants follow each other immediately in a word or sentence, they are written with a ligature (combined character).
...
Exception: if the second consonant sign is न् or ल्, this is placed under the first consonant sign, losing the horizontal stroke. Depending on the font, there are further exceptions, which are listed below. If a ligature is not provided in the relevant font, a Virāma is inserted.

Examples:

In the type used in this script:
...
A) Scribe omnes ligaturas in supradicta lista occurrentes.
...
7\. sanctus est gurucandrakirti.

8\. vaisyah est tuladhara.

9\. dominus est vishnuh.
