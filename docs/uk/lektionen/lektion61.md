...
## 61.1. Deklination der Коріньnomina auf -ā, -ī, -ū

### 61.1.1. Коріньnomina auf -ā am Ende von तत्पुरुष
...
### 61.1.2. Feminine Коріньnomina auf -ī
...
### 61.1.3. Коріньnomina auf -ī am Ende von तत्पुरुष
...
### 61.1.4. Einsilbige, feminine Коріньnomina auf -ū
...
### 61.1.5. Коріньnomina auf -ū am Ende von तत्पुरुष
...
## 61.2. Das periphrastische Майбутній час (लुट्)
...
*   dass eine Person oder Sache immer wieder tut oder erleidet, was durch die Корінь ausgedrückt wird   &lt;!-- TODO: Fallback translation --&gt;
    कृ 8U: चेक्रीयते / चर्करीति "er tut immer wieder"  
    भू 1P: बोभूयते / बोभवीति "er ist (wird) oft"   &lt;!-- TODO: Fallback translation --&gt;

*   dass eine Person oder Sache intensiv tut oder erleidet, was durch die Корінь ausgedrückt wird:   &lt;!-- TODO: Fallback translation --&gt;
    कृ 8U: चेक्रीयते / चर्करीति "er tut intensiv, er tut tüchtig"   &lt;!-- TODO: Fallback translation --&gt;

*   bei Коріньn, die eine Bewegung ausdrücken, bedeutet das Intensivum die gekrümmte Bewegung:   &lt;!-- TODO: Fallback translation --&gt;
    व्रज् 1P:  वव्रज्यते "er geht in Krümmungen" (NICHT: "er geht oft")   &lt;!-- TODO: Fallback translation --&gt;

*   bei einigen Коріньn (Aufzählung: Kielhorn, Grammatik § 458b) bedeutet das Intensivum Tadel:   &lt;!-- TODO: Fallback translation --&gt;
...
*   Основа презенсу: wie ein Ātmanepada der 4. Теперішній часklasse (दिवादिगण). &lt;!-- TODO: Fallback translation --&gt;
*   z.B.   &lt;!-- TODO: Fallback translation --&gt;
    *   Passiv Теперішній час: बुध् : बोबुध्यते ; भू : बोभूय्यते &lt;!-- TODO: Fallback translation --&gt;
    ...
    *   Майбутній час: seṭ: बोबुधिष्यते ; बोभूयिष्यते &lt;!-- TODO: Fallback translation --&gt;
    *   periphrastisches Майбутній час: बोबुधिता ; बोभूयिता &lt;!-- TODO: Fallback translation --&gt;
...
### 61.4.1. Утворення ohne besonderes Suffix, Parasmaipada
...
### 61.4.2. Утворення mit Suffix -ya, Parasmaipada
...
### 61.4.3. Утворення mit dem Suffix -kāmya, Parasmaipada
...
### 61.4.4. Утворення mit dem Suffix -sya oder -asya, Parasmaipada
...
### 61.4.5. Утворення mit dem Suffix -ya, Ātmanepada
...
### 61.4.6. Утворення mit dem Suffix -aya, -āpaya
...
### 61.8.1. Personalpronomen des Двоїна
