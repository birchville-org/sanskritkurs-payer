---
title: "Урок 4"
subtitle: "Питальні та вказівні займенники у називному відмінку"
lesson_id: 4
...
## 4.1. Прості доповнювальні запитання (словесні запитання) та відповіді

### 4.1.1. Питальні займенники та вказівні займенники

#### 4.1.1.1. Питальний займенник (praśnārthakasarvanāma n. = ⟪प्रश्नार्थकसर्वनामन्⟫)

::: grammar-box
| | Називний відмінок однини | Називний відмінок множини |
| :--- | :--- | :--- |
...
:::
**Щодо називного відмінка однини чоловічого роду:**
**sa, eṣa** (⟪स एष⟫) вживається перед усіма звуками, крім короткого **-a**
**so, eṣo** (⟪सो एषो⟫) вживається перед **-a**, яке елідується (випадає) за допомогою авараґха
**saḥ, eṣaḥ** (⟪सः एषः⟫) вживається лише на паузі (кінець речення, кінець вірша)
