...
Приклади для r перед приголосними:
...
*   при літерах із вертикальною завершальною рискою: / на вертикальній завершальній рисці
    
*   при інших літерах: внизу літери
...
А) Напишіть мовою деванаґарі та наведіть переклад (передбачається знання Урока 8):
...
Б) Прочитайте, транслітеруйте та перекладіть:
