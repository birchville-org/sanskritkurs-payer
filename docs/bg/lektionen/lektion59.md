---
title: Урок 59
subtitle: "Секундарните окончания и императивните окончания на двойката (द्विवचनम्)"
lesson_id: 59
...
| :--- | :---: | :---: | :---: | :---: | :---: |
|   | вторичен | Повелително (लोट्) | вторичен тематичен | вторичен атематичен[[br]]Оптиматив (विधिलिङ्) | Повелително (लोट्) |
...
::: grammar-box
**Пред -ва и -вахи тематичният гласен -а- се заменя с -ā-.**
:::

### 59.2.1. Първи клас на настоящето време (भ्वादिगणः)

भू 1-во лице ед. число „стана, бъда“
...
::: grammar-box
**Сиṣ-аористът се образува в П от всички корени на -ā, -e, -o, -ai, които не са ограничени до 1., 2. или 3. аорист, както и от някои други корени, между които नम्, यम्, रम्. В Ā всички тези корени образуват s-аорист.**

**Образуване:**

**Авгмент + висока степен на корена + s + i + ṣ + атематична вторична окончание (като iṣ-аорист)**
:::

Суфиксът за образуване на основа и окончанието на сиṣ-аорист са следните:
...
::: grammar-box
**Най-голямата част от अनिट्-корените, които завършват на -ś, -ṣ или -h и предпоследната им позиция е i, u или ṛ, образуват sa-аорист. Факултативните अनिट्-корени с такава структура образуват по избор sa-аорист или iṣ-аорист.**

**Образуване:**

**Аугмент + ниско степенуване на корена + s + a + тематично вторично окончание**

**1.l.2.l.3.l.дв. се образуват от s-аорист, т.е. атематично.**
:::

Сuffixът за образуване на основа + окончанието на sa-аорист са следните:
...
**Няколко корена на -h (गुह्, दिह्, दुह्, लिह्) могат в Ā да образуват по избор 2.3.l.1.l.2.m. без -sa-.**
:::
...
Следващият текст е от भट्टिकाव्य ("Поетическо произведение на \[поета\] Bhaṭṭi"). भट्टिकाव्य разказва в 22 песни историята на राम, като едновременно с това илюстрира правилата на граматиката и поетиката чрез примери.

Поетичното произведение има четири раздела:

1.  Песни 1-5: смесени правила
2.  Песни 6-9: основни правила на граматиката на Pāṇini
3.  Песни 10-13: най-важните поетически украшения
4.  Песни 14-22: употреба на времената и наклоненията

भट्टिकाव्य е създадено в периода между 495 и 641 г. сл.н.е.
...
:::
Следващият откъс е началото на 15-та песен, посветена на аориста. रावण, царят на демоните, който е откраднал жена му सीता на राम, изпраща за своя брат कुम्भकर्ण ("Гърнеухо"), който лежи в вид на вечен сън като наказание за своите престъпления.

::: media
![](/images/lekt5903.webp)
Ил.: कुम्भकर्णः
Kecak танц, Бали (Индонезия)
...
**lekt5902:** [Източник на изображението: Henryart/Wikipedia. Обществено достояние]

**lekt5903:** Kecak танц, Бали (Индонезия) [Източник на изображението: Flying Pharmacist / Wikipedia. [Лиценз Creative Commons](http://creativecommons.org/licenses/by-sa/3.0/) (Attribution, share alike)]
