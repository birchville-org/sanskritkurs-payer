...
A) Впишете в следните изречения, като вземете предвид сандхи, посочените имена и съществителни, и образувате именни изречения:
...
Обр.: ईश्वरः शिवः
(Източник на изображението: [Подробности](/bg/licenses#uebung002))
:::