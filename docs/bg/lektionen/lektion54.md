...
Със Урок 54 в университетските занятия започва 2‑тият семестър. От сега нататък курсът се провежда изключително в контекста на главната тема на този семестър – четенето на цялата **Bhagavadgītā**. Целта е да се достигне такава гладкост при четене на средно труден текст, че в последната трета част на семестъра големи пасажи от **Bhagavadgītā** да могат да се превеждат от паметта. В началото в университетските занятия се раздаваха словни листове, по‑късно студентите трябваше сами да ползват съответните речници (Monier‑Williams, Apte, PW).
...
इच्छाप्रकृति   () ( да  ; „в  е да се  ) се   -u за  на **Nomina agentis**.

(Образуването на желателните глогове ще се разгледа по‑късно)
...
![](/images/lekt5402.jpg)  
Фигура: अयुयुत्सुरर्जुनः  
भगवद्गीतोपदेशः  
Tirupati = తిరుపతి  
\[Източник на изображението: Raji Srinivas / Wikipedia. GNU FDLicense\]
...
Пример за рецитация: [http://www.vaisnava.cz/gita/mp3/Bhagavad-gita02.mp3](http://www.vaisnava.cz/gita/mp3/Bhagavad-gita02.mp3). – Достъпно на 2009‑01‑28

## 54.5. लुङ्  на  ()

लुङ् लङ्    на  () е  **a‑**,  се    по      ().

В санскрит аорист се ползва само в индикатив и пракатив.

लुङ् са    на  ():

1. **Незвукови (асигматични) аористи:**  
    *   54.5. -iṣ-Aorist: Augment + Wurzel + i + ṣ + Sekundärendung
    * 54.2. **Темавокален аорист:** аугмент + корен + a + вторична наставка  
    *   54.5. -iṣ-Aorist: Augment + Wurzel + i + ṣ + Sekundärendung
> | 3\. प्रथमः | अपात् | अपुर्  
    * 54.4. **‑s‑аорист:** аугмент + корен + s + вторична наставка  
    *   54.5. -iṣ-Aorist: Augment + Wurzel + i + ṣ + Sekundärendung
    *   54.6. -siṣ-Aorist: Augment + Wurzel + siṣ + Sekundärendung
    * 54.7. **‑sa‑аорист:** аугмент + корен + s + a + вторична наставка  
...
Наставката за 3‑м л. мн. е **‑ur**. **Ātmanepada** не се използва.
...
### 54.6.1. Аорист на 3‑т. ед. страдателен  
...
(Останалите страдателни форми в аорист се изразяват чрез **Ātmanepada** форми).

## 54.7. Упражнение  

Преведете на писмено (Писмо) следните форми и образувайте съответните аористни форми:
...
![](/images/lekt5401.jpg)  
Фигура: त्रिचक्रेणेश्वरः स्तूयते  
Tamil Nadu  
[Източник на изображение: driek. – [http://www.flickr.com/photos/driek/2411004380/](http://www.flickr.com/photos/driek/2411004380/). – Достъпно на 2009‑01‑28. – [Creative Commons лиценз](http://creativecommons.org/licenses/by-nc-sa/2.0/deed.de) (признание, без комерсиална употреба, споделяне на същите условия)]