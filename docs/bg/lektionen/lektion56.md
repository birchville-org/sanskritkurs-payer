...
Augment + редуплициран корен + a + тематичен вторичен суфикс  

Коренната сричка може да е в дълбока или висока степен. При корени, завършващи на -i или -u, дълбоката степен е правилото.  

Крайната -i, -u се заменя с -iy съответно -uv.  
...
### 56.1.1. Образуване на аориста на каузативите и на корените от 10‑тата клас на настоящето

**Коренна сричка:**  

Изходната точка е формата на настоящата (или каузативната) основа, след като е премахнат елементът за образуване **-aya-** (т.е. основа на -p при каузативи на -paya-).
...
**Гласна на редупликационната сричка:**  
...
**Особености на определени корени според Kielhorn, Grammatik § 435c ff.**

Коренните срички, започващи гласна, се редупликират по следните правила:

*   Ако след гласната следва само един съгласен или група съгласни, чийто първи член не е нито назален, нито **d**, нито **r**, редупликационната сричка е:  

    гласна – първи следващ съгласен (или негов представител в редупликационната сричка) – i – всички съгласни  
...
*   i, u wird durch ī, ū ersetzt, wenn die Stammsilbe mit nur einem Konsonanten anfängt und metrisch kurz ist:  
    ...
    гласна – първи съгласен – втори съгласен (представител) – i – втори съгласен  
...
Инјунктивът е формата без аугмент към аугментните форми, т.е. неговите форми са идентични с аугмент‑без‑формите на индикативното имперфект или аорист. Индийската граматика не признава инжунктив като отделна граматическа категория.

Съгласно основната работа:

![](/images/lekt5601.jpg)  
*   मा + (स्म) + Imperativ (selten)  
Професор по сравнителна лингвистика, Университет Еранген‑Нюрнбърг (1955 – 1983)  
[Източник на изображението: http://titus.uni‑frankfurt.de/personal/galeria/hoffma‑k.htm – достъпно на 27‑02‑2009]
...
В пост‑Ведически санскрит инжунктивът се използва само в комбинация с частицата за забрана **मा** (+ инжунктив аорист) или **मा स्म** (+ инжунктив настояще или аорист), при което различен аспект обикновено не се посочва.
...
![](/images/lekt5602.jpg)  
Фигура: क्लैब्यं मा स्म गमः (भगवद्गीता 2,3a)  
Плакат (Ернесто Че Гевара) на политическа партия във Валлахира (വാല്ലചിര), Трисур (തൃശ്ശൂര്‍).  
„Груба превод на надписа:  
Мъченичеството е вълнуващо изживяване за революционер.  
И заплашително за труса.  
Че не е образец за трусовете.“  
[Източник на изображението: Hari_Menon – http://www.flickr.com/photos/me_haridas/2282563515/ – достъпно на 27‑02‑2009 – лиценз Creative Commons Attribution‑NonCommercial‑ShareAlike 2.0 (Име, без комерсиална употреба, споделяне при същите условия)]

Двата примера имат prohibitivно значение. Инжунктивът аорист тук се употребява в първоначалното си значение. (Превесът на аорист в такива изречения вероятно се дължи на превес на prohibitivните изречения над inhibitivните, но това изисква допълнително изследване за класическия санскрит.)
...
*   मा + (स्म) + Imperativ (selten)  
    ...
     
*   अलम् oder कृतम्  = Instrumentalis im Inhibitivsatz  
    напр. अलं  विषादेन "Genug mit dem Verzagen! = Hör auf, verzagt zu sein! = Kopf hoch!"  
     
...
![](/images/lekt5603.jpg)  
Фигура:  अलं  विषादेन  
[Източник: World Bank / Curt Carnemark – http://www.flickr.com/photos/worldbank/2244549274/ – достъпно на 27‑02‑2009 – лиценз Creative Commons Attribution‑NoDerivs 2.0 (Име, без комерсиална употреба, без изменения)]

## 56.4. स्म

## 56.4. स्म

Също така следната конструкция е изключително важна:

> स्म + Indikativ Präsens dient zum Erzählen in der Vergangenheit, vor allem um eine Dauer in der Vergangenheit zu bezeichnen:
> 
> напр. वसति स्म "es wohnte einmal" (स्म kann manchmal auch fehlen).
