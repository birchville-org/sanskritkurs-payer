...
::: grammar-box
**Das Kausativ ist mit wenigen Ausnahmen Ubhayapada** &lt;!-- TODO: Fallback translation --&gt;
:::

Regeln für die Verwendung des Ātmanepada im Kausativum: &lt;!-- TODO: Fallback translation --&gt;

::: grammar-box
**Im Kausativum wird das Ātmanepada verwendet:** &lt;!-- TODO: Fallback translation --&gt;
...
Die Regeln entsprechen also i.A. den Regeln für die Verwendung des Ātmanepada bei Ubhayapada-Verben. &lt;!-- TODO: Fallback translation --&gt;
...
## 29.3. Упражнение за превод zur Wiederholung
...
## 29.4. Бъдеще време und Kausativ zu den bisher gelernten Коренn

::: grammar-box

| Корен[[br]]धातु | Бъдеще време[[br]]ऌत् | Kausativ[[br]]कारित |
| :--- | :--- | :--- |
