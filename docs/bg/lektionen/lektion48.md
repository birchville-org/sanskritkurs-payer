...
| **3. Person** :br⟪प्रथमः⟫ | \-tu:br\-tāt¹ | \-tām | \-antu:br**3.клас: -atu**:br(изв. -\*ntu) | \-atām:br(изв: -\*ntām) |
:::
...
| :---: | :--- |
| **\-ø** | Коренn der 5. und 8. Klasse, bei denen dem auslautenden \-u nur ein Konsonant vorausgeht. |
| **\-āna** | Коренn der 9. Klasse, die auf Konsonant enden, substituieren für \-nī+Окончание \-āna |
...
| **\-a** | Ersatz des **\-a** des Grundwortes durch das neue Suffix **\-a**.:brПримери siehe oben. |
