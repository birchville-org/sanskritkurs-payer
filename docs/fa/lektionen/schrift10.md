...
اگر اولین هم‌صدا از حروفی که باید به هم متصل شوند، با خط عمودی پایان نیابد، آنگاه هم‌صدای بعدی بدون خط افقی خود زیر اولین هم‌صدا قرار می‌گیرد.

استثناها: اگر ⟪म्⟫ یا ⟪य्⟫ دومین بخش ترکیب باشند، پس از نشانه اول به صورت کوتاه‌شده نوشته می‌شوند:
...
تمام حروف چسبیده‌ی ذکر شده در بالا را بنویسید
