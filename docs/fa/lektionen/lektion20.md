...
:::
## ۲۰.۶. صرف بخش پایانی یک باهووِریهی
...
:::
## ۲۰.۸. رابطه بهووریهی و جمله موصولی
...
۲. کالی‌داسا و سایر شاعران، اساتید زبان سانسکریت هستند.

۳. کشتری معاش خود را از طریق سلاح‌ها کسب می‌کند.

۴. همچنین زنان شودرا به عنوان دهارما، خشونت‌پرهیزی، راستگویی، پاکی، عدم شکایت، بدخواهی نداشتن و صبر دارند.
...
**lekt2001:** سیامریپ (ក្រុងសៀមរាប)، کامبوج، قرن نهم پس از میلاد [منبع تصویر: ویکی‌پدیا، مالکیت عمومی]

**lekt2002:** [منبع تصویر: مشارکت‌ها در ادبیات‌شناسی و تاریخ اندیشه هند. -- بون، ۱۹۲۶]

**lekt2003:** سانچی = ⟪सांची⟫ [منبع تصویر ویکی‌پدیا، مالکیت عمومی]

**lekt2004:** جوده‌پور = ⟪जोधपुर⟫ [منبع تصویر: Jared Zimmerman. -- http://www.flickr.com/photos/spoinknet/35414570/. -- دسترسی در ۲۰۰۸-۱۲-۱۱. -- مجوز کریتیو کامنز (نسب‌دهی، استفاده غیرتجاری، بدون تغییر)]

**lekt2005:** عیسی و سایر خدایان، احمدآباد [منبع تصویر: توسط ganuullu. -- http://www.flickr.com/photos/ganuullu/373131240/. -- دسترسی در ۲۰۰۸-۱۲-۱۱. -- مجوز کریتیو کامنز (نسب‌دهی، استفاده غیرتجاری، بدون تغییر)]

**lekt2006:** مدیا پرادش [منبع تصویر: dhyanji. -- http://www.flickr.com/photos/dhyanji/147056147/. -- دسترسی در ۲۰۰۸-۱۲-۱۱. -- مجوز کریتیو کامنز (نسب‌دهی، استفاده غیرتجاری، بدون تغییر)]

**lekt2007:** چنای = சென்னை [منبع تصویر: calamur. -- http://www.flickr.com/photos/gargi/162477734/. -- دسترسی در ۲۰۰۸-۱۲-۱۱. -- مجوز کریتیو کامنز (نسب‌دهی، استفاده غیرتجاری، بدون تغییر)]

**lekt2008:** ریشیکش = ⟪ऋषिकेश⟫. «این در واقع بخشی از آشرام در ریشیکش است که بیتلز آنجا اقامت داشتند. این بخش خاص زمانی که آن‌ها بودند وجود نداشت، اما به نظر خنک و جذاب می‌آید.» [منبع تصویر: توسط ogimogi. -- http://www.flickr.com/photos/ogimogi/284517677/. -- دسترسی در ۲۰۰۸-۱۲-۱۱. -- مجوز کریتیو کامنز (نسب‌دهی)]

**lekt2009** کارناتاکا [منبع تصویر: توسط mattlogelin. -- http://www.flickr.com/photos/mattlogelin/188758072/. -- دسترسی در ۲۰۰۸-۱۲-۱۱. -- مجوز کریتیو کامنز (نسب‌دهی، استفاده غیرتجاری)]

**lekt2010:** بودا به عنوان یک زاهد پیش از بینش رهایی‌بخش خود، گاندارا، قرن ۲/۳. [منبع تصویر: ویکی‌پدیا، مجوز GNU FDLicense]
:::
