---
title: "درس ۶۰"
subtitle: "پایان‌های دوگانهٔ ماضی کامل (⟪द्विवचनम्⟫)"
lesson_id: 60
...
(منبع تصویر: [جزئیات](/fa/licenses#lekt6001))
:::

::: media
![](/images/lekt6002.webp)
(منبع تصویر: [جزئیات](/fa/licenses#lekt6002))
:::
...
(منبع تصویر: [جزئیات](/fa/licenses#lekt6003))
:::

::: media
![](/images/lekt6004.webp)
(منبع تصویر: [جزئیات](/fa/licenses#lekt6004))
:::
...
(منبع تصویر: [جزئیات](/fa/licenses#lekt6005))
...
| ⟪पत्⟫ 1P | ⟪पिपतिषति⟫ «او در آستانه‌ی افتادن است» |
| ⟪चुर्⟫ 10U | ⟪चुचोरयिषति⟫ «او می‌خواهد بدزدد» |
| ⟪बुध्⟫ کائس. | ⟪बुबोधयिषति⟫ «او می‌خواهد تعلیم دهد (به سوی آگاهی بیدار کند)» |

### 60.6.1. شکل‌گیری بن تمنا (دسیدراتیو)

::: grammar-box
**ریشه‌های کلاس‌های صرفی ۱ تا ۹:**

**ریشه تکرارشونده + sa**

**یا:**

**ریشه تکرارشونده + i + ṣa**

برای قوانین استفاده از واکه‌ی پیوند دهنده‌ی -i- به کیلهورن، دستور زبان § 443 - 445 مراجعه کنید.

**ریشه‌های کلاس صرفی دهم و سبک علت‌ساز (کائساتیو):**

**بن صرفی تکرارشونده + i + ṣa**
:::
::: grammar-box
**شکل ریشه:**

1.  ریشه معمولاً در حالت گام پایین (گُروت) است: ⟪जीव्⟫ » ⟪जिजीविष⟫-  

1.  اگر واکه‌ی پیوند دهنده‌ای دنبال نشود، -i یا -u پایانی به ترتیب با -ī و -ū جایگزین می‌شوند:  
⟪जि⟫ » ⟪जि⟫:sig[⟪गी⟫]⟪ष⟫- «خواستن پیروزی»  
⟪द्रु⟫ » ⟪दु⟫:sig[⟪द्रू⟫]⟪ष⟫- «خواستن دویدن»  

2.  اگر واکه‌ی پیوند دهنده‌ای دنبال نشود، -ṝ یا -ṛ پایانی به ترتیب با -īr و پس از واژه‌های لبی (لابیال) با -ūr جایگزین می‌شوند:  
⟪कृ⟫ » ⟪चि⟫:sig[⟪कीर्ष⟫]\- «خواستن انجام دادن»  
⟪मृ⟫ » ⟪मु⟫:sig[⟪मूर्ष⟫]\- «در آستانه‌ی مردن بودن»  
⟪पॄ⟫ » ⟪पु⟫:sig[⟪पूर्ष⟫]\- «خواستن پر کردن»  

3.  ⟪दा⟫، ⟪धा⟫ و ⟪मा⟫ و برخی ریشه‌های دیگر با -ā، -e، -o در حالت گام پایین (گُروت) Ø هستند:  
⟪दा⟫ » ⟪दित्स⟫- (di-**d** + sa)  
⟪धा⟫ » ⟪धित्स⟫-  
⟪मा⟫ » ⟪मित्स⟫-  

2. ریشه‌های در حالت گام بالا (دیرغات) در تمنا: 
1.  بیشتر ریشه‌های با -ā (-e، -ai و غیره):  
⟪गै⟫ » ⟪जिगास⟫- «خواستن خواندن»  
⟪पा⟫ » ⟪पिपास⟫- «خواستن نوشیدن، تشنه بودن»
:::
::: grammar-box
...
(منبع تصویر: [جزئیات](/fa/licenses#lekt6006))
:::
...
(منبع تصویر: [جزئیات](/fa/licenses#lekt6007))
:::

::: media
![](/images/lekt6008.webp)
(منبع تصویر: [جزئیات](/fa/licenses#lekt6008))
:::

::: media
![](/images/lekt6009.webp)
(منبع تصویر: [جزئیات](/fa/licenses#lekt6009))
:::
