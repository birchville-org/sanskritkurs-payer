...
[L0] A) از جمله‌های فعال درس ۷ (lektion07.md)، تمرین A با استفاده از PPP جمله‌های مجهول گذشته، و برای افعال لازم و حرکتی جمله‌های فعال گذشته بسازید.
...
ب) صفت‌های مفعولی گذشته (PPPs) مربوط به شکل‌های فعلی [درس ۱۰](lektion10.md)، تمرین A را بسازید. توجه داشته باشید که به یک شکل مانند sṛjati، PPPهایی در هر سه جنسیت پاسخ می‌دهند.
