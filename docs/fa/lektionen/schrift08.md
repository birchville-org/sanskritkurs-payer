...
نشانه‌های مصوت برای شروع کلمه، در صورتی که کلمه در نوشتار با کلمه قبلی متصل نباشد:
...
۱. اگر نشانه هم‌صدای نخستین که قرار است پیوند بخورد با خط عمودی در سمت راست پایان یابد، این خط را از دست می‌دهد و پیش از هم‌صدای دوم قرار می‌گیرد.

استثنا: اگر نشانه هم‌صدای دوم ⟪न्⟫ یا ⟪ल्⟫ باشد، این نشانه با از دست دادن خط افقی زیر نشانه هم‌صدای نخستین قرار می‌گیرد. بسته به نوع قلم، استثناهای دیگری نیز وجود دارد که در ادامه فهرست شده‌اند. اگر در قلم مورد نظر لیگاتویی پیش‌بینی نشده باشد، ویراما (Virāma) قرار داده می‌شود.

Beispiele:

در نوعی که در این اسکریپت استفاده می‌شود:
...
به املای jña توجه کنید:

![](/images/schrift017.webp)

حرف -a ابتدایی که طبق قواعد سانسکریت جمله‌ای حذف می‌شود (-as + a- » -o ' ) با نام آواگراها شناخته می‌شود:
...
د) بخوانید، تANSKRیت کنید و ترجمه نمایید:
