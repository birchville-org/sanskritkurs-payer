...
## 27.1. کاربرد حالت مکانی (⟪سَپتَمی⟫ مؤنث = "هفتمین پایان حالت")

::: grammar-box

**حالت مکان (⟪सप्तमी⟫) به پرسش‌های زیر پاسخ می‌دهد:**
*   **کجا؟**
*   **کجا؟**
*   **چه زمانی؟**
*   **نسبت به چه چیزی؟**
...
**۱. حالت مکان (⟪सप्तमी⟫) به پرسش «کجا؟» پاسخ داده و مکانی را نشان می‌دهد که در آن (روی، بر، نزد) فاعل (⟪कर्ता⟫) یا مفعول یک عمل قرار دارد یا خود آن عمل رخ می‌دهد.**
...
تصویر: ⟪जयपुरनगरे⟫
جایپور، ۱۸۷۵.
(منبع تصویر: [جزئیات](/licenses#lekt2701))
:::

::: grammar-box

**۲. حالت مکانی (Lokativ) در پاسخ به پرسش «چه زمانی؟» زمان یا شرایط خارجی را نشان می‌دهد:**

> ⟪तस्मिन्काले⟫ = «در آن زمان، در این هنگام»

**همچنین به اینجا Locativus Absolutus (مطلق مکانی) مربوط می‌شود:**

**اگر عمل یا حالت یک شخص یا چیز، زمانی را که - یا شرایطی را که زیر آن‌ها - شخص یا چیز دیگری عملی انجام می‌دهد یا در وضعیت خاصی قرار دارد، تعیین کند، آنگاه کلمه‌ای که آن شخص یا چیز نخستین را مشخص می‌کند، همراه با کلمه‌ای که همان را دقیق‌تر تعیین می‌نماید (که اغلب یک اسم مفعولی است) در حالت مکانی ظاهر می‌شود (⟪सप्तमी⟫):**

> ⟪एवं⟫ ⟪गच्छति⟫ ⟪काले⟫ = "در حالی که زمان می‌گذرد..."
>
> ⟪तस्मिन्गते⟫ = "پس از آنکه او رفته بود..."

**گاهی اوقات کارگزار (⟪कर्ता⟫) به طور جداگانه ذکر نمی‌شود:**

> ⟪एवं⟫ ⟪सति⟫ = "زیرا این‌گونه است"

**مطلق مکان (Locativus absolutus) باید بسته به زمینه با "در حالی که" (مثلاً اسم فاعل حال)، "پس از آنکه"، "هنگامی که" (مثلاً اسم مفعولی گذشته)، "زیرا"، "چون"، "با اینکه" یا "اگر" ترجمه شود.**
...
راجستان.
(منبع تصویر: [جزئیات](/licenses#lekt2702))
:::
...
هولی.
(منبع تصویر: [جزئیات](/licenses#lekt2703))
:::
...
## 27.2. Bildung des حالت مکانی (⟪सप्तमी⟫)
...
:::
## 27.3. مروری بر پایانه‌های حالت منظم (⟪विभक्ति⟫)
...
:::
**چاپ شده به رنگ قرمز**: موارد قوی صرفی (در صورت تغییر پایه).

## 27.4. یک بیت با تمام اشکال صرفی (مفرد) برای ⟪राम⟫

::: media
![](/images/lekt2708.webp)
تصویر: ⟪रामे⟫ ⟪चित्तलयः⟫ ⟪सदा⟫ ⟪भवतु⟫ ⟪मे⟫ ⟪भो⟫ ⟪राम⟫ ⟪मामुद्धर⟫ ⟪॥⟫
Rāma-Satz.
(منبع تصویر: [جزئیات](/licenses#lekt2708))
:::
...
**ترجمه:**
۱. **حالت فاعلی:** راما، آن گوهر (⟪मणि⟫ مذکر) در میان شاهان (⟪राजन्⟫ مذکر)، همیشه (⟪सदा⟫) پیروز می‌شود.
۲. **حالت مفعولی:** من راما را، سرور و همسر (⟪ईश⟫ مذکر) راما (= لاکشمی)، دوست می‌دارم (⟪भज्⟫ اول شخص مفرد).
۳. **حالت ابزاری:** راما سپاه (⟪चमू⟫ مؤنث) شب‌گردان (= دیوان) (⟪निशा⟫ مؤنث = شب) را کشت.
۴. **حالت برایی:** بر این راما درود باد!
۵. **حالت ازی:** پناهگاهی (⟪परायण⟫ خنثی) بهتر (⟪परतर⟫ ۳) از راما وجود ندارد.
۶. **حالت اضافی:** من (⟪अहम्⟫) بندهٔ راما هستم (⟪अस्मि⟫).
۷. **حالت مکانی:** آرامش (⟪लय⟫ مذکر) قلبم (⟪मे⟫) همیشه در راما باد (⟪भवतु⟫).
۸. **حالت ندایی:** ای راما، مرا (⟪माम्⟫) نجات ده (⟪उद्धर⟫ = حالت امری از ⟪उद्⟫ + ⟪हृ⟫ یا ⟪उद्⟫ + ⟪धृ⟫)
...
::: indent
**آینده:** ⟪वसिष्यते⟫:br **اسم مفعولی:** ⟪वसित⟫:br **نهادین:** ⟪वसितुम्⟫
:::
از آن:
...
(منبع تصویر: [جزئیات](/licenses#lekt2709))
:::
...
تصویر: ⟪नराः⟫
نارن. اودایپور.
(منبع تصویر: [جزئیات](/licenses#lekt2711))
:::
### ۲۷.۷.۲. خنثی‌های ختم شده به -a: ⟪फल⟫
...
تصویر: ⟪फलानि⟫
میوه‌ها. بنگالورو.
(منبع تصویر: [جزئیات](/licenses#lekt2710))
:::
### ۲۷.۷.۳. مؤنث با -ā: ⟪क्षत्रिया⟫
...
(منبع تصویر: [جزئیات](/licenses#lekt2718))
:::
### ۲۷.۷.۴. مذکرها با -i: ⟪अरि⟫
...
(منبع تصویر: [جزئیات](/licenses#lekt2712))
:::
### ۲۷.۷.۵. مؤنث‌های ختم شده به -i: ⟪مَتی⟫
...
(منبع تصویر: [جزئیات](/licenses#lekt2713))
:::
### ۲۷.۷.۷. مؤنث‌های منتهی به -u: ⟪धेनु⟫
...
تصویر: ⟪धेनुः⟫
گاو در اودایپور.
(منبع تصویر: [جزئیات](/licenses#lekt2714))
:::
### ۲۷.۷.۸. اسم‌های مؤنث چندبخشی ختم شده به -ī: ⟪देवी⟫
...
(منبع تصویر: [جزئیات](/licenses#lekt2715))
:::
### ۲۷.۷.۹. اسم فاعل مضارع پاراسمایپادا با -ant: ⟪सन्त्⟫
...
(منبع تصویر: [جزئیات](/licenses#lekt2716))
:::
### ۲۷.۷.۱۰. ⟪महान्त्⟫
...
