...
:::
## ۳۸.۲. دگرگونی آوایی نیم‌واک‌ها در کلمه
...
:::
## 38.3. صرف اسم‌های بن‌دار بر -n

### 38.3.1. اسم‌های منتهی به -an و همچنین اسم‌های منتهی به -man یا -van پس از مصوت
::: grammar-box
...
| **ریشه ضعیف میانی** | **-a** :br(از -*n) | **-ma** :br(از -*mn) | **-va** :br(از -*vn) | سایر حالت‌ها پیش از پایان همخوانی:بر انتخابی نیز مفرد مکان مذکر، خنثی و مؤنث |
| **ضعیف‌ترین ریشه** | **-n** | **-mn** | **-vn** | سایر حالت‌ها پیش از پایان مصوتی |
...
:::
### ۳۸.۳.۲. اسم‌های پسوند -man یا -van پس از همخوان
...
:::
## ۳۸.۶. مباحث نحوی دربارهٔ ⟪आत्मन्⟫
...
## 38.11. فهرست واژگان برای تمرین ترجمه
...
(منبع تصویر: [جزئیات](/licenses#lekt3813))
:::
⟪एकैकशस्⟫ قید: به‌طور جداگانه
...
تصویر: ⟪गणयां⟫ ⟪चक्रुः⟫
(منبع تصویر: [جزئیات](/licenses#lekt3814))
:::
