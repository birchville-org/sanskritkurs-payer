...
Exemples de r devant une consonne :
...
r après une consonne : /

*   pour les lettres avec une barre verticale finale : / sur la barre verticale finale
    
*   pour les autres lettres : en bas de la lettre
...
A) Écrivez en Devanāgarī et donnez la traduction (nécessite la Leçon 8) :
...
B) Lisez, translitérez et traduisez :
