# Exercice d’écriture 10

### Deuxième règle de formation des ligatures de consonnes

\[La première règle se trouve dans [Exercice d’écriture 8](schrift08.md)\]

Lorsque le premier des consonnes à relier ne se termine pas par un trait vertical, le consonne suivante est placée sous le premier consonne, en perdant son trait horizontal.

Exceptions : Si म् ou य् constituent le second élément de la ligature, ils sont écrits raccourcis derrière le premier caractère :
...
Écrivez toutes les ligatures mentionnées ci-dessus

### Tableau des ligatures les plus courantes dans la police de caractères de la grammaire de Kielhorn
