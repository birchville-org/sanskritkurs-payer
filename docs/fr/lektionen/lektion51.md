...
:::
### 51.2.1. Racines sur occlusives non palatales

::: grammar-box
**Les règles phonétiques habituelles s'appliquent, c'est-à-dire**
* **en position finale se trouve la non-aspirée sourde correspondante**
* **devant le -su du locatif pluriel, la finale est d'abord remplacée par la non-aspirée sourde correspondante, puis les modifications phonétiques appropriées se produisent**
...
Pluriel Nom.Acc.Voc. :sig[⟪शत्रुजिन्ति⟫]
:::
...
### 51.2.2. Racines sur occlusives palatales (c, ch, j), ś, ṣ

::: grammar-box
**Devant une terminaison commençant par une voyelle, la finale de la racine reste inchangée.**

**Pour les autres terminaisons, il vaut ce qui suit :**

* **-c et -j en finale sont remplacés par k, puis la racine est traitée comme si elle se terminait par -k**
* **dans certains mots (liste chez Kielhorn, Grammatik p. 18), -j en finale est remplacé par -ṭ**
* **-ch en finale est remplacé par -ṭ**
* **-ś et -ṣ en finale sont, à quelques exceptions près, remplacés par -ṭ. Dans les cas exceptionnels, -ś et -ṣ sont remplacés par -k**
