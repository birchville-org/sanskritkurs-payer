---
title: "Ders 6"
subtitle: "Fiil cümlesinin yapısı (Özne ve fiil biçimi)"
lesson_id: 6
...
::: grammar-box
**Şema I: Fiil Biçimi**
Örn. **yajati** = ⟪यजति⟫ = "O (o, o) bir sunumla onur verir", "O kurban keser"

**Şema II: Özne (kartṛ m. = ⟪कर्तृ⟫) – Fiil Biçimi**
Örn. **rāmo yajati** = ⟪रामो यजति⟫ = "Rāma bir sunumla onur verir", "Rāma kurban keser"
:::
Özne (**kartṛ** m. = ⟪कर्तृ⟫), edilgen kipte olmayan bir fiil cümlesinde belirtildiğinde, özne **Yalın hal** (birinci hâl, prathamā = ⟪प्रथमा⟫) halindedir. Sayı (vacana n. = ⟪वचन⟫) açısından özne ve fiil biçimi uyum gösterir.


## 6.2. Fiil Biçimlerinin Oluşturulması
...
3. **Edilgen** (**karman** n. = ⟪कर्मन्⟫). Örn. **ijyate** = ⟪इज्यते⟫ = "Bir sunumla onurlandırılır"
...
::: grammar-box
| | Tekil (Einzahl):brekavacana n.:br⟪एकवचन⟫ | Çoğul (Mehrzahl):brbahuvacana n.:br⟪बहुवचन⟫ |
| :--- | :--- | :--- |
| **Parasmaipada n.** :br⟪परस्मैपद⟫ | **-ti** :br-⟪ति⟫ | **-nti** :br-⟪न्ति⟫ |
| **Ātmanepada n.** :br⟪आत्मनेपद⟫ | **-te** :br-⟪ते⟫ | **-nte** :br-⟪न्ते⟫ |
:::
Örnek **yaj** = ⟪यज्⟫ = "bir kurbanla onurlandırmak", "kurban sunmak":
Şimdiki zaman kökü: **yaja** = ⟪यज⟫
3. sg. P. **yajati** = ⟪यजति⟫
...
## 6.5. Şimdiki zaman kökünün oluşturulması

### 6.5.1. Altıncı şimdiki zaman sınıfına ait fiiller (tudādi = ⟪तुदादि⟫ = "tud vb.")

::: grammar-box
**Şimdiki zaman kökü = Kök (ortak sesli derecede, yani listelendiği şekilde) + a-**

| Kök (dhātu m.):br⟪धातु⟫ | Şimdiki zaman kökü |
| :--- | :--- |
| **viś** :br⟪विश्⟫ | **viśa-** :br⟪विश⟫- |
| **sṛj** :br⟪सृज्⟫ | **sṛja-** :br⟪सृज⟫- |
:::
### 6.5.2. Birinci şimdiki zaman sınıfına ait fiiller (bhvādi / bhūvādi = ⟪भ्वादि⟫ / ⟪भूवादि⟫ = "bhū vb.")

::: grammar-box
| Şimdiki zaman kökü = Kök (yüksek sesli derecede, nadiren uzatılmış) + a- ||||
| Kök (dhātu m.):br⟪धातु⟫ | Yüksek sesli derecesi | a- öncesinde yüksek sesli derecesi | Şimdiki zaman kökü |
| :--- | :--- | :--- | :--- |
...
| Ünlü uzun kapalı bir hecede, yani kısa ünlünün iki veya daha fazla ünsüzden önce gelmesi durumunda, yüksek sesli derecesi oluşturulmaz ||||
| **nind** :br⟪निन्द्⟫ | **nind** :br⟪निन्द्⟫ | **nind** :br⟪निन्द्⟫ | **ninda-** :br⟪निन्द⟫- |
:::
#### 6.5.2.1. Kelime Sandhi'sinde e ve o
Sözcük içi ünlülerden önce **e** harfi **ay**, **o** harfi ise **av** ile değiştirilir.

#### 6.5.2.2. Ses Değişimi (Ablaut)

::: grammar-box
| Düşük Aşama:brYok Oluş Aşaması | Yüksek Aşama:brTam Aşama:brGuṇa m.:br⟪गुण⟫ | Uzun Aşama:brVṛddhi f.:br⟪वृद्धि⟫ |
| :--- | :--- | :--- |
**ø** | **a** | **ā** |
| **i / ī** | **e** | **ai** |
| **u / ū** | **o** | **au** |
...
| **ḷ** | **al** | **āl** |
:::
### 6.5.3. 4. Şimdiki Zaman Sınıfına Giren Fiiller (divādi = ⟪दिवादि⟫ = "div ve benzerleri")

::: grammar-box
**Şimdiki Zaman Kökü = Düşük Aşamada bulunan kök (listelendiği hali) + ya-**
...
:::
### 6.5.4. Temel Ünlü, Tematik Şimdiki Zaman Sınıfları

::: grammar-box
Şimdiki Zaman Sınıflarının kök yapım eklerindeki **a** harfine **Temel Ünlü (Themavokal)** denir. Kök yapım eklerinde **a** bulunan şimdiki zaman sınıfları bu nedenle "tematik şimdiki zaman sınıfları" olarak adlandırılır.
:::

## 6.6. Konuşulan Sanskritçe: Diğer Sorular (praśna m. = ⟪प्रश्न⟫)

::: grammar-box
**N. N. kiṃ karoti?** = N.N. ⟪किं करोति⟫ = "N. N. ne yapıyor?"
**N. N. (çoğul) kiṃ kurvanti?** = N.N. ⟪किं कुर्वन्ति⟫ = "N.N.'ler ne yapıyor?"
(karoti, kurvanti **kṛ** = ⟪कृ⟫ 8 U: "yapmak, etmek" fiiline aittir)
**kiṃ kuśalam?** = ⟪किं कुशलम्⟫ = "İyi misiniz?, Nasılsınız?"
Yanıt: **sarvathā kuśalam** = ⟪सर्वथा कुशलम्⟫ = "(Ben) her açıdan iyiyim."
:::
...
**P:** Kök yalnızca Parasmaipada'dadır
**Ā:** Kök yalnızca Ātmanepada'dadır
**U:** Ubhayapada ("her iki kelime biçimi"): Kök hem Parasmaipada'da hem de Ātmanepada'da kullanılır.
...
**muh** 4 P (muhyati) ⟪मुह् मुह्यति⟫ : şaşkınlık içinde olmak, kafa karışıklığına uğramak
**yudh** 4 Ā (yudhyate) ⟪युध् युध्यते⟫ : savaşmak
**viś** 6 P (viśati) ⟪विश् विशति⟫ : girmek, içeri almak
**sṛj** 6 P (sṛjati) ⟪सृज् सृजति⟫ : bırakmak, dışarı salmak, yayılmak


## 6.8. Alıştırma

**A) Parantez içinde belirtilen kökleri kullanarak fiil cümleleri oluşturun:**
...
**B) A alıştırmasında oluşturulan cümleleri çoğul haline getirin.**

**C) Sanskrit’a çevirin:**
1. Bir sunakla tapan eder. (Sunak tanrısı için sunak rahibi)
2. Śiva dans eder.
3. Rāma yönetir.
4. Śūdralar şaşkındır.
5. Kṣatriya kadınları girerler.
6. HÜKÜMDAR yayılır.
7. Kṣatriya bir sunakla tapan eder. (sunak tanrısı olarak)
8. Śūdra kadınları dans ederler.
9. Kṣatriyalar savaşır.
10. Aziz adamlar yönetirler.
11. Hatırlarlar.
12. Kim (dişil) dans eder?
13. (Anılan) Brahman kadın dans eder.

::: media
![](/images/lekt0601.webp)
**Śivo nṛtyati** = ⟪शिवो नृत्यति⟫
Śiva Naṭarāja (⟪नटराज⟫), Kadavul Hindu Tapınağı, Kauai, Hawaii
(Görsel kaynağı: Wikipedia, CC-BY-SA 2.5)
:::

## 6.9. Tekrar alıştırması

**A) Yerleştirme alıştırması: Aşağıdaki yerleştirme alıştırmalarından sonra oluşturduğunuz cümlelerin cevabı olan soruları oluşturun:**
