...
Kelime başındaki sesli harf işaretleri, eğer kelime önceki bir kelime ile yazıda bağlı değilse:

![](/images/schrift015.webp)

![](/images/schrift016.jpg)

### Ünsüz birleşmeleri (Ligatürler)

Kelime veya cümlede iki veya birden fazla ünsüz yan yana geldiğinde, bunlar birleşik işaret (ligatür) kullanılarak yazılır.

1. Eğer birleştirilecek ünsüz işaretlerinden ilki sağdaki dikey çizgi ile bitiyorsa, bu çizgiyi kaybeder ve ikinci ünsüzün önüne yerleştirilir.

İstisna: Eğer ikinci ünsüz işareti ⟪न्⟫ veya ⟪ल्⟫ ise, yatay çizgisini kaybederek ilk ünsüz işaretin altına yerleştirilir. Yazı tipine bağlı olarak aşağıda listelenen diğer istisnalar da vardır. İlgili yazı tipinde bir ligatür öngörülmemişse, Virāma konur.

Örnekler:

Bu metinde kullanılan yazı tipinde:
...
Birleşik harflerin yazımına dikkat edin:

![](/images/schrift017.webp)

Cümle sandhi kurallarına göre elide edilen (−as + a− » −o ') başlangıç −a, Avagraha olarak adlandırılır:
...
A) Yukarıdaki listede bulunan tüm birleşik harfleri yazın
...
D) Okuyunuz, transkribe ediniz ve çeviriniz:
