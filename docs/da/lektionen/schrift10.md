...
### Anden regel for dannelsen af konsonantligaturer

\[Første regel se i [Skriveøvelse 8](schrift08.md)\]

Hvis den første af de konsonanter, der skal forbindes, ikke slutter med en lodret streg, placeres den følgende konsonant under den første ved at miste sin vandrette streg.

Undtagelser: Hvis ⟪म्⟫ eller ⟪य्⟫ er det andet led i ligaturen, skrives de forkortede bag det første tegn:
...
Eksempler (undtagelser er understreget):
...
Skriv alle ovenfor nævnte ligaturer

### Fortegnelse over de mest almindelige ligaturer i skrifttypen fra Kielhorns grammatik
