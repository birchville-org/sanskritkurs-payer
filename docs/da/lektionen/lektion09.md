...
| :--- | :--- | :--- |
| **kṛ** :br8 U:br⟪कृ⟫:br"gøre" | **kāraka** :br(⟪कारक⟫) | "Skaber, gører" |
| **śru** :br5 P:br⟪श्रु⟫:br"høre" | **śrāvaka** m.:br(⟪श्रावक⟫) | "Hører, elev,:brbuddh.: Buddha-tilhænger" |
| **nī** :br1 U:br⟪नी⟫:br"lede" | **nāyaka** m.:br(⟪नायक⟫) /:br **nāyikā** f.:br(⟪नायिका⟫) | "Leder, hersker, ægtemand,:brelsker / elskerinde, dame" |
| **yaj** :br1 U:br⟪यज्⟫:br"ofre" | **yājaka** m.:br(⟪याजक⟫) | "Offerer, offerpræst" |
| **nṛt** :br4 P:br⟪नृत्⟫:br"danse" | **nartaka** m.:br(⟪नर्तक⟫) /:br **nartakī** f.:br(⟪नर्तकी⟫) | "Danser / danserinde" |
...
| Rod:br⟪धातु⟫ | + -aka (kṛt) | Betydning |
| :--- | :--- | :--- |
| **kṛṣ** :br6 U:br⟪कृष्⟫:br"plove" | **kṛṣaka** m.:br(⟪कृषक⟫) | "bonde":br(gammel grad!) |
| **kliś** :br9 P:br⟪क्लिशु⟫:br"pinde" | **kleśaka** m.:br(⟪क्लेशक⟫) | "plager" |
| **khād** :br1 P:br⟪खाद्⟫:br"tygge, spise" | **khādaka** m.:br(⟪खादक⟫) | "spiser, slukker" |
...
til **yaj** 1 U:
**ijyā** f. (⟪इज्या⟫) : Offer (fra \*yj » ij + suffikset **yā**)
