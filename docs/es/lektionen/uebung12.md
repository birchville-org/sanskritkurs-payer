...
A) Forme a partir de las oraciones activas de [Lección 7](lektion07.md), Ejercicio A, oraciones pasivas del pretérito con el participio de pasado (PPP); con verbos intransitivos y verbos de movimiento, oraciones activas del pretérito.
...
B) Forme los correspondientes PPes a las formas verbales de [Lección 10](lektion10.md), Ejercicio A. Tenga en cuenta que a una forma como sṛjati le corresponden PPes en los tres géneros.
...
C) Transforme las oraciones de [Lección 10](lektion10.md), Ejercicio C, al pasivo en el pretérito.
