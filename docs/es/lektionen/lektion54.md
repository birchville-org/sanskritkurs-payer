...
Con la Lección 54 comienza en la enseñanza universitaria el segundo semestre. A partir de ahora, el curso se desarrolla únicamente como complemento al tema principal de este semestre: la lectura completa de la *Bhagavadgītā*. El objetivo de aprendizaje es alcanzar una fluidez tal en la lectura de un texto de dificultad media, que en el último tercio del semestre puedan traducirse de forma improvisada grandes pasajes de la *Bhagavadgītā*. Al principio del curso se distribuían listas de vocabulario; posteriormente, los estudiantes debían utilizar por su cuenta diccionarios específicos (Monier-Williams, Apte, PW).

El curso sobre la *Bhagavadgītā* no estará disponible en línea por el momento.

Las lecciones del curso de sánscrito abordan temas de gramática sánscrita que aún no han sido tratados.
...
La त्रिष्टुभ् presenta dos esquemas básicos, dependiendo de si la cesura (final de palabra, límite composicional o antes de ciertos sufijos como -tara, -tama, etc.) se sitúa después de la cuarta o la quinta sílaba del पाद.
...
Ejemplo de recitación: [http://www.vaisnava.cz/gita/mp3/Bhagavad-gita02.mp3](http://www.vaisnava.cz/gita/mp3/Bhagavad-gita02.mp3). -- Acceso el 2009-01-28
...
1.  Aoristos no sibilánticos (asigmáticos):  
    *   54.1. Aoristo de la raíz: Augumento + raíz + terminación secundaria
    *   54.2. Aoristo temático: Augumento + raíz + ***a*** + terminación secundaria
    *   54.3. Aoristo reduplicado: Augumento + ***raíz reduplicada*** + ***a*** + terminación secundaria  
2.  Aoristos sibilánticos (sigmáticos: aparece una s o una sílaba que contiene s (ṣ) antes de la terminación personal):  
    *   54.4. Aoristo en -s: Augumento + raíz + ***s*** + terminación secundaria
    *   54.5. Aoristo en -iṣ: Augumento + raíz + ***i*** + ***ṣ*** + terminación secundaria
    *   54.6. Aoristo en -siṣ: Augumento + raíz + ***siṣ*** + terminación secundaria
...
|   | Singular | Plural |
| --- | --- | --- |
| 1. Tercera persona | अपाम[[br]]a-pā + am | अपाम |
| 2. Segunda persona | अपास् | अपात |
| 3. Primera persona | अपात् | अपुर्[[br]]a-p-ur (grado reducido) |
:::
...
**La raíz presenta la siguiente forma:**
