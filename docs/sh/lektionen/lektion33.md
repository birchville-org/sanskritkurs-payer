...
* Treća klasa prezensa
* (kao i neki glagoli drugih klasa prezensa),
* perfekt,
* reduplicirani aorist,
* frequentativum i
* desiderativum

se formiraju pomoću reduplicacije. Deo reduplicirane forme koji se postavlja ispred korena naziva se silaba za reduplicaciju.

Silaba za reduplicaciju sastoji se od (jednog suglasnika i) samoglasnika.

### 33.1.1. Suglasnik za reduplicaciju

::: grammar-box
**1. Uobičajeno:**  
**Ponavljanje prvog suglasnika korena**
:::
Primeri:

::: indent
⟪दा⟫ 3 "dati"
* 3.sg.P.Ind.Präs. ⟪ददाति पॄ⟫ 3 "napuniti"
* 3.sg.P.Ind.Präs. :sig[⟪पि⟫]⟪पर्ति मा⟫ 3Ā "meriti"
* 3.sg.Ā.Ind.Präs. :sig[⟪मि⟫]⟪मीते⟫
:::
::: grammar-box
**2. Aspirirani početni suglasnik korena reduplicira se odgovarajućim neaspiriranim suglasnikom.**
:::
Primeri:

::: indent
⟪धा⟫ 3 "postaviti"
* 3.sg.P.Ind.Präs. ⟪दधाति भी⟫ 3 "bojati se"
* 3.sg.P.Ind.Präs. :sig[⟪बि⟫]⟪भेति⟫
:::
::: grammar-box
**3. Gutural se reduplicira odgovarajućim neaspiriranim palatalom:**

:::
::: indent
⟪क्⟫, ⟪ख्⟫ preko ⟪च् ग्⟫, ⟪घ्⟫ preko ⟪ज्⟫
:::
**⟪ह्⟫ se uvek reduplicira preko ⟪ज्⟫.**
Primeri:

::: indent
⟪हु⟫ 3 "(žrtvenoj) vatri uliti"
* 3.sg.P.Ind.Präs. ⟪जुहोति⟫
:::
::: grammar-box
**4. Ako koren počinje sa više suglasnika, ponavlja se samo prvi (uz eventualnu primenu pravila 2 ili 3).**
:::
::: grammar-box
**5. Ako koren počinje sa grupom suglasnika šum + bezglasni suglasnik, ne reduplicira se šum, već sledeći bezglasni suglasnik prema gore navedenim pravilima.**
:::
Example:
...
**The rules for the reduplication consonant given above apply.**
:::
...
::: grammar-box
⟪हु⟫ 3P "to pour into the fire (for sacrifice)"
...
* on the other hand, it is the high grade in an ablaut series of the ā-group
...
::: grammar-box
**Roots ending in -ā (except ⟪दा⟫ and ⟪धा⟫) usually grade to -ī- in the weak stem** (see Thumb-Hauschild Vol. 1,1 p. 271. Presumably the ablaut series B mentioned above served as a model, although these roots otherwise follow series A), **before vocalic endings the root vowel disappears completely (see ablaut series A).**
:::
Examples:
...
| | 3. sg. Ā. | 3. pl. Ā. |
| :--- | :--- | :--- |
| **Indicative Present** | ⟪मिमीते⟫:brmimī-te | ⟪मिमते⟫:brmim-ate |
...
**Note for ⟪धा⟫ the law of breath dissimilation!**
:::
::: grammar-box
...
Fig.: ⟪दानम्⟫
(Image source: [Details](/sh/licenses#lekt3306))
:::
...
(Image source: [Details](/sh/licenses#lekt3307))
:::
...
Fig.: ⟪समाधि⟫
(Image source: [Details](/sh/licenses#lekt3305))
:::
...
Fig.: ⟪भयम्⟫
(Image source: [Details](/sh/licenses#lekt3304))
:::
...
⟪हीनयान⟫ n.: the defective vehicle (of Buddhism): derogatory term used by representatives of the "Great Vehicle", i.e. ⟪महायान⟫; the defective path (⟪यान⟫ to ⟪या⟫ 2: to go, to travel). The term ⟪हीनयान⟫ should no longer be used. The surviving form of the ancient Buddhism is called ⟪थेरवाद⟫.
:::
::: media
![](/images/lekt3303.webp)
Fig.: ⟪हीनयानमेव⟫
(Image source: [Details](/sh/licenses#lekt3303))
:::
...
(Izvor slike: [Detalji](/sh/licenses#lekt3302))
:::
...
B) Insert the corresponding forms of the verbs specified in parentheses into Indicative Present, Imperfect, and Optative:
