---
title: "Lekcija 39"
subtitle: 'Lične nastavke prve osobe (:sig[⟪तृतीयः⟫] ⟪पुरुषः⟫ = \"**treća** osoba\")'
lesson_id: 39
...
## 39.1. Lične nastavke prve osobe (:sig[तृतीयः] ⟪पुरुषः⟫ = "**treća** osoba")

Nastavke prve osobe (:sig[⟪तृतीयः⟫] ⟪पुरुषः⟫ = "**treća** osoba") su:
...
| **Primarne nastavke tematskih osnova** | **-mi** | **-mas** | **-i**¹ | **-mahe** |
| **Primarne nastavke atematskih osnova** | ^^ | ^^ | **-e** | ^^ |
| **Sekundarne nastavke tematskih osnova** | **-m** | **-ma** | **-i** | **-mahi** |
| **Sekundarne nastavke atematskih osnova** | **-am** | ^^ | ^^ | ^^ |
| **Optativna nastavka** | ^^ | ^^ | **-a** | ^^ |
| **Perfektne nastavke** | **-a** | ^^ | **-e** | **-mahe** |

:::
¹ Napomena: zapravo, primarna nastavka Ā tematskih osnova treba da se postavi i kao -e, pred kojim tematski vokal -a- iz analognih razloga otpada. Međutim, efekat je takav kao da se nastavka -i pridružuje tematskom vokalu -a-: a + i » e.

## 39.2. Oblikovanje glagolskih oblika prve osobe tematskih prezentskih osnova

::: grammar-box
**Pravilo:**
**Pred -mi, -mas, -ma, -mahe, -mahi tematski vokal -a- zamenjuje se sa -ā- !!!**
:::
### 39.2.1. Prva klasa prezensa (⟪भ्वादि⟫)
...
| :--- | :---: | :---: | :---: | :---: |
| | ⟪एकवचनम्⟫ | ⟪बहुवचनम्⟫ | ⟪एकवचनम्⟫ | ⟪बहुवचनम्⟫ |
| **Indikativ prezens - ⟪लट्⟫** | ⟪भवामि⟫ | ⟪भवामस्⟫ | **⟪भवे⟫** :brbhava + i:brravno: bhav-e | **⟪भवामहे⟫** |
...
:::
## 39.3. Formation of the first-person verb forms of the simple future - ⟪ऌत्⟫
...
::: grammar-box
**Note that within the word - in contrast to sentence sandhi - before endings beginning with**
* **vowel**
* **semivowel**
* **nasal**
...
Fig.: ⟪सो ऽस्मि⟫
(Image source: [Details](/sh/licenses#lekt3901))
:::
...
::: grammar-box
**With roots ending in a vowel, the -u of the stem-forming suffix (-nu) may optionally be omitted before endings beginning with m-.**
:::
⟪सु⟫ 5U
...
| :--- | :---: | :---: | :---: | :---: |
| | ⟪एकवचनम्⟫ | ⟪बहुवचनम्⟫ | ⟪एकवचनम्⟫ | ⟪बहुवचनम्⟫ |
| **Indikativ prezens - ⟪लट्⟫** | ⟪क्रीणामि⟫ | ⟪क्रीणीमस्⟫ | ⟪क्रीणे⟫ :brkrī + n-e | ⟪क्रीणीमहे⟫ |
...
Izvedite za sljedeće glagolske oblike forme prve osobe koje odgovaraju tom glagolskom obliku u broju, vremenu, načinu (indikativ, optativ) i aspektualnom načinu (P, Ā, pasiv).

Primjer: ⟪गच्छन्ति⟫ » ⟪गच्छामस्⟫
