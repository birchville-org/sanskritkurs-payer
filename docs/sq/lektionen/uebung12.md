...
A) Formoni nga fjali aktive të [Leksioni 7](lektion07.md), Ushtrimi A, fjali pasive të së kaluarës; për verbat intransitivë dhe verbat e lëvizjes, formoni fjali aktive të së kaluarës.
...
B) Formoni PPP-të përkatës për format e verbit nga [Leksioni 10](lektion10.md), Ushtrimi A. Kini parasysh se një format si sṛjati i korrespondon PPP-ve në të tre gjinitë.
...
9. pāśyati ⟪पश्यति⟫ (Pasivi formohet nga dṛś!) : ⟪दृष्टः ३⟫
...
C) Shkruani pohimet nga [Mësimi 10](lektion10.md), ushtrimi C, në mënyrën pasive dhe në kohën e kaluar.
...
(Burimi i imazhit: [Detaje](/sq/licenses#uebung020))
:::
