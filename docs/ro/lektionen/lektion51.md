...
\-⟪ज⟫ 3 (jña » jā » forma profundă j + a) "descinzând din, născut în" de ex. ⟪आत्मज⟫ "fiu"

\-⟪ज्ञ⟫ 3 "cunoscător" (jñ-a) de ex. ⟪सर्वज्ञ⟫ 3 "cunoscător universal"

\-⟪द⟫ 3 "dând" (d-a) de ex. ⟪वारिद⟫ m. "nor" (⟪वारि⟫ n. "apă")

\-⟪प⟫ 3 "băând" (p-a) de ex. ⟪द्विप⟫ m. "elefant (bând de două ori)"
...
* **-c și -j la final sunt înlocuite cu k, iar tulpina este tratată apoi ca și cum ar termina în -k**
* **în unele cuvinte (lista la Kielhorn, Gramatică p. 18), -j final este înlocuit cu -ṭ**
* **-ch final este înlocuit cu -ṭ**
* **-ś și -ṣ final sunt, cu unele excepții, înlocuite cu -ṭ. În cazurile excepționale, -ś și -ṣ sunt înlocuite cu -k**
...
* **în mod normal, -h este înlocuit cu -ḍh**
* **dacă rădăcina de bază începe cu d-, atunci -h este înlocuit cu -gh. La fel și pentru alte câteva cuvinte, opțional sau obligatoriu (lista la Kielhorn, Gramatică §80,2)**
* **(la finalul numelui de rădăcină, -h este înlocuit cu -dh)**
...
Explicație: -⟪अभिषेकौ⟫ Nom.Acc.Voc.Dual.masc. (Dualdvandva)
...
⟪४⟫. Comentariul lui ⟪भानुचन्द्र⟫ (sec. al XVI-lea) la secțiunea anterioară a ⟪कादम्बरी⟫ (acest exercițiu ar trebui tradus sub îndrumarea unui profesor. Dacă unul nu este disponibil, se poate omite)
