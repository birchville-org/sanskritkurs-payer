...
Adverbialmente, può essere utilizzato l'Instrumentale:
...
Adverbialgebrauch kann der Ablativ sein:

*   from nouns  
    e.g. ⟪बलात्⟫ "forcibly, with force"
...
Fig.: ⟪क्व⟫
(Image source: [Details](/arc/licenses#lekt3701))
:::
...
can a predicative adverb stand instead of a predicative adjective:
...
In questions about words, one asks about an agent (⟪कर्तृ⟫), an object, an activity, a circumstance, etc., e.g.
...
*   ⟪किम्⟫ (often evokes a negative response)
...
Fig.: ⟪वृक्षः⟫
(Image source: [Details](/arc/licenses#lekt3706))
:::
...
Fig.: ⟪कृष्णः⟫ ⟪बलरामश्च⟫
(Image source: [Details](/arc/licenses#lekt3707))
:::
...
(Image source: [Details](/arc/licenses#lekt3708))
:::
...
(Image source: [Details](/arc/licenses#lekt3709))
:::
...
(Image source: [Details](/arc/licenses#lekt3710))
:::
7\. ⟪उप⟫ "near"
...
(Image source: [Details](/arc/licenses#lekt3711))
:::
8\. ⟪यथा⟫
