...
Примеры для r перед согласными:
...
*   у букв с вертикальной завершающей чертой: / на вертикальной завершающей черте
...
A) Напишите в Devanāgarī и приведите перевод (требуется знание Урока 8):
