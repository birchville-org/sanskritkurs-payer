---
title: Урок 59
subtitle: "Окончания двойственного числа вторичных окончаний и повелительного наклонения (द्विवचनम्)"
lesson_id: 59
...
| :--- | :---: | :---: | :---: | :---: |
|   | вторичные | повелительное наклонение (लोट्) | вторичные тематические | вторичные атематические[[br]]оптивный (विधिलिङ्) | повелительное наклонение (लोट्) |
...
:::grammar-box
**Перед -va и -vahi тематальный гласный -a- заменяется на -ā-.**
...
:::धा 3-е л. ду. ч. «помещать, класть, ставить»
...
:::grammar-box
**siṣ-аорист в P образуют все корни на -ā, -e, -o, -ai, не ограниченные 1., 2. или 3. аористом, а также некоторые другие корни, в т.ч. नम्, यम्, रम्. В Ā все эти корни образуют s-аорист.**

**Образование:**

**Авгмент + ступа корня + s + i + ṣ + атематическое вторичное окончание (как в iṣ-аористе)**
:::Суффикс образования основы + окончания siṣ-аорита звучат так:
...
:::grammar-box
**sa-аорист образуют большинство अनिट्-корней, оканчивающихся на -ś, -ṣ или -h, предпоследним элементом которых является i, u или ṛ. Факультативные अनिट्-корни такой формы образуют по выбору либо sa-аорист, либо iṣ-аорист.**

**Образование:**

**Аугмент + корень в слабой степени + s + a + тематическое окончание вторичного спряжения**

**Формы 1.sg.2.3.du.Ā образуются от s-аорита, то есть атематически.**
:::Суффикс образования основы + окончания sa-аорита звучат следующим образом:
...
**Некоторые корни на -h (गुह्, दिह्, दुह्, लिह्) могут в Ā образовывать формы 2.3.sg.1.du.2.pl. по выбору без -sa-.**
:::Парадигма:
...
A) Переведите следующий текст и определите все встречающиеся в нем глагольные формы.

_Предварительное замечание:_

Следующий текст взят из भट्टिकाव्य («Поэтическое произведение [поэта] Бхатти»). भट्टिकाव्य в 22 песнях повествует историю राम, но одновременно иллюстрирует правила грамматики и поэтики на примерах.
...
4.  Песни 14-22: использование времен и наклонений
...
Рис.: रावणः
(Источник изображения: [Подробности](/ru/licenses#lekt5902))
:::Следующий отрывок является началом 15-й песни, посвященной аористу. रावण, царь демонов, похитивший у राम его жену सीता, посылает за своим братом कुम्भकर्ण («Ухо-горшок»), который за свои злодеяния находится в состоянии своего рода вечного сна.
...
:::_Подсказка к переводу:_ Стих 6: दिदृक्षते \= десидератив от दृश्
...
**lekt5902:** [Источник изображения: Henryart/Wikipedia. Общественное достояние]

**lekt5903:** Танец Кечак, Бали (Индонезия) [Источник изображения: Flying Pharmacist / Wikipedia. [Лицензия Creative Commons](http://creativecommons.org/licenses/by-sa/3.0/) (Attribution, share alike)]
