...
Παραδείγματα για το r πριν από σύμφωνο:
...
* σε γράμματα με κάθετη τελική γραμμή: / στην κάθετη τελική γραμμή

* σε άλλα γράμματα: κάτω στο γράμμα
...
A) Γράψτε στα Δεβαναγkī και δώστε τη μετάφραση
