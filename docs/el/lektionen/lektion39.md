...
## 39.1. Οι προσωπικές καταλήξεις του πρώτου προσώπου (**:sig[⟪तृतीयः⟫]** ⟪पुरुषः⟫ = «**τρίτο** πρόσωπο»)

Οι καταλήξεις της πρώτου προσώπου (**:sig[⟪तृतीयः⟫]** ⟪पुरुषः⟫ = "**τρίτο** πρόσωπο") είναι:
...
:::
1 Σημείωση: στην πραγματικότητα, η πρωτογενής κατάληξη Ā των θεματικών κλίσεων θα έπρεπε να ορίζεται ως -e, πριν από την οποία το θεματικό φωνήεν -a- εξαφανίζεται για λόγους αναλογίας. Ωστόσο, το αποτέλεσμα είναι σαν η κατάληξη -i να προστίθεται στο θεματικό φωνήεν -a-: a + i » e.

## 39.2. Σχηματισμός των ρηματικών τύπων του πρώτου προσώπου των θεματικών ενεστωτικών στελεχών

::: grammar-box
**Κανόνας:**
**Vor -mi, -mas, -ma, -mahe, -mahi wird der Themavokal -a- durch -ā- ersetzt !!!**
:::
### 39.2.1. Πρώτη τάξη ενεστώτα (⟪भ्वादि⟫) <!-- TODO: Fallback translation -->
...
:::
### 39.2.2. Έκτη τάξη ενεστώτα (⟪तुदादि⟫)
...
:::
### 39.2.3. Τέταρτη κλάση ενεστώτα (⟪दिवादि⟫)
...
:::
### 39.2.4. Δέκατη τάξη ενεστώτα (⟪चुरादि⟫) και Αιτιατικά (⟪णिजन्त⟫)
...
:::
### 39.2.5. Παθητική φωνή (Suffix ⟪यक्⟫)
...
:::
## 39.3. Σχηματισμός των ρηματικών τύπων του πρώτου προσώπου του απλού μέλλοντα - ⟪ऌत्⟫

::: grammar-box
**Το μέλλον έχει θεματικό σχηματισμό. Επομένως, ισχύει επίσης ο κανόνας για τους θεματικούς ρίζες:**

**Vor -mi, -mas, -mahe wird der Themavokal -a- durch -ā- ersetzt !!!**
:::
### 39.3.1. Σχηματισμός ⟪अनिट्⟫ <!-- TODO: Fallback translation -->
...
:::
## 39.4. Σχηματισμός των ρηματικών τύπων του πρώτου προσώπου των αθεματικών ενεστωτικών θεμάτων

::: grammar-box
**Σημειώστε ότι εντός της λέξης — σε αντίθεση με τον σύνθετο σάντχι — πριν από καταλήξεις που ξεκινούν με**
* **φωνήεν**
* **ημιφωνικό**
* **δασεία**

**τα σύμφωνα συνήθως παραμένουν αμετάβλητα.**

π.χ. ⟪वच्⟫ 1.sg.Ind.Präs.P **⟪व⟫**⟪च्मि⟫**
:::
### 39.4.1. Δεύτερη τάξη ενεστώτα (⟪अदादि⟫)
...
Εικ.: ⟪सो⟫ ⟪ऽस्मि⟫
(Πηγή εικόνας: [Λεπτομέρειες](/el/licenses#lekt3901))
:::
### 39.4.2. Τρίτη τάξη Ενεστώτα (⟪जुहोत्यादि⟫)
...
:::
### 39.4.3. Πέμπτη τάξη ενεστώτα (⟪स्वादि⟫)

::: grammar-box
**Σε ρίζες που λήγουν σε φωνήεν, μπορεί προαιρετικά να παραλείπεται το -u του επιθέματος σχηματισμού (-nu) πριν από καταλήξεις που ξεκινούν με m-.**
:::
⟪सु⟫ 5U
...
:::
### 39.4.4. Όγδοη τάξη ενεστώτα (⟪तनादि⟫)
...
:::
### 39.4.5. Έβδομη τάξη ενεστώτα (⟪रुधादि⟫)
...
:::
### 39.4.6. Ένατη τάξη ενεστώτα (⟪क्र्यादि⟫)
...
Σχηματίστε για τις ακόλουθες ρηματικές μορφές τις μορφές της πρώτης προσώπου, οι οποίες αντιστοιχούν σε αριθμό, χρόνο, τρόπο (οριστική, υποτακτική) και φωνή/ενέργεια (P, Ā, Παθητική).

Παράδειγμα: ⟪गच्छन्ति⟫ » ⟪गच्छामस्⟫
