...
A) 在单数和复数中（如果不是专有名词），填入直接宾语或方向第四格（宾格）：
...
E) 为所有迄今所学的名词构成单数（dvitīyā）和复数的宾格（Akkusativ）。
...
图：⟪स⟫ ⟪गुरुः⟫ ⟪।⟫ ⟪एनं⟫ ⟪शृण्वन्ति⟫ ⟪॥⟫
(图片来源：[详细信息](/licenses#uebung006))
:::