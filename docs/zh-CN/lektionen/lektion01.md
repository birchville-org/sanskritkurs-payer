...
:::
**基于本土语法学家著作的优秀系统语法，同时也是对帕尼尼的导论：**

> **Kunnappally, John:** Prakriyā bhāshyam : 梵语语法 / 最初用马拉雅拉姆语撰写。由 K.V.R. Pai 翻译成英语。-- Parathode : 自费出版，1983。-- 818页；23厘米。
...
> **语言学词典** / 哈杜莫德·布施曼主编。 -- 第4版，修订并补充书目 / 在哈特穆特·劳弗协助下。 -- 斯图加特 : Kröner, 2008. -- 816页 ; 22厘米。 -- ISBN 978-3-520-45204-7
...
| 音素 | 描述 |
| :--- | :--- |
| **a - ⟪अ⟫** | “短 a”在印度人那里——自古至今——常被发为 ə。在欧洲，人们将其发为短 a，在孟加拉地区则发为短而暗的 o。
| **ṛ - ⟪ऋ⟫** | 类似于捷克语中元音化的 r。带有轻微的 i 尾音。
| **ṝ - ⟪ॠ⟫** | 类似于捷克语中元音化的 r。带有轻微的 u 尾音。
| **jñ - ⟪ज्ञ्⟫** | 也可发为 dny（马拉地语）或 gy（北印度语）。
| **ś - ⟪श्⟫** | sch 音，舌尖向下弯曲。类似于德语“mischen”中的 sch。
| **ṣ - ⟪ष्⟫** | ach 音，舌尖向后卷曲。有时在喉咙后部发音，以至于听起来几乎像 kh。
| **h - ⟪ह्⟫** | 送气音，绝非延长符号。
| **ḥ - :** | **Visarga（Visarjanīya）** -- ⟪विसर्ग⟫ / ⟪विसर्जनीय⟫。无声送气音，带有 preceding 元音或前一个双元音第二部分的尾音：agniḥ -- ⟪अग्निः⟫ = agnihi, devaiḥ -- ⟪देवैः⟫ = devaihi, gauḥ -- ⟪गौः⟫ = gauhu
| **ṃ** | **Anusvara（安努斯瓦拉）** -- ⟪अनुस्वर⟫。在咝音、h、l 之前：元音鼻化。词尾 = m。在辅音前：对应于后续辅音的鼻音：saṃdhi -- ⟪संधि⟫ = sandhi -- ⟪सन्धि⟫
:::
要达到最佳的发音效果，应以相当缓慢且单调的节奏朗读句子、诗句或单词，并精确考虑元音的长度。
