...
印度语法学家也将如 :sig[⟪अकृत⟫]（3.sg.Ā）这样的形式归入 s-不定过去时，尽管它们明确属于词根不定过去时。为此，印度语法学家为 s-不定过去时发明了以下临时音变规则：
...
例如，**:sig[⟪चि⟫]** 5U: 第二人称复数.Ā **:sig[⟪अचेढ्वम्⟫]**
...
倒数第二个音节带有 -ṛ- 的其他词根的不定过去时也可以这样构成：
