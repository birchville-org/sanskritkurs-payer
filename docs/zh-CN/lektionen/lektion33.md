...
* 重音过去式，
* 频繁体，以及
* 通过重叠方式构成。在重叠形式中，置于词根之前的部分称为重叠音节。
* 重叠音节由（一个辅音和）一个元音组成。
...
* **低阶**
  * **辅音前：-i-**  
    例如，**:sig[⟪धा⟫]** 过去分词：**:sig[⟪हित⟫]** (hi-ta)
  * **元音前：Ø**  
    例如，**:sig[⟪धा⟫]** 第三人称复数直陈式现在时 **⟪दधति⟫** (dadh-ati)
* **高阶：-ā-**  
  例如，**:sig[⟪धा⟫]** 第三人称单数直陈式现在时 **:sig[⟪दधाति⟫]**
:::
例如还包括：
...
::: grammar-box
**词根以 -ā 结尾（⟪दा⟫ 和 :sig[⟪धा⟫] 除外）**，在弱式词干中通常以 -ī- 结尾**（参见 Thumb-Hauschild 第 1 卷第 1 部分第 271 页。推测此处以上述提到的 B 类元音交替为范本，尽管这些词根通常遵循 A 类交替）；**在元音词尾前，词根元音完全消失（参见 A 类元音交替）。**
:::
示例：
...
| **虚拟式** | ⟪जह्यात्⟫:brjah-yā-t:br(Die Wurzel ⟪हा⟫ hat vor dem Optativ-yā/y die gleiche Form wie vor Vokalen!) | ⟪जह्युर्⟫:brjah-y-ur |
:::
### 33.4.1. 词根 **⟪दा⟫** 和 **:sig[⟪धा⟫]**

::: grammar-box
**词根 ⟪दा⟫ 和 :sig[⟪धा⟫] 以元音 -a- 进行重音，并在弱词干中失去词根元音。**

**注意 :sig[⟪धा⟫] 中的送气同位异化规则！**
:::
::: grammar-box
**:sig[⟪धा⟫]** 3U “放置，确定，分配”
...
| :--- | :--- | :--- | :--- | :--- |
| **现在时直陈式** | ⟪दधाति⟫ | ⟪दधति⟫:brdadh-ati | ⟪धत्ते⟫:brdadh-te:br(Erklärung: Thumb-Hauschild 1,1 S. 302f.) | ⟪दधते⟫:brdadh-ate |
| **未完成时** | ⟪अदधात्⟫ | ⟪अदधुर्⟫ | ⟪अधत्त⟫:bra + dadh + ta | ⟪अदधत⟫ |
| **虚拟式** | ⟪दध्यात्⟫:brdadh-yā-t | ⟪दध्युर्⟫ | ⟪दधीत⟫:brdadh-ī-ta | ⟪दधीरन्⟫ |
:::
**⟪दा⟫** 的形式是通过在 **:sig[⟪धा⟫]** 的变位表中将 **dh** 替换为 **d** 得到的。即：
...
**不定式** **:sig[⟪धातुम्⟫]**
:::
**:sig[⟪धा⟫]** + **⟪सम्⟫** + **⟪आ⟫** 第三变位 **⟪समादधाति⟫**：将全部注意力集中于某事，集中精神
...
::: indent
注意：
第三人称复数现在时主动态 **:sig[⟪पिपुरति⟫]**  
第三人称单数未完成时主动态 **:sig[⟪अपिपर्⟫]** （源自：\*apipart）  
第三人称复数未完成时主动态 **:sig[⟪अपिपरुर्⟫]**  
第三人称单数祈愿语态主动态 **:sig[⟪पिपूर्यात्⟫]**
