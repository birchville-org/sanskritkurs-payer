...
| 代词 | 性 | 单数工具格 | 复数工具格 |
| :--- | :--- | :--- | :--- |
| **tad** :br"er, sie, es; der, die, das" (Erwähnte):br⟪तद्⟫ | 阳/中 | **tena** :br⟪तेन⟫ | **tais** :br⟪तैस्⟫ |
| | 阴 | **tayā** :br⟪तया⟫ | **tābhis** :br⟪ताभिस्⟫ |
| **etad** :br"dieser, diese, dieses" (dem Sprechenden sehr Nahe):br⟪एतद्⟫ | 阳/中 | **etena / enena** :br⟪एतेन⟫ / ⟪एनेन⟫ | **etais** :br⟪एतैस्⟫ |
| | 阴 | **etayā / enayā** :br⟪एतया⟫ / ⟪एनया⟫ | **etābhis** :br⟪एताभिस्⟫ |
| **idam** :br"dieser, diese, dieses" (Nahe):br⟪इदम्⟫ | 阳/中 | **anena / enena** :br⟪अनेन⟫ / ⟪एनेन⟫ | **ebhis** :br⟪एभिस्⟫ |
