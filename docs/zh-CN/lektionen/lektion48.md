...
| **3. Person** :br⟪प्रथमः⟫ | \-tu:br\-tāt¹ | \-tām | \-antu:br **第三类：-atu** :br(省略形式 -\*ntu) | \-atām:br(省略形式: -\*ntām) |
:::
...
:::
解释：  
:sig[⟪द्वयोर्हि⟫] :sig[⟪कुलयोः⟫]：属格（⟪षष्ठी⟫）双数形式，对应⟪द्वे⟫ ⟪कुले�“两个家庭”
