...
Znaki samogłoskowe na początku słowa, jeśli słowo nie jest połączone w zapisie z poprzednim słowem:
...
Jeśli w słowie lub zdaniu dwie lub więcej spółgłosek występują bezpośrednio po sobie, zapisuje się je za pomocą ligatury (znaku połączonego).

1. Jeśli pierwszy ze łączonych znaków spółgłoskowych kończy się pionową kreską po prawej stronie, traci tę kreskę i umieszcza się go przed drugim spółgłosem.

Wyjątek: jeśli drugą łączoną spółgłoską jest ⟪न्⟫ lub ⟪ल्⟫, umieszcza się ją pod pierwszą spółgłoską, tracąc poziomą kreskę. W zależności od krój pisma istnieją dalsze wyjątki, wymienione poniżej. Jeśli w danym kroju pisma ligatura nie jest przewidziana, stosuje się znak virāma.

Przykłady:

W kroju pisma używanym w tym skrypcie:
...
Zwróć uwagę na zapis jña:

![](/images/schrift017.webp)

Początkowe -a, które zgodnie z zasadami sandhi zdania ulega elizji (-as + a- » -o ' ), jest oznaczane za pomocą tzw. avagraha:
...
A) Napisz wszystkie ligatury występujące w powyższej liście

B) Napisz i przetłumacz:
...
D) Przeczytaj, transliteruj i przetłumacz:
