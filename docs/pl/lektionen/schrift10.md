...
### Druga regula tworzenia ligatur spółgłosek

\[Pierwsza regula zob. w [Ćwiczeniu pisma 8](schrift08.md)\]

Jeśli pierwsza ze spółgłosek do połączenia nie kończy się pionową kreską, następującą spółgłoskę umieszcza się pod pierwszą spółgłosek, tracąc jej poziomą kreskę.

Wyjątki: Jeśli ⟪म्⟫ lub ⟪य्⟫ są drugim członem ligatury, zapisuje się je skrócone za pierwszym znakiem:
...
Przykłady (wyjątki są podkreślone):
...
Napisz wszystkie powyżej wymienione ligatury

### Spis najczęściej występujących ligatur w czcionce gramatyki Kielhorna
