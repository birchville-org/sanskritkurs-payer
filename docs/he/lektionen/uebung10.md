...
א) צרו את הצורת הסביל לצורות הפועל הבאות (עם תרגום של צורת הפועל), כלומר, הצורת הסביל, המתאימה לצורת הפועל באיש ובמספר:
...
9. pāśyati ⟪पश्यति⟫ (הסביל נבנה מ-dṛש!) : dṛśyate ⟪दृश्यते⟫
...
22. tanvanti ⟪तन्वन्ति⟫ (2 צורות!) : tanyante / tāyante ⟪तन्यन्ते⟫ ⟪तायन्ते⟫

ב) צרו את הכלי היחיד והרבים לכל השמות שלמדנו עד כה

ג) המירו את המשפטים הבאים לסביל ותרגמו אותם:
...
וישיות / נשים וישיות הולכות לכפר זה.
...
6\. העין מובילה. (מבנה פסיבי) (עין ואוזן בדרך כלל משתמשים בשני)
...
8\. מי (נקבה) שומרת על הילדה? (מבנה פסיבי)

kayā bālā rakṣyate.

⟪कया⟫ ⟪बाला⟫ ⟪रक्ष्यते⟫ ⟪।⟫

9\. הברמנים משבח את האדון עם קורבן. (מבנה פסיבי, ללא השימוש במילה yajña)

kṣatriyeṇeśvara ijyate.

⟪क्षत्रियेनेश्वर⟫ ⟪इज्यते⟫ ⟪।⟫

10\. באמצעות נדיבות, תלמיד של בודהה זוכה לשמים.
...
הם תמיד מזכירים לעצמם את האלים.
...
בארץ מאירים קדושים באמצעות שלווה.
