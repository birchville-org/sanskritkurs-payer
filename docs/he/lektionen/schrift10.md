...
### הכלל השני ליצירת צרופי עיצורים

[ראשון ראה ב[תרגיל כתיבה 8](schrift08.md)]

אם האות הראשונה בקבוצה אינה מסתיימת בקו אנכי, אזי האות הבאה תיכתב מתחת לאות הראשונה, תוך ויתור על הקו האופקי שלה.

חריגים: אם ⟪म्⟫ או ⟪य्⟫ הם הרכיב השני בצירוף, הם ייכתבו מקוצרים אחרי האות הראשונה:
...
דוגמאות (החריגים מסומנים בקו תחתון):
...
כתוב את כל הצרופים המופיעים לעיל

### רשימת הצרופים הנפוצים ביותר בפונט של דקדוקו של קילהורן
