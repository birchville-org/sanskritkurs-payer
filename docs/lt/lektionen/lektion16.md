---
title: "Pamoka 16"
subtitle: "Apie sandhį išsakančių priebalsių"
lesson_id: 16
...
## 16.1. Apie galūnių priebalsių sandhį

Sudėtinio žodžio (kompozito) formavimui, kurio pirmoji dalis yra priebalsine galūne besibaigiantis kamienas, reikia šių taisyklių:

Galūnėje esantys gretiniai, retrofleksiniai, dantiniai ir lūpiniai priebalsiai (t. y. ne nosiniai ir ne palataliniai).

::: no-header

|   |   |
| :--- | :--- |
| **Pauzėje ir prieš balsius** | **Jų atitikmenimis pakeičiami neaspiruoti priebalsiai:** :br **pvz.** :br :indent -g + p- » -kp- :br :indent -d + ph- » -tph- :br :indent -dh + p- » -tp- |
| **Prieš priebalsius** | **Jų atitikmenimis pakeičiami neaspiruoti priebalsiai:** :br **pvz.** :br :indent -t + g- » -dg- :br :indent -k + b- » -gb- :br :indent -dh + d- » -dd- :br :indent -k + a- » -ga- |
| **Prieš nosinius** | **Jų atitikmenimis pakeičiami nosiniai:** :br **pvz.** :br :indent -t + n- » -nn- :br :indent -p + n- » -mn- |

:::
Išimtis iš aukščiau pateiktos taisyklės:

Galūnėje esantis dantinis priebalsis (ne nosinis):

::: no-header

|   |   |
| :--- | :--- |
| **Prieš palatalinius** | **Jų atitikmenimis pakeičiami neaspiruoti palataliniai:** :br **t. y.** :br :indent -t + c- » -cc- :br :indent -d + c- » -cc- :br :indent -th + c- » -cc- :br :indent -dh + c- » -cc- :br :indent -t/-th/-d/-dh + ch- » -cch- :br :indent -t/-th/-d/-dh + j- » -jj- :br :indent -t/-th/-d/-dh + jh- » -jjh- |
| **+ ś** | **» -cś- arba -cch-** |
| **Prieš retrofleksinius** | **Jų atitikmenimis pakeičiami neaspiruoti retrofleksiniai:** :br **t. y.** :br :indent -t/-th/-d/-dh + ṭ(h)- » -ṭṭ(h)- :br :indent -t/-th/-d/-dh + ḍ(h)- » -ḍḍ(h)- |
| **Prieš l-** | **Jų atitikmenimis pakeičiami -l:** :br **t. y.** :br :indent -t/-th/-d/-dh + l- » -ll- |
...
(Image source: [Details](/lt/licenses#lekt1604))
:::
...
A) Sudarykite visus iki šiol išmoktus linksnius pateiktoms žodžių formoms kaip iki šiol išmoktų declinacijos klasių pavyzdžius.

Tam naudokite šią schemą, kuri atitinka indų gramatikų vartojamą linksnių tvarką ir kurią dėl savo — vėliau aptariamų — privalumų perėmė ir vakarų gramatikai:

| Vienaskaita:br⟪एकवचनम्⟫ | Daugiskaita:br⟪बहुवचनम्⟫ |
| :--- | :--- |
| **⟪१⟫. ⟪प्रथमा⟫** :brVardininkas | **⟪१⟫. ⟪प्रथमा⟫** |
| **⟪२⟫. ⟪द्वितीया⟫** :brKaltininkas | **⟪२⟫. ⟪द्वितीया⟫** |
| **⟪३⟫. ⟪तृतीया⟫** :brĮnagininkas | **⟪३⟫. ⟪तृतीया⟫** |
| **⟪६⟫. ⟪षष्ठी⟫** :brGimininkas | **⟪६⟫. ⟪षष्ठी⟫** |

Išmokite declinacijos modelius pagal šiuos pavyzdžius!!!
...
B) Išverkite ir išskirkite visus sanskrito sandaugas:
