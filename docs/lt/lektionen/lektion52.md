...
## 52.1. Neutrum der Stämme auf -i und -u <!-- TODO: Fallback translation -->
...
:::
## 52.2. Nominalbildung <!-- TODO: Fallback translation -->

### 52.2.1. PPP + -vant: Partizip der Vergangenheit Parasmaipada <!-- TODO: Fallback translation -->
...
:::
### 52.2.2. ⟪तद्धित⟫-Suffix -maya / -mayī <!-- TODO: Fallback translation -->
...
:::
### 52.2.3. ⟪तद्धित⟫-Suffix -eya <!-- TODO: Fallback translation -->
...
:::
## 52.3. Adverbialbildung: Adverbialsuffix -śas <!-- TODO: Fallback translation -->
...
:::
## 52.4. Verbalkomposita, die ausdrücken, dass etwas zu etwas wird oder gemacht wird, was es vorher nicht ist (⟪अभुततद्भावः⟫) <!-- TODO: Fallback translation -->
...
**Der Auslaut des Nomens wird folgendermassen behandelt:** <!-- TODO: Fallback translation -->
...
:::
::: indent
⟪भस्मसात्कृ⟫:sig[⟪त्वा⟫] <!-- TODO: Fallback translation -->
:::
## 52.5. Wortwiederholungen (⟪द्विरुक्तम्⟫) <!-- TODO: Fallback translation -->
...
## 52.6. Das Zahlwort (⟪सम्ख्या⟫ f.) <!-- TODO: Fallback translation -->
...
:::
### 52.6.2. Ordinalzahlen <!-- TODO: Fallback translation -->
...
:::
### 52.6.4. Zahladjektive <!-- TODO: Fallback translation -->
...
### 52.6.5. Komposita mit Kardinalzahlen im Vorderglied <!-- TODO: Fallback translation -->

::: grammar-box
**⟪बहुव्रीहि⟫ dieser Art werden ganz regelmässig gebildet.** <!-- TODO: Fallback translation -->
:::
Beispiel: <!-- TODO: Fallback translation -->
...
:::
Daher darf z.B. aus ⟪उत्तरा⟫ ⟪वृक्षाः⟫ "nördliche Bäume" oder ⟪पञ्च⟫ ⟪ब्राह्मणः⟫ kein Tatpuruṣa gebildet werden. Aus ⟪सप्तन्⟫ und ⟪ऋषि⟫ kann aber der Tatpuruṣa ⟪सप्तर्षि⟫ m. "die sieben Ṛṣis" gebildet werden, wenn dies als Name für das Sternbild des Grossen Bären (Ursa maior) steht. <!-- TODO: Fallback translation -->
::: media
![](/images/lekt5206.jpg)
Abb.: ⟪सप्तर्षयः⟫
...
2.  das so gebildete Kompositum in einer Bedeutung gebraucht wird, die sonst durch ein Taddhita-Suffix bezeichnet wird (bei dieser Art ist der Übergang zum Bahuvrīhi fliessend):   <!-- TODO: Fallback translation -->
    Beispiele:  
...
**Tatpuruṣa, die nach dieser Regel gebildet werden heissen Dvigu (:sig[⟪द्विगु⟫]).** <!-- TODO: Fallback translation -->
...
:::
## 52.7. Wortliste <!-- TODO: Fallback translation -->
...
:::
⟪वृज्⟫ 7P ⟪वृणक्ति⟫ 1P ⟪वर्जति⟫ : wenden, drehen ; abwehren, ausschliessen <!-- TODO: Fallback translation -->
...
:::
## 52.8. Übersetzungsübung <!-- TODO: Fallback translation -->
...
⟪सर्वमात्मवशं⟫ ⟪सुखम्⟫ ⟪।⟫
⟪एतद्विद्यात्समासेन⟫
⟪लक्षणं⟫ ⟪सुखदुःख⟫:sig[⟪योः⟫] ⟪॥१६०॥⟫ <!-- TODO: Fallback translation -->
...
:::
## 52.9. Aufgaben während der Semesterferien <!-- TODO: Fallback translation -->
...
**lekt5206:** Das Siebengestirn = die sieben hellsten Sterne des Grossen Bären (Ursa maior) [Bildquelle: Wikipedia, GNU FDLicense] <!-- TODO: Fallback translation -->
