...
::: grammar-box
In the passive sentence, the agent (**kartṛ**) is in the **instrumental case** (tṛtīyā f. "third case ending"), and the direct object (**karman** n.) is in the **nominative case** (prathamā f.).
...
::: grammar-box
**Even if the corresponding active sentence would contain an accusative (dvitīyā) of the goal, this can be put into the nominative case (prathamā) in the passive sentence:**
...
**praviśyatām** = ⟪प्रविश्यताम्⟫ = "May one enter = Please come in = Come in!"
**niṣadyatām** = ⟪निषद्यताम्⟫ = "May one sit down = Please take a seat = Have a seat"
:::
Sanskrit passive constructions are extremely common: the passive is, after all, easier to form than numerous present stems.

::: important
**Sanskrit passive sentences should generally not be rendered in German using a passive sentence, as the German passive serves a completely different stylistic function.**
:::
...
| | Instrumental Singular | Instrumental Plural |
| :--- | :--- | :--- |
| **Masculine nouns ending in -a**:brdeva:br⟪देव⟫ | **devena** :br⟪देवेन⟫ | **devais** :br⟪देवैस्⟫ |
| **Neuter nouns ending in -a**:brphala:br⟪फल⟫ | **phalena** :br⟪फलेन⟫ | **phalais** :br⟪फलैस्⟫ |
...
| **etad** :br"this (very close to the speaker)":br⟪एतद्⟫ | M/N | **etena / enena** :br⟪एतेन⟫ / ⟪एनेन⟫ | **etais** :br⟪एतैस्⟫ |
| | F | **etayā / enayā** :br⟪एतया⟫ / ⟪एनया⟫ | **etābhis** :br⟪एताभिस्⟫ |
| **idam** :br"this (near)":br⟪इदम्⟫ | M/N | **anena / enena** :br⟪अनेन⟫ / ⟪एनेन⟫ | **ebhis** :br⟪एभिस्⟫ |
...
2. **to indicate the means or instrument by which something is accomplished**
3. **to indicate the path along which someone reaches a destination**
4. **to express connection, union, or accompaniment with**
5. **with postpositions meaning "together with, with"; e.g., saha = ⟪सह⟫ = "with"** :brz.B.:br **brāhmaṇena saha** = ⟪ब्राह्मणेन सह⟫ = "together with the Brahmin"
:::
...
**Note that for verbs of the 4th present class, the Ātmanepada and the Passive have identical forms! Whether Ātmanepada or Passive is present can only be inferred from the sentence construction in this case.**



### 10.4.1. Special rules for the formation of the Passive
...
4. **Guna grade of verbs beginning with ya, va, ra, or where these sounds follow another consonant (Samprasāraṇa = ⟪सम्प्रसारण⟫):**

| Root:br⟪धातु⟫ | Guna grade:br⟪सम्प्रसारण⟫ | Passive:br⟪यक्⟫ |
| :--- | :--- | :--- |
...
The traditional indigenous designation for this formation of the Guna grade in verbs with **ya** or **va** is **Samprasāraṇa** (⟪नपुंसकम्⟫ = ⟪सम्प्रसारण⟫).
...
* a **-an-ya** formation
* a **-ā-ya-** formation (the long **ā** represents a hypothetical long nasal)
...
**puṇya** n. ⟪पुण्य⟫ : good deed, merit
  ...
  ::: note-box
  That by which one earns well-being and good rebirths.
  :::
...
1. A Brāhmaṇa goes to the village with a Vaiśya.
2. He venerates Viṣṇu with a sacrifice. (Express "sacrifice" as **yajña**!)
3. The Veda is called śruti. (**vad**)
4. One sets up the warp of a loom. (2 possibilities)
...
:::
5. The teachers ask questions. (Passive construction)
...
10. Through generosity a follower of Buddha attains heaven.
...
**śānti** f. ⟪शान्ति⟫ : cessation, peace, calm
