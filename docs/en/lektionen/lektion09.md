...
A final vowel of the root as well as **-a-** in the penultimate position of the root are replaced by their strengthened grade (**vṛddhi**) (there are some exceptions), the other vowels are replaced by their middle grade (**guṇa**).
:::
**Examples:**

| Root:br⟪धातु⟫ | + -aka / -ikā (kṛt) | Meaning |
| :--- | :--- | :--- |
| **kṛ** :br8 U:br⟪कृ⟫:br"to do" | **kāraka** :br(⟪कारक⟫) | "agent, doer" |
...
| **yaj** :br1 U:br⟪यज्⟫:br"to sacrifice" | **yājaka** m.:br(⟪याजक⟫) | "sacrificer, priest" |
| **nṛt** :br4 P:br⟪नृत्⟫:br"to dance" | **nartaka** m.:br(⟪नर्तक⟫) /:br **nartakī** f.:br(⟪नर्तकी⟫) | "dancer / danceress" |
| **ji** :br1 P:br⟪जि⟫:br"to conquer" | **jayaka** 3:br(⟪जयक⟫) | "victorious" |

::: grammar-box
**Some of these formations have the narrower meaning: "one who habitually or as a duty, or well, performs that expressed by the root".**
:::
...
In addition, there are some less important uses of the suffix **-aka**. Cf. Wackernagel, Altindische Grammatik, II, §45ff.
