...
Example:
> **kṣatriyā nagaraṃ gatā** = ⟪क्षत्रिया नगरं गता⟫ = „The Kṣatriya woman has gone to the city.“
:::

### 12.1.3. Schema II for intransitive verbs and verbs of motion

::: grammar-box
**Agent (kartṛ) in the Instrumental case (tṛtīyā) -- PPP in the Nominative Singular Neuter**

Example:
> **kṣatriyeṇa (nagaraṃ) gatam** = ⟪क्षत्रियेण⟫ (⟪नगरं⟫) ⟪गतम्⟫ = „(By the Kṣatriya, (to the city) has been gone) = The Kṣatriya has (gone to the city).“
...
Thus, while the so-called „Participle Perfect Passive“ for transitive verbs primarily has a passive meaning (**āpta** = „reached (been reached)“) and for intransitive verbs and verbs of motion an active meaning (**gata** = „gone“), there are some verbs for which the PPP can have both active and passive meaning:

e.g.
**gata** = ⟪गत⟫ = „gone“ (active); but also: **gato mārgaḥ** = ⟪गतो मार्गः⟫ = „a gone path“ (passive)
**āpta** = ⟪आप्त⟫ = „reached (been reached)“ (passive), „having reached“ (active)


## 12.3. Formation of the PPP

::: grammar-box
The following formation methods occur (for each root, its PPP must be learned!):
...
In *aniṭ* formations, the following laws of sound combination in the word must be observed. **These laws are very important for understanding the entire Sanskrit morphology.**
...
**muc** 6 U (muñcati), PPP **mukta** ⟪मुच् मुञ्चति मुक्त⟫ : to release, to let go, to liberate; from the cycle of rebirths (**saṃsāra** m.) to liberate = to redeem
...
**sic** + **abhi-**: **abhiṣeka** m. ⟪अभिषेक⟫ : sprinkling of a king at the royal consecration, royal consecration
...
| Root:br⟪धातु⟫ | Passive Pres. 3rd sg. Indic.:br⟪यक् लट्⟫ | PPP:br⟪क्त⟫ |
| :--- | :--- | :--- |
