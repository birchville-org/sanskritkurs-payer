...
## 12.2. On the meaning of the PPP

Thus, while the so-called "Perfect Passive Participle" for transitive verbs has primarily passive meaning (**āpta** = "reached (been)") and for intransitive verbs and verbs of motion active meaning (**gata** = "gone"), there are some verbs for which the PPP can have both active and passive meaning:
...
::: grammar-box
The following forms of formation occur (for each root, its PPP must be learned!):
...
::: grammar-box
Without a connecting vowel, the PPP is generally formed from roots ending in a vowel as well as from many other roots, without there being a fixed rule for this, regarding at which structured roots the connecting vowel occurs or does not.
...
## 12.4. Laws of phonetic combination in the word

In *aniṭ* formations, the following laws of phonetic combination in the word must be observed. **These laws are very important for the understanding of the entire Sanskrit morphology.**
...
| **6. Voiced aspirated stop + voiceless stop » voiced unaspirated stop + voiced aspirated stop (Bartholomae’s Aspirate Law):** | **bh-t » b-dh:** :br **labh + ta » lab-dha** = ⟪लब्ध⟫ :br **dh-t » d-dh:** :br **budh + ta » bud-dha** = ⟪बुद्ध⟫ :br **yudh + ta » yud-dha** = ⟪युद्ध⟫ :br **krudh + ta » krud-dha** = ⟪क्रुद्ध⟫ |
| **7. h-t wird replaced by ḍh with lengthening of a preceding i or u; or by gdh. Before such a ḍh, a is replaced by o, rarely by ā:** | **dah + ta » dag-dha** = ⟪दग्ध⟫ :br **guh + ta » gūḍha** = ⟪गूढ⟫ (guh 1 (gūhati) „etwas verbergen”):br **muh + ta » mug-dha / mūḍha** = **⟪मुग्ध⟫ / ⟪मूढ⟫** :br **sah + ta » soḍha** = ⟪सोढ⟫ |
:::
...
Some roots are counted by indigenous grammarians among the 6th conjugation class, which form the present stem with nasal infix and thematic vowel a, e.g.:

- **muc** 6 U (muñcati), PPP **mukta** ⟪मुच्⟫ ⟪मुञ्चति⟫ ⟪मुक्त⟫ : to unfasten, to release, to liberate; to liberate from the cycle of rebirths (**saṃsāra** m.) = to save
...
| Root:br⟪धातु⟫ | Passiv Present 3. sg. Indikativ:br⟪यक्⟫ ⟪लट्⟫ | PPP:br⟪क्त⟫ |
| :--- | :--- | :--- |
...
**A) Form passive sentences in the past tense from the active sentences of [Lesson 7](/lektionen/lektion07), Exercise A, using past tense active sentences for intransitive verbs and verbs of motion.**

**B) Form the corresponding PPPs from the verb forms of [Lesson 10](/lektionen/lektion10), Exercise A. Note that a form like sṛjati corresponds to PPPs in all three genders.**
