...
:::
If the verb is in Parasmaipada or Ātmanepada, then the direct object (**karman** n. = ⟪कर्मन्⟫) is generally in the **accusative** (Wenfall, dvitīyā f. = ⟪द्वितीया⟫).


## 7.2. The accusative (Wenfall, dvitīyā f. = ⟪द्वितीया⟫ = "second case ending")
...
:::
The forms **enam** (⟪एनम्⟫) etc. belong to the stem **enad** (⟪एनद्⟫), which forms inflections only in some cases. These are used instead of the forms of **etad** and **idam** when what is designated has already been mentioned in the preceding context.
e.g. **ayaṃ devaḥ, enaṃ yajante.** = ⟪अयं देवः⟫ | ⟪एनं यजन्ते⟫ || : "He is a god. They sacrifice to him."


### 7.2.2. Usage of the Accusative (Wenfall, dvitīyā f. = ⟪द्वितीया⟫ = "second case ending")
...
e.g.
**devaṃ yajati** = ⟪देवं यजति⟫ : "He worships a god with an offering."
**phalam āpnoti** = ⟪फलमाप्नोति⟫ : "He obtains the fruit (e.g. of his action)."
2. With verbs that express going, movement, leading or similar towards something, the accusative denotes the goal of the movement:
e.g.
...
**gurūn + śṛṇoti** » **gurūñ chṛṇoti** (besides gurūñ śṛṇoti) = ⟪गुरूञ्छृणोति⟫ (⟪गुरूञ्शृणोति⟫) : "He hears the teachers." "He listens to the teachers."

2. If preceded by an initial **l-**, it is replaced by **-l** with Anunāsika (nasalized l, in writing ⟪ल्⟫ with Anunāsika ⟪ँ⟫):
e.g. **paśūn + labhate** » ⟪पशूंल्लभते⟫ : "He obtains livestock."

3. If preceded by an initial voiceless palatal, retroflex, or dental consonant, it is replaced by **Anusvāra** + the corresponding sibilant sound:
**-n** before **c-, ch-** » **-ṃś**
**-n** before **ṭ-, ṭh-** » **-ṃṣ**
**-n** before **t-, th-** » **-ṃs**
...
e.g. **phala** n. = ⟪फल⟫ = "fruit": Nom./Akk. sg. **phalam** = ⟪फलम्⟫
**Ending Nominative / Accusative Plural: -āni**
e.g. **phala** n. = ⟪फल⟫: Nom./Akk. pl. **phalāni** = ⟪फलानि⟫
:::

## 7.5. Athemeatic Present Classes

The 5th present class forms a so-called athematic present stem, i.e., the present stem does not end in the "thematic vowel" **-a** as it does in thematic present classes (1st, 4th, 6th, and 10th class).
...
4. The Kṣatriyas honor the goddesses with sacrifices as sacrifice-lords.
5. Vaiśya women honor deities with sacrifices.
6. The LORD is angry.
