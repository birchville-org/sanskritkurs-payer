...
- The verbal sentence with direct object
...
e.g.
- **rāmaḥ phalaṃ khādati** = ⟪रामः⟫ ⟪फलं⟫ ⟪खादति⟫ : "Rāma eats (consumes) a fruit."
- **brāhmaṇo devaṃ yajati** = ⟪ब्राह्मणो⟫ ⟪देवं⟫ ⟪यजति⟫ : "The Brahman worships a god with a sacrifice (for someone else)."
:::
If the verb is in the Parasmaipada or Ātmanepada, then the direct object (**karman** n. = ⟪कर्मन्⟫) is generally in the **accusative** (accusative case, dvitīyā f. = ⟪द्वितीया⟫).
...
:::
::: grammar-box
**Accusative plural masculine of stems ending in a vowel (exception: monosyllabic root stems with long vowel): lengthening of the final vowel + -n**
...
:::
::: grammar-box
**Accusative plural feminine of stems ending in a vowel (exception: monosyllabic root stems with long vowel): lengthening of the final vowel + -s**
...
:::
The forms **enam** (⟪एनम्⟫) etc. belong to the stem **enad** (⟪एनद्⟫), which forms cases only in some inflections. These are used instead of the forms of **etad** and **idam** when the thing referred to has already been mentioned in the preceding context.
...
2. With verbs expressing going, movement, leading, or similar, the accusative denotes the goal of the movement:
   e.g.
...
1. Before voiced palatal and retroflex sparśa and before **ś-**, it is replaced by the nasal corresponding to these sounds:
   ...
   **gurūn + śṛṇoti** » **gurūñ chṛṇoti** (alternatively gurūñ śṛṇoti) = ⟪गुरूञ्छृणोति⟫ (⟪गुरूञ्शृणोति⟫) : "He hears the teachers." "He listens to the teachers."
...
The 5th present class forms a so-called athematic present stem, i.e., the present stem does not end in the "thematic vowel" **-a** as in the thematic present classes (1st, 4th, 6th, 10th class).
...
::: grammar-box
- **Strong stem**: (usually) zero-grade root (as stated) + **-no-**
- **Weak stem**: (usually) zero-grade root (as stated) + **-nu-**

**Before vocalic endings, in roots ending in a vowel, -nu- is replaced by -nv-, and in roots ending in a consonant, -nu- is replaced by -nuv- before vocalic endings.**
:::
**Examples:**

| Root:br⟪धातु⟫ | Starker Stem | Schwacher Stem | Before Vowel:br(weak) |
| :--- | :--- | :--- | :--- |
...
- **āp** 5 P (āpnoti) ⟪आप्⟫ ⟪आप्नोति⟫ : to reach, to obtain
...
Fig.: Was war das die vedische Somapflanze?: Fliegenpilz: *Amanita muscaria* (L.) Lam.
(Image source: [Details](/en/licenses#lekt0701))
:::
- **phala** n. ⟪फल⟫ : fruit (also in the figurative sense: (karmic) fruit of an action)
- **nṛtya** n. ⟪नृत्य⟫ : dance
...
- **gam** 1 P (gacchati) ⟪गम्⟫ ⟪गच्छति⟫ : to go (According to the indigenous verb classification, it belongs to Present class 1, but is in reality a formation with a present stem formation suffix **-ccha-**: **gam** » Middle grade (**gm** ») **ga-ccha-ti**)
...
**C) Insert agent, object, and verb in the plural in exercise sentences B).**

**D) Insert into Ātmanepada:**
...
Fig.: To which god is one sacrificing here? Answer: Gaṇeśa (Gaṇapati) = ⟪गणेश⟫ (⟪गणपति⟫). Gaṇapatihoma (yajña).
