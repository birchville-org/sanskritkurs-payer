...
**2. When the causative of transitive verbs is used reflexively ("to show oneself", "to be heard", etc.), or when the object of the simple verb is the agent (⟪कर्तृ⟫) of the causative:**
...
⟪पुनर्⟫ Indeclinable: again, repeatedly, back, once more; however, but (before voiced sounds except r-: ⟪पुनर्⟫)
...
## 29.4. Futureee and Causative of the roots learned so far

::: grammar-box

| Root:br⟪धातु⟫ | Future:br⟪ऌत्⟫ | Kausativ:br⟪कारित⟫ |
| :--- | :--- | :--- |
...
**lekt2901:** ⟪रोहू⟫ ⟪मछली⟫ = Labeo rohita Hamilton [Image source: Khalid Mahmood / Wikipedia. GNU FDLicense]
