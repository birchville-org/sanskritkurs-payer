...
You with the hanging belly, you sweet-toothed one,
...
:::
Modern dictionaries of Sanskrit are arranged in the order of this classification. This classification and the order of the sounds are essential for understanding Sanskrit grammar and therefore must be memorized:
...
| **ṛ - ⟪ऋ⟫** | like Czech vocalized r. Light echo of i. |
| **ṝ - ⟪ॠ⟫** | like Bohemian vocalized r. Lighter resonance of u. |
| **jñ - ⟪ज्ञ्⟫** | also like dny (Marāṭhī) or gy (North Indian). |
| **ś - ⟪श्⟫** | sch-sound with tongue tip bent downward. Similar to sch in "mischen". |
| **ṣ - ⟪ष्⟫** | ach-sound with tongue tip curled back. Often articulated so far back in the throat that it sounds almost like kh. |
| **h - ⟪ह्⟫** | Aspiration sound, never a lengthening mark. |
| **ḥ - :** | **Visarga (Visarjanīya)** -- ⟪विसर्ग⟫ / ⟪विसर्जनीय⟫. Voiceless aspiration with resonance of the preceding vowel or the second part of the preceding diphthong: agniḥ -- ⟪अग्निः⟫ = agnihi, devaiḥ -- ⟪देवैः⟫ = devaihi, gauḥ -- ⟪गौः⟫ = gauhu |
| **ṃ** | **Anusvara** -- ⟪अनुस्वर⟫. Before sibilants, h, l: nasalization of the vowel. Word-finally = m. Word-internally before consonants: the nasal corresponding to the following consonant: saṃdhi -- ⟪संधि⟫ = sandhi -- ⟪सन्धि⟫ |
:::
The best pronunciation is achieved by reading the sentences, verses, or words quite slowly and monotonously, with exact consideration of the length of the vowels.
