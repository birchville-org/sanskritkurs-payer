...
No fixed rules can be established for the distribution of PPPs in -ta- versus -na-. However:

::: grammar-box

Almost all roots ending in -d form the PPP with -na-. In this case, -d-n- is replaced by -n-n-, which does not otherwise occur in word sandhi, but rather constitutes an imitation of sentence sandhi.
...
**1. The PPP of verbs meaning "to think", "to wish", "to know", "to be acquainted with", "to revere" as well as some other verbs marked by ñi in the Dhātupāṭha, the root list of Pāṇini, does not only have a past tense meaning but can also be used with present-tense meaning:**
e.g.
:::
::: indent
⟪इष्ट⟫ "desired" (i.e. not only desired in the past, but also in the present)
⟪त्वरित⟫ "hurrying, hasty" (PPP to tvar 1 Ā "to hurry"; Dhātupāṭha: ñitvárā)
:::
...
Attributes (modifiers) appear in prose before the word they modify, following normal word order. Adjectival attributes agree with the noun in number, case, and gender:
...
Stems in -mant or -vant belong to nominal stems with stem gradation.

::: grammar-box
For nominal stems with stem gradation, one distinguishes between strong and weak cases (vibhakti). In the strong cases, the stem-forming suffix — for root nouns, the root-like component — appears in the guṇa or vṛddhi grade; in weak cases, it appears in the zero-grade.
:::
**Strong cases are:**
...
::: grammar-box
As the first member of a compound, a noun with stem gradation appears in the weak stem (in the so-called middle for three-stem nouns).
:::

## 13.6. On Word Sandhi

The following laws of word sandhi are necessary for understanding the individual forms of declension of nouns ending in -mant and -vant:

::: grammar-box
1. Number of final consonants in a word: If a word would end with two or more consonants, only the first consonant is retained; the others are dropped. The combination -r- + consonant is permitted.
...
7. A Brāhmaṇa has not told a falsehood.
