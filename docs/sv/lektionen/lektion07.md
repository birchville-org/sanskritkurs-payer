---
title: "Lektion 7"
subtitle: "Verbsatsen med direkt objekt"
lesson_id: 7
...
**brāhmaṇo devaṃ yajati** = ⟪ब्राह्मणो देवं यजति⟫ : "The Brahmin worships a god with a sacrifice (for someone else)."
...
The forms **enam** (⟪एनम्⟫) etc. belong to the stem **enad** (⟪एनद्⟫), which forms cases only in some instances. These are used instead of the forms of **etad** and **idam** when the entity referred to has already been mentioned in the preceding context.
...
3. If preceded by a word-initial voiceless palatal, retroflex, or dental consonant, it is replaced by **Anusvāra** + the sibilant corresponding to these sounds:
**-n** before **c-, ch-** » **-ṃś**
**-n** before **ṭ-, ṭh-** » **-ṃṣ**
**-n** before **t-, th-** » **-ṃs**
...
## 7.5. A thematic Present classes
...
(Image source: [Details](/sv/licenses#lekt0701))
...
**A) Infoga det direkta objektet respektive riktningsackusativen i singular och plural:**
...
(Bildkälla: [Details](/sv/licenses#lekt0704))
...
**B) Infoga de motsvarande verbformerna:**
...
(Bildkälla: [Details](/sv/licenses#lekt0702))
