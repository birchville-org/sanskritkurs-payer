...
In addition to this basic rule for forming Samāhāradvandvas, there are a number of other rules that can be found in Pāṇini 2,4,2-17 or e.g. Mr. R. Kale, A higher Sanskrit grammar, reprint 1969, § 189 - 192 a. In the various stages of language development, not always the same rules were observed!
...
**Kṛt-suffixet -aka, femininum ofta -ikā, bildar nomina agentis (substantiv som uttrycker utföraren) till varje rot.**

En utljudande vokal i roten samt **-a-** på näst sista plats i roten ersätts av deras förlängda form (**vṛddhi**) (det finns några undantag), de övriga vokalerna ersätts av deras starka form (**guṇa**).
...
**Några av dessa bildningar har den snävare betydelsen: "det som uttrycks av roten, vanemässigt eller som en skyldighet eller väl utförande".**
...
(Image source: [Details](/sv/licenses#lekt0903))
...
(Image source: [Details](/sv/licenses#lekt0902))
...
Fig.: **karṣaka** = ⟪कर्षक⟫.
(Image source: [Details](/sv/licenses#lekt0901))
...
1. Duties of all twice-born persons:
   **ijyādhyayanadānāni**
⟪इज्याध्ययनदानानि⟫
...
Explanation: dvijātīnām = Genitive plural of dvijāti ("towards the twice-born"); kārukuśīlavakarma is a Tatpuruṣa compound with a Dvandva (kārukuśīlava) in the prior member. karma = Nom. sg. of karman n. "deed, activity, karma" from the root kṛ 8 U). Translate "deed / activity of ... (Genitive)" (as designated by the Dvandva).
