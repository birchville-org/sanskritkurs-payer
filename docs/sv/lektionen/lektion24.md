---
title: "Lektion 24"
subtitle: 'Dativ (⟪चतुर्थी⟫ = "fjärde kasusändelse")'
lesson_id: 24
...
= "Rāma har gått för att höra lärarens tal."
...
(Bildkälla: [Details](/sv/licenses#lekt2404))

:::

::: grammar-box

**2. Dativ (⟪चतुर्थी⟫) kan också beteckna objektet för en infinitiv som ska kompletteras för att ange syfte:**
...
⟪फलेभ्यो ग्रामं गच्छति⟫ = "Han går till byn i syfte att få frukter = Han går till byn för att hämta frukter."

:::

**På samma sätt betecknar dativ (⟪चतुर्थी⟫) syftet med en sak eller en handling:**

Example:

::: indent

⟪यज्ञायान्नम्⟫ = "Mat för ett offer = Mat till ett offer"
...
(Bildkälla: [Details](/sv/licenses#lekt2401))
...
(Image source: [Details](/sv/licenses#lekt2402))
...
(Image source: [Details](/sv/licenses#lekt2403))
...
Fig.: ⟪अलंकारः⟫
(Image source: [Details](/sv/licenses#lekt2405))

:::

⟪हेतु⟫ m.: impulse, occasion, cause, reason; ⟪हेतुना⟫, ⟪हेतोस्⟫, ⟪हेतवे⟫ with Genitive or as the second member of a compound = "for the sake of ..., because of"
...
(Image source: [Details](/sv/licenses#lekt2406))
...
⟪अभि⟫ Preverb:  be-, after - towards, to - here, to - there, against, into - within, with regard to, on, over, at
...
(Image source: [Details](/sv/licenses#lekt2407))
...
(Image source: [Details](/sv/licenses#lekt2408))
...
(Image source: [Details](/sv/licenses#lekt2411))
...
Fig.: ⟪श्रीगणेशाय नमः⟫
(Image source: [Details](/sv/licenses#lekt2409))
...
8. A warrior is a match for (the other) warrior (⟪शक्त⟫).

9. Even Viṣṇu does not surpass (⟪प्र⟫-⟪भू⟫ + Dat.) Śiva.

10. After I have bowed to the three sages (Acc.) (⟪नमस्कृ⟫)... He bows to Narasiṃha (Dat.)
...
(Image source: [Details](/sv/licenses#lekt2410))
...
15⟪१५⟫. På återseende! (Neusanskrit: ⟪पुनर्दर्शनाय⟫)