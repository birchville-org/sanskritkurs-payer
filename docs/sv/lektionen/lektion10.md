---
title: "Lektion 10"
subtitle: "Passivsatsen (instrumentalis av agenten)"
lesson_id: 10
...
e.g. **brāhmaṇena deva ijyate** = ⟪ब्राह्मणेन देव इज्यते⟫ = "A Brahman worships a god with an offering" (literally: "A god is worshipped by a Brahman with an offering.")

This sentence is **completely (!) semantically equivalent** to the sentence:
...
In the passive sentence, the agent (**kartṛ**) stands in the **Instrumental** (tṛtīyā f. "third case ending"), the direct object (**karman** n.) in the **Nominative** (prathamā f.).
Passive sentences in which the agent is not specified usually have an impersonal meaning ("one"):
e.g. **ijyate** = ⟪इज्यते⟫ "One sacrifices" (literally: "it is worshipped with an offering").

:::

::: grammar-box

**Even if the corresponding active sentence would contain an accusative (dvitīyā) of purpose, this can be put into the nominative (prathamā) in the passive sentence:**
...
**praviśyatām** = ⟪प्रविश्यताम्⟫ = "One may enter = Please come in = Come in!"
**niṣadyatām** = ⟪निषद्यताम्⟫ = "One may sit down = Please take a seat = Please be seated"
...
| :--- | :--- | :--- |
| **Feminines in -i**:brśruti:br⟪श्रुति⟫ | **śruty-ā** :br⟪श्रुत्या⟫ | **śruti-bhis** :br⟪श्रुतिभिस्⟫ |
| **Feminines in -ī**:brdevī:br⟪देवी⟫ | **devy-ā** :br⟪देव्या⟫ | **devī-bhis** :br⟪देवीभिस्⟫ |
| **Feminines in -u**:brdhenu:br⟪धेनु⟫ | **dhenv-ā** :br⟪धेन्वा⟫ | **dhenu-bhis** :br⟪धेनुभिस्⟫ |

**Irregular formations (Singular):**

| | Instrumental Singular | Instrumental Plural |
| :--- | :--- | :--- |
| **Masculines in -i**:brkavi:br⟪कवि⟫ | **kavi-n-ā** :br⟪कविना⟫ | **kavi-bhis** :br⟪कविभिस्⟫ |
| **Masculines in -u**:brpaśu:br⟪पशु⟫ | **paśu-n-ā** :br⟪पशुना⟫ | **paśu-bhis** :br⟪पशुभिस्⟫ |
| **Feminines in -ā**:brdevatā:br⟪देवता⟫ | **devat-ay-ā** :br⟪देवतया⟫ | **devatā-bhis** :br⟪देवताभिस्⟫ |

**Masculines and Neuters in -a (irregular in singular and plural):**

| | Instrumental Singular | Instrumental Plural |
| :--- | :--- | :--- |
| **Masculines in -a**:brdeva:br⟪देव⟫ | **devena** :br⟪देवेन⟫ | **devais** :br⟪देवैस्⟫ |
| **Neuters in -a**:brphala:br⟪फल⟫ | **phalena** :br⟪फलेन⟫ | **phalais** :br⟪फलैस्⟫ |

**Interrogative pronoun kim:**

| | Instrumental Singular | Instrumental Plural |
| :--- | :--- | :--- |
| **Masculine / Neuter** | **kena** :br⟪केन⟫ | **kais** :br⟪कैस्⟫ |
| **Feminine** | **kayā** :br⟪कया⟫ | **kābhis** :br⟪काभिस्⟫ |

**Demonstrative pronouns:**

| Pronoun | Gender | Instrumental Singular | Instrumental Plural |
| :--- | :--- | :--- | :--- |
| **tad** :br"he, she, it; the, that (one)" (mentioned):br⟪तद्⟫ | M/N | **tena** :br⟪तेन⟫ | **tais** :br⟪तैस्⟫ |
...
**The Instrumental (tṛtīyā) is primarily used for the questions:**
**By what?**
**With what?**
**With whom?**

**It is used**
1. **in passive sentences: Agent (kartṛ) in the Instrumental**
2. **to indicate the means or instrument with which something is accomplished**
3. **to indicate the path by which someone reaches somewhere**
4. **to express connection, union, accompaniment with**
5. **with postpositions meaning "together with, with"; e.g., saha = ⟪सह⟫ = "with"** :brfor example:br **brāhmaṇena saha** = ⟪ब्राह्मणेन सह⟫ = "together with the Brahmin"
...
| :--- | :--- | :--- |
| **nī** :br1 U:br(nayati) | **nīyate** :br(⟪नीयते⟫):br"he is led" | **nīyante** :br(⟪नीयन्ते⟫) |
| **man** :br4 Ā:br(manyate) | **manyate** :br(⟪मन्यते⟫):br"it is thought" | **manyante** :br(⟪मन्यन्ते⟫) |
| **viś** :br6 P:br(viśati) | **viśyate** :br(⟪विश्यते⟫):br"it is entered" | **viśyante** :br(⟪विश्यन्ते⟫) |

**Note that for verbs of the 4th present class, the Ātmanepada and the passive have identical forms! Whether an Ātmanepada or a passive is present can only be inferred from the sentence structure in this case.**
...
2. **Roots with -a- between consonants** (except nasals, y, r, v) remain in the strong grade:
* **labh** 1 Ā: **labhyate**, **labhyante** :br⟪लभ्यते⟫, ⟪लभ्यन्ते⟫

3. **Some roots form their passive in the strong grade** (or in the ablaut grade of the present stem):
...
4. **Weak grade of verbs beginning with ya, va, ra, or where these sounds follow another consonant (Samprasāraṇa = ⟪सम्प्रसारण⟩):**

| Root:br⟪धातु⟫ | Weak grade:br⟪सम्प्रसारण⟫ | Passive:br⟪यक्⟫ |
| :--- | :--- | :--- |
...
The traditional indigenous designation for this formation of the deep stage in verbs with **ya** or **va** is **Samprasāraṇa** (⟪नपुंसकम्⟫ = ⟪सम्प्रसारण⟫).
...
* But: **smṛ** 1 P: **smaryate** :br⟪स्मर्यते⟫

6. **Some roots ending in -an have alternatively two passive stem formations:**
* one **-an-ya**
* one **-ā-ya-** (the long **ā** is a representative for a hypothetical long nasal)
...
Fig.: ⟪वरुणः⟫
(Image source: [Details](/sv/licenses#lekt1003))
...
Fig.: ⟪विश्वामित्रः⟫
(Image source: [Details](/sv/licenses#lekt1002))
...
1. En brahman går till byn med en vaiśya.
2. Han dyrkar Viṣṇu med ett offer. (Uttryck offer **yajña**!)
3. Veda kallas śruti. (**vad**)
4. Man spänner upp varpen. (2 möjligheter)
...
(Bildkälla: [Details](/sv/licenses#lekt1004))

:::

5. Lärare frågar. (Passiv konstruktion)
6. Ögat leder. (Passiv konstruktion)
7. Poeten ser en gudom. (Passiv konstruktion)
8. Vem (fem.) vaktar flickan? (Passiv konstruktion)
9. Kṣatriya dyrkar HERREN med ett offer. (Passiv konstruktion, utan att använda ordet **yajña**)
10. Genom generositet når en anhängare av Buddha en himmel.
...
**dhana** n. ⟪धन⟫ : reward, money, wealth, property
