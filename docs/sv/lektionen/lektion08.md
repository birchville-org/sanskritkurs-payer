---
title: "Lektion 8"
subtitle: "Bildning av substantiv & 8:e presensklass"
lesson_id: 8
category: "Grammatik"
status: "stable"
...
**Nominal stem + case ending » syntax-capable noun**

:::

## 8.2. Klassificering av nominalsuffix

**kṛt (kṛdanta) = ⟪कृत्⟫ (⟪कृदन्त⟫)**
**kārakakṛt** (⟪कारककृत्⟫) » nomina agentis (betecknar någon som utför det som roten betecknar)
**kṛtikṛt** (⟪कृतिकृत्⟫) » nomina actionis (betecknar handlingen som uttrycks av roten) eller abstrakta substantiv
...
**Indelning efter ablaut:**
**guṇya** (⟪गुण्य⟫): bildning i högsta grad
**na guṇya** (⟪न गुण्य⟫): bildning i lägsta grad
**vṛddhyarha** (⟪वृद्ध्यर्ह⟫): bildning i förlängd grad


## 8.3. Vissa viktiga nominala suffix

### 8.3.1. -a m. (kṛt)

::: grammar-box

**Kṛt-suffixet -a bildar maskulina (sällan neutra) substantiv som betecknar en handling eller ett tillstånd som avses med roten; ibland även adjektiv eller substantiv som uttrycker agens (kartṛ) för den handling som avses med verbrotet. För kort penultima (= vokal före konsonant, varmed roten slutar) eller utgående rotvokal ersätts vanligen högsta grad (guṇa) eller förlängd grad (vṛddhi).**

:::

**Exempel:**

| Rot:br⟪धातु⟫ | + -a (kṛt) | Betydelse |
| :--- | :--- | :--- |
| **ji** 1 P:br⟪आप्⟫:br"segra" | **jaya** m.:br⟪जय⟫ | "seger, att segra" |
| **muh** 4 P:br⟪मुह्⟫:br"vara förvirrad" | **moha** m.:br⟪मोह⟫ | "förvirring, bedrägeri, villfarelse" |
| **krudh** 4 P:br⟪क्रुध्⟫:br"förbittra sig" | **krodha** m.:br⟪क्रोध⟫ | "vrede" |
| **kup** 4 P:br⟪कुप्⟫:br"förbittra sig" | **kopa** m.:br⟪कोप⟫ | "vrede" |
| **lubh** 4 P:br⟪लुभ्⟫:br"begära" | **lobha** m.:br⟪लोभ⟫ | "begär" |
| **labh** 1 Ā:br⟪लभ्⟫:br"få" | **lābha** m.:br⟪लाभ⟫ | "att få, vinst" |
| **sṛj** 6 P:br⟪सृज्⟫:br"släppa,:breläta gå" | **sarga** m.:br⟪सर्ग⟫ | "att släppa, emanation, skapelse" (om wortsandhi j » g se senare) |
| **śru** 5 P:br⟪श्रु⟫:br"höra" | **śrava** m.:br⟪श्रव⟫ | "att höra" |
| **bhū** 1 P:br⟪भू⟫:br"bli, vara" | **bhāva** m.:br⟪भाव⟫ | "att bli, det (något) vara, natur, karaktär" |
| **yudh** 4 Ā:br⟪युध्⟫:br"kämpa" | **yodha** m.:br⟪योध⟫ | "kämpe, krigare, soldat" |
...
(Image source: [Details](/sv/licenses#lekt0801))

:::

::: note-box

**"Darshan"** or **"Darshana"** is a term from Hinduism for the sight and vision of the holy and divine. *Darshana* can refer, for example, to an official meeting between student and teacher, where the student has been invited by the teacher. It can also mean *immersing oneself* while gazing at an image of a deity. The latter meaning is the most common in contemporary Hindi usage. In connection with Mata Amritanandamayi, Darshan means the embrace by the Guru.

Pious Hindus go to the temple to attain the sight of God through a symbol or statue in which the spiritual presence of the deity is assumed. In this sense, it is also a blessing by the deity. However, Darshan can also be received through a vision of the deity during prayer or meditation. A living person who is regarded as an incarnation of the deity, such as an Avatara, can also give Darshan.
(Quelle: Wikipedia)
...
**Urmantrat Oṃ (⟪ॐ⟫) i olika indiska skrifter**
...
(Bildquellen: [Details](/sv/licenses#lekt0803))
...
| :--- | :--- | :--- | :--- |
| **guru** :br⟪गुरु⟫:br3 "heavy, worthy,:brm. Teacher" | **gurutva** n.:br⟪गुरुत्व⟫ | **gurutā** f.:br⟪गुरुता⟫ | "Heaviness, Venerability,:brThe state of being a teacher (essence or nature of a teacher)" |
...
**nāga** m. ⟪नाग⟫ : the naked one, elephant, snake (elephants and snakes have no fur, just as humans are "naked apes")
**gaja** m. ⟪गज⟫ : elephant
**śuc** 1 P (śocati) ⟪शुच् शोचति⟫ : to grieve
**śuka** m. ⟪शुक⟫ : parrot
...
(Image source: [Details](/sv/licenses#lekt0809))
...
Fig.: **likh** (⟪लिख्⟫) : Writing stick of the Batak (Sumatra), which was likely also in use in India
(Image source: [Details](/sv/licenses#lekt0809))
...
**D) Translate:**
1. The Kṣatriyas protect both Brāhmaṇas and Vaiśyas and Śūdras. (2 possibilities)
