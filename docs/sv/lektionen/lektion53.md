...
Fig.: ⟪मार्जारयुगम्⟫
(Image source: [Details](/sv/licenses#lekt5301))
...
Fig.: ⟪हस्तौ⟫
(Image source: [Details](/sv/licenses#lekt5302))
...
Fig.: ⟪फले⟫
(Image source: [Details](/sv/licenses#lekt5306))
...
Fig.: ⟪धेनू⟫
(Image source: [Details](/sv/licenses#lekt5307))
...
Fig.: ⟪पितापुत्रौ⟫
(Image source: [Details](/sv/licenses#lekt5308))
...
| ⟪स्था⟫ 1P "to stand" | ⟪स्थिर⟫ 3 "constant, firm" | :sig[⟪स्थेयस्⟫] 3 "firmer" :br ⟪स्थिरतर⟫ 3 | :sig[⟪स्थेष्ठ⟫] 3 "most firm" :br ⟪स्थिरतम⟫ 3 |

:::

**Special rules for the addition of these suffixes:**
...
(Image source: [Details](/sv/licenses#lekt5309))

:::

**Some inflectional forms of this type have no root-related base form at all; they are "defective". Therefore, the following series must be memorized especially well:**
...
(Image source: [Details](/sv/licenses#lekt5303))
...
(Image source: [Details](/sv/licenses#lekt5304))
...
**For the meters, where the number of syllables is fixed (⟪वृत्त⟫), one can initially distinguish further:**
...
### 53.10.4. Den episka Śloka (⟪श्लोक⟫ m.)
...
"I Śloka är den sjätte stavelsen i en Pāda tung,
den femte i alla Pādas lätt
Den sjunde stavelsen är i den andra och fjärde Pāda kort, lång i de två andra."
Det viktigaste versmåttet i eposen (⟪महाभारत⟫, ⟪रामायण⟫) samt otaliga andra verk är Śloka ("rop", "ljud", "strof" till ⟪श्रु⟫ "höra").
...
Den andra och tredje stavelsen i en ⟪पाद⟫ bör inte vara ⟪लघु⟫ samtidigt. I b och d får stavelse 2 - 4 inte vara ¯ ˘ ¯.

**Bischeman (⟪विपुला⟫) för a och c:**
...
**I alla Śloka-former ligger huvudcesuren i slutet av den andra ⟪पाद⟫: där är antingen ordslut eller – vid långa sammansättningar – slutet av en sammansättningsdel.**
## 53.11. Övning

::: grammar-box

**Bestäm vilka av alla hittills inlärda verser som är Ślokas. Skriv ner det metriska schemat för dessa. Peka på eventuella oregelbundenheter eller Vipulā-former.**
