...
### 48.2.1. Imperative endings on athematic present stems
...
Note: ¹ The endings of the 2nd and 3rd sg. can be replaced by -tāt if a blessing is to be expressed. -tāt attaches (also in the 3rd sg.) to the weak stem.
...
With the suffix **-a** and (less frequently) **-ya**, another noun can be derived from a noun. In doing so, the first syllable of the original noun receives the guṇa grade (⟪वृद्धि⟫). If the original stem already ends in **-a**, then the ⟪वृद्धि⟫ is the only marker of derivation, since nothing changes at the end of the stem.

The derived words have the meaning:

> "having some relation to that which is designated by the base word"
...
The words formed in this way are adjectives, but they can be substantivized, e.g. as patronymics (name formation after the father: "son of N.N.") or abstracta (mostly neuter).
...
| :---: | :--- |
| **\-ṛ** | **\-a** generally attaches to the final **\-r**: e.g. ⟪जेतृ⟫ "winner" » ⟪जैत्र⟫ 3 "victorious" |
| **\-a** | Replacement of the **\-a** of the base word by the new suffix **\-a**. e.g. see above. |
...
(Image source: [Details](/sv/licenses#lekt4801))
...
(Image source: [Details](/sv/licenses#lekt4802))
...
(Image source: [Details](/sv/licenses#lekt4803))
...
(Bildkälla: [Details](/sv/licenses#lekt4804))
...
⟪कुमार⟫ m.: barn, yngling, prins; epitet för ⟪कार्तिकेय⟫ / Murugan = முருகன் = മുരുകന്‍ / Subrahmanya = ಸುಬ್ರಹ್ಮಣ್ಯ
...
(Bildkälla: [Details](/sv/licenses#lekt4805))
...
(Bildkälla: [Details](/sv/licenses#lekt4806))
...
(Bildkälla: [Details](/sv/licenses#lekt4807))
...
(Bildkälla: [Details](/sv/licenses#lekt4808))
...
(Bild: Payer)
(Bildkälla: [Details](/sv/licenses#lekt4809))

:::

## 48.5. Übung

A) Översätt ⟪सुभाषितानि⟫ i början av lektionen.
