...
(See later for the two latter types!)
...
1. **either the summativ connection of persons, things, properties designated by its individual members:**
Itaretaradvandva = ⟪इतरेतरद्वन्द्व⟫

2. **or it combines these persons, things or properties into a unity:**
Samāhāradvandva ("collective dvandva") = ⟪समाहारद्वन्द्व⟫

**In the first case (Itaretaradvandva):**
The Dvandva takes the grammatical gender of its last member and the endings of the dual (for two things) or plural (for more than two things). Singular endings are also permissible.

**In the second case (Samāhāradvandva):**
The Dvandva is generally a neuter (regardless of the gender of the last member) and stands in the singular.
...
**För ordningen av led i en dvandva gäller bland annat följande regler:**
Benämningen av de olika stånden (**varṇa**) ska ordnas enligt deras hierarki (högst först).
Den äldre broderns namn ska placeras före den yngre broderns namn.
I allmänhet ska det viktigare ordet placeras först.
Ord som slutar på **-i** eller **-u** ska föregå.
Ord som slutar på **-a** och börjar med en vokal ska föregå.
Ord som innehåller färre stavelser ska föregå.
...
**abhiniveṣa** m. = ⟪अभिनिवेष⟫ : benägenhet för, envishet, insisterande på; speciellt: tillgivenhet till kroppen som om den vore ens egen.
