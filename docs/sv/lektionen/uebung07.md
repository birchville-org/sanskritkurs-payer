...
A) Fyll i direkt objekt respektive riktningsackusativ i singular och plural (om det inte är egennamn):
...
B) Fyll i de motsvarande verbformerna:
...
C) Sätt agent, objekt och verb i plural i övningsmeningarna B).
