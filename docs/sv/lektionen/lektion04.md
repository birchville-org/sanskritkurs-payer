---
title: "Lektion 4"
subtitle: "Frågepronomen och demonstrativa pronomen i nominativ"
lesson_id: 4
...
För att kunna bilda satser med dessa pronomen (sarvanāman n.) krävs kännedom om följande sandhiregler:

### 4.1.2. Sandhi för utljudande -m

::: grammar-box
**Utljudande -m ersätts med anusvāra (-ṃ) före konsonanter. I slutet av en sats eller vers samt före vokaler behålls -m.**
:::
### 4.1.3. Sandhi för utljudande -e

::: grammar-box
1. **Före a- förblir -e oförändrat: det inledande a- elideras med avagraha:**
t.ex. ete + agnayas » ete 'gnayaḥ = ⟪एते ऽग्नयः⟫ "dessa eldar"

2. **Före andra vokaler än kort a- ersätts -e vanligtvis med -a med hiatus. Även ersättning med -ay förekommer:**
t.ex. ime + īśvarās » ima īśvarāḥ = ⟪इम ईश्वराः⟫ (sällan: imay īśvarāh = ⟪इमयीश्वराः⟫) "dessa herrar"
:::
### 4.1.4. Sandhi för utljudande -d

::: grammar-box
**Utljudande -d ersätts med -t i paus samt före tonlösa gutturaler (k, kh) och labialer (p, ph).**

Ersättning före andra konsonanter diskuteras senare. Undvik tills vidare sådana ljudsammanstötningar!
:::
### 4.1.5. Frågeformler

Med hjälp av dessa pronomen bildar man t.ex. följande frågeformler:
...
> viṣṇuḥ kaḥ? = ⟪विष्णुः कः⟫ Answer: viṣṇur īśvaraḥ = ⟪विष्णुरीश्वरः⟫. (In a nominal sentence, the subject can be placed at the beginning to emphasize the connection to the question.)
...
(Bildkälla: [Detaljer](/sv/licenses#lekt0401))
:::
