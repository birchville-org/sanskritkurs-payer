---
title: "Lektion 6"
subtitle: "Byggnaden av verbalsatsen (agens och verbalform)"
lesson_id: 6
...
**Schema I: Verb Form**
e.g. **yajati** = ⟪यजति⟫ = "He (she, it) worships with a sacrifice", "He (she, it) sacrifices"
...
If the agent (**kartṛ** m. = ⟪कर्तृ⟫) is mentioned in a verbal sentence that is not in the passive voice, then the agent stands in the **Nominative** (first case, prathamā = ⟪प्रथमा⟫). In the number (vacana n. = ⟪वचन⟫), the agent and verb form then agree.
...
In many cases, the semantic nuance of the Ātmanepada can no longer be recognized; even skilled poets often use the Ātmanepada without semantic difference from the Parasmaipada. Nevertheless, when translating, one must always pay close attention to whether such a semantic nuance is present.

Verb som används i både Parasmaipada och Ātmanepada (i den specifika Ātmanepada-betydelsen) kallas **Ubhayapada**-verb (**ubhayapada** n. = ⟪उभयपद⟫ = "båda ordformerna").

Some verbs are used either only in the Parasmaipada or only in the Ātmanepada. For these verbs, the Ātmanepada or Parasmaipada has no specific meaning. E.g., **manyate** = ⟪मन्यते⟫ = "he (she, it) thinks" (without specific Ātmanepada meaning).

4. **Mode of Expression** (Mood):
1. **Indicative**: Statement form
2. **Optative**: Wish form and potentiality form
...
The present is the tense of the present time, particularly also of duration.
...
## 6.4. Primära ändelser för tredje person (prathama m. = ⟪प्रथम⟫ = "första (!) person")

## 6.4. Primära ändelser för tredje person (prathama m. = ⟪प्रथम⟫ = "första (!) person")

::: grammar-box

| | Singular (Einzahl):br⟪एकवचन⟫ | Plural (Mehrzahl):br⟪बहुवचन⟫ |
| :--- | :--- | :--- |
...
Exempel **yaj** = ⟪यज्⟫ = "hedra med ett offer", "offra":
Presensstam: **yaja** = ⟪यज⟫
3. sg. P. **yajati** = ⟪यजति⟫
...
## 6.5. Bildning av presensstammen

### 6.5.1. Verb i den 6:e presensklassen (tudādi = ⟪तुदादि⟫ = "tud etc.")

::: grammar-box

**Presensstam = rot i låg grad (i vilken den listas) + a-**
...
### 6.5.2. Verb i den 1:a presensklassen (bhvādi / bhūvādi = ⟪भ्वादि⟫ / ⟪भूवादि⟫ = "bhū etc.")
...
| Low grade:brZero grade | High grade:brFull grade:brGuṇa m.:br⟪गुण⟫ | Lengthened grade:brVṛddhi f.:br⟪वृद्धि⟫ |
| :--- | :--- | :--- |
| **ø** | **a** | **ā** |
| **i / ī** | **e** | **ai** |
| **u / ū** | **o** | **au** |
...
Answer: **sarvathā kuśalam** = ⟪सर्वथा कुशलम्⟫ = "(It is) good in every respect."
...
I sanskrit anges verb i **rotform**. Talet efter roten anger **konjugationsklassen**.

**P:** Rot är endast Parasmaipada
**Ā:** Rot är endast Ātmanepada
**U:** Ubhayapada ("båda ordformer"): Rot används i både Parasmaipada och Ātmanepada.
**():** I parentes anges 3:e person singular presens indikativ (laṭ).

:::

**Lär er följande ord:**
**yaj** 1 U (yajati) ⟪यज् यजति⟫ : hedra med ett offer, offra
**bhū** 1 P (bhavati) ⟪भू भवति⟫ : bli, uppstå, vara
**smṛ** 1 P (smarati) ⟪स्मृ स्मरति⟫ : förmedla, minnas
**nṛt** 4 P (nṛtyati) ⟪नृत् नृत्यति⟫ : dansa
**nī** 1 U (nayati) ⟪नी नयति⟫ : leda
**man** 4 Ā (manyate) ⟪मन् मन्यते⟫ : tänka
**muh** 4 P (muhyati) ⟪मुह् मुह्यति⟫ : vara förvirrad
**yudh** 4 Ā (yudhyate) ⟪युध् युध्यते⟫ : kämpa
**viś** 6 P (viśati) ⟪विश् विशति⟫ : träda in
**sṛj** 6 P (sṛjati) ⟪सृज् सृजति⟫ : släppa, utge sig själv, emanera


## 6.8. Övningar

**A) Bilda verbala meningar med de rötter som anges inom parentes genom att infoga dem:**
...
**B) Översätt de meningar som bildades i övning A till plural.**
...
Brahmins, Kṣatriyas and Vaśyas are twice-born. (2 possibilities)
